    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" meta:resourcekey="panelMainResource1" BorderStyle="NotSet">
        ...
        <div class="div-main">
            ...
            <web:base ID="objectBase" runat="server" ObjectNumberEnabled="false" ObjectNameVisible="false" meta:resourcekey="objectBaseResource1">
                    ...
                    <ui:UIFieldRichTextBox ID="textAdjustmentDescription" runat="server" Caption="Description" EditorHeight="120px"
                            PropertyName="Description" ToolTip="Description of the reallocation"  meta:resourcekey="textAdjustmentDescriptionResource1" InternalControlHeight="120px" />
                        <br />
                        <br />                        
            </ui:UITabView>
                <ui:UITabView ID="uitabviewReallocateFrom" runat="server" Caption="Reallocate From" meta:resourcekey="uitabviewReallocateFromResource1" BorderStyle="NotSet">
                    <ui:UIPanel runat="server" ID="panelReallocateFrom" meta:resourcekey="panelReallocateFromResource1" BorderStyle="NotSet">
                        ...
                        <ui:UIFieldTreeList runat="server" ID="treeAccountFrom" Caption="Add Account" OnAcquireTreePopulater="treeAccountFrom_AcquireTreePopulater"
                            OnSelectedNodeChanged="treeAccountFrom_SelectedNodeChanged" meta:resourcekey="treeAccountFromResource1" ShowCheckBoxes="None" TreeValueMode="SelectedNode">
                        </ui:UIFieldTreeList>
                        <ui:UIGridView runat="server" ID="gridReallocateFrom" ShowFooter="True" PropertyName="BudgetReallocationFroms"
                            ...
                            KeyName="ObjectID" OnRowDataBound="gridReallocateFrom_RowDataBound" 
                            meta:resourcekey="gridReallocateFromResource1" DataKeyNames="ObjectID" 
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewTemplateColumn meta:resourcekey="UIGridViewTemplateColumnResource77">
                                    <ItemTemplate>
                                        <cc1:UIFieldTextBox ID="textTotalAmount" runat="server" DataFormatString="{0:#,##0.00}" FieldLayout="Flow" InternalControlWidth="70px" meta:resourceKey="textInterval01AmountResource1" PropertyName="TotalAmount" ShowCaption="False" ValidateDataTypeCheck="True" ValidateRangeField="True" ValidateRequiredField="True" ValidationDataType="Currency" ValidationRangeMin="0" ValidationRangeType="Currency">
                                        </cc1:UIFieldTextBox>
                                    </ItemTemplate>
                                    <HeaderStyle Font-Bold="False" HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewTemplateColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalOpeningBalance" DataFormatString="{0:#,##0.00}" HeaderText="(1) Opening Balance" meta:resourcekey="UIGridViewBoundColumnResource3" PropertyName="TotalOpeningBalance" ResourceAssemblyName="" SortExpression="TotalOpeningBalance">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalAdjustedAmount" DataFormatString="{0:#,##0.00}" HeaderText="(2) Adjusted Amount" meta:resourcekey="UIGridViewBoundColumnResource4" PropertyName="TotalAdjustedAmount" ResourceAssemblyName="" SortExpression="TotalAdjustedAmount">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalReallocatedAmount" DataFormatString="{0:#,##0.00}" HeaderText="(3) Reallocated Amount" meta:resourcekey="UIGridViewBoundColumnResource5" PropertyName="TotalReallocatedAmount" ResourceAssemblyName="" SortExpression="TotalReallocatedAmount">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalBalanceAfterVariation" DataFormatString="{0:#,##0.00}" HeaderText="(4) Total After Adjustments&lt;br /&gt;(1)+(2)+(3)" HtmlEncode="False" meta:resourcekey="UIGridViewBoundColumnResource6" PropertyName="TotalBalanceAfterVariation" ResourceAssemblyName="" SortExpression="TotalBalanceAfterVariation">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalPendingApproval" DataFormatString="{0:#,##0.00}" HeaderText="(5) Total Pending Approval" meta:resourcekey="UIGridViewBoundColumnResource7" PropertyName="TotalPendingApproval" ResourceAssemblyName="" SortExpression="TotalPendingApproval">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalApproved" DataFormatString="{0:#,##0.00}" HeaderText="(6) Total Approved" meta:resourcekey="UIGridViewBoundColumnResource8" PropertyName="TotalApproved" ResourceAssemblyName="" SortExpression="TotalApproved">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalDirectInvoicePendingApproval" DataFormatString="{0:#,##0.00}" HeaderText="(7) Total Direct Invoice Pending Approval" meta:resourcekey="UIGridViewBoundColumnResource9" PropertyName="TotalDirectInvoicePendingApproval" ResourceAssemblyName="" SortExpression="TotalDirectInvoicePendingApproval">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalDirectInvoiceApproved" DataFormatString="{0:#,##0.00}" HeaderText="(8) Total Direct Invoice Approved" meta:resourcekey="UIGridViewBoundColumnResource10" PropertyName="TotalDirectInvoiceApproved" ResourceAssemblyName="" SortExpression="TotalDirectInvoiceApproved">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalAvailableBalance" DataFormatString="{0:#,##0.00}" HeaderText="(9) Total Available&lt;br /&gt;(4)-(5)-(6)-(7)-(8)" HtmlEncode="False" meta:resourcekey="UIGridViewBoundColumnResource11" PropertyName="TotalAvailableBalance" ResourceAssemblyName="" SortExpression="TotalAvailableBalance">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                            </Columns>
                        </ui:UIGridView>
                        <ui:UIObjectPanel runat="server" ID="panelBudgetReallocationFroms" meta:resourcekey="panelBudgetReallocationFromsResource1" BorderStyle="NotSet">
                ...
                <ui:UITabView ID="uitabviewReallocateTo" runat="server" Caption="Reallocate To" meta:resourcekey="uitabviewReallocateToResource1" BorderStyle="NotSet">
                    <ui:UIPanel runat="server" ID="panelReallocateTo" meta:resourcekey="panelReallocateToResource1" BorderStyle="NotSet">
                        ...
                        <ui:UIFieldRadioList runat="server" ID="locationToModel" Caption="Show Accounts" OnSelectedIndexChanged="locationToModel_SelectedIndexChanged">
                        <Items>
                            <asp:ListItem Selected="True" Text="Show accounts applicable to the current budget period" Value="0"></asp:ListItem>
                        ...
                        <ui:UIFieldTreeList runat="server" ID="treeAccountTo" Caption="Add Account" OnAcquireTreePopulater="treeAccountTo_AcquireTreePopulater"
                            OnSelectedNodeChanged="treeAccountTo_SelectedNodeChanged" meta:resourcekey="treeAccountToResource1" ShowCheckBoxes="None" TreeValueMode="SelectedNode">
                        </ui:UIFieldTreeList>
                        <ui:UIGridView runat="server" ID="gridReallocateTo" ShowFooter="True" PropertyName="BudgetReallocationTos"
                            BindObjectsToRows="True" ValidateRequiredField="True" 
                            Caption="To Budget Items" ToolTip="Indicate budget items to reallocate to." 
                            OnRowDataBound="gridReallocateTo_RowDataBound" 
                            meta:resourcekey="gridReallocateToResource1" DataKeyNames="ObjectID" 
                            GridLines="Both" RowErrorColor="" style="clear:both;">
                            <PagerSettings Mode="NumericFirstLast" />
                            <commands>
                            ...
                            <Columns>
                                <cc1:UIGridViewButtonColumn ButtonType="Image" CommandName="DeleteObject" ConfirmText="Are you sure you wish to delete this item?" ImageUrl="~/images/delete.gif" meta:resourceKey="UIGridViewButtonColumnResource2">
                                    <HeaderStyle HorizontalAlign="Left" Width="16px" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewButtonColumn>
                                <cc1:UIGridViewBoundColumn DataField="Account.Path" HeaderText="Account" meta:resourceKey="UIGridViewBoundColumnResource2" PropertyName="Account.Path" ResourceAssemblyName="" SortExpression="Account.Path">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="TotalOpeningBalance" DataFormatString="{0:#,##0.00}" HeaderText="(1) Opening Balance" meta:resourcekey="UIGridViewBoundColumnResource12" PropertyName="TotalOpeningBalance" ResourceAssemblyName="" SortExpression="TotalOpeningBalance">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalAdjustedAmount" DataFormatString="{0:#,##0.00}" HeaderText="(2) Adjusted Amount" meta:resourcekey="UIGridViewBoundColumnResource13" PropertyName="TotalAdjustedAmount" ResourceAssemblyName="" SortExpression="TotalAdjustedAmount">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalReallocatedAmount" DataFormatString="{0:#,##0.00}" HeaderText="(3) Reallocated Amount" meta:resourcekey="UIGridViewBoundColumnResource14" PropertyName="TotalReallocatedAmount" ResourceAssemblyName="" SortExpression="TotalReallocatedAmount">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalBalanceAfterVariation" DataFormatString="{0:#,##0.00}" HeaderText="(4) Total After Adjustments&lt;br /&gt;(1)+(2)+(3)" HtmlEncode="False" meta:resourcekey="UIGridViewBoundColumnResource15" PropertyName="TotalBalanceAfterVariation" ResourceAssemblyName="" SortExpression="TotalBalanceAfterVariation">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalPendingApproval" DataFormatString="{0:#,##0.00}" HeaderText="(5) Total Pending Approval" meta:resourcekey="UIGridViewBoundColumnResource16" PropertyName="TotalPendingApproval" ResourceAssemblyName="" SortExpression="TotalPendingApproval">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalApproved" DataFormatString="{0:#,##0.00}" HeaderText="(6) Total Approved" meta:resourcekey="UIGridViewBoundColumnResource17" PropertyName="TotalApproved" ResourceAssemblyName="" SortExpression="TotalApproved">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalDirectInvoicePendingApproval" DataFormatString="{0:#,##0.00}" HeaderText="(7) Total Direct Invoice Pending Approval" meta:resourcekey="UIGridViewBoundColumnResource18" PropertyName="TotalDirectInvoicePendingApproval" ResourceAssemblyName="" SortExpression="TotalDirectInvoicePendingApproval">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalDirectInvoiceApproved" DataFormatString="{0:#,##0.00}" HeaderText="(8) Total Direct Invoice Approved" meta:resourcekey="UIGridViewBoundColumnResource19" PropertyName="TotalDirectInvoiceApproved" ResourceAssemblyName="" SortExpression="TotalDirectInvoiceApproved">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="TotalAvailableBalance" DataFormatString="{0:#,##0.00}" HeaderText="(9) Total Available&lt;br /&gt;(4)-(5)-(6)-(7)-(8)" HtmlEncode="False" meta:resourcekey="UIGridViewBoundColumnResource20" PropertyName="TotalAvailableBalance" ResourceAssemblyName="" SortExpression="TotalAvailableBalance">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                            </Columns>
                        </ui:UIGridView>
                        <ui:UIObjectPanel runat="server" ID="panelBudgetReallocationTos" meta:resourcekey="panelBudgetReallocationTosResource1" BorderStyle="NotSet">
