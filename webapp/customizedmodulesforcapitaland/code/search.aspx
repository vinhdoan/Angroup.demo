...
<script runat="server">
    ...
    /// <summary>
    /// Occurs when the user selects a node in the Code Type treeview.
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void panel_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        {
            CodeTypeID.Bind(OCodeType.GetLowerCodeTypes(TablesLogic.tCode[new Guid(treeCode.SelectedValue)].CodeType));
        }
    }
...
<body>
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="Code" GridViewID="gridResults" ObjectPanelID="tabSearch"
                BaseTable="tCode" TreeviewUrl="../../tree/code.aspx" OnSearch="panel_Search"
                onSelectedNodeChanged="panel_SelectedNodeChanged" meta:resourcekey="panelResource1"
