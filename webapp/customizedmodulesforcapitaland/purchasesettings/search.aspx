...
<script runat="server">
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        BudgetGroupID.Bind(AppSession.User.GetAllAccessibleBudgetGroup("OPurchaseSettings", null), true);
    }
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" 
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="Location.Path" HeaderText="Location" 
                                    meta:resourceKey="UIGridViewBoundColumnResource1" PropertyName="Location.Path" 
