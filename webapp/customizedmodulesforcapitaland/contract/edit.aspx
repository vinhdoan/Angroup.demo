        ...
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1" BorderStyle="NotSet">
                <ui:UITabView runat="server" ID="tabDetails" Caption="Details" meta:resourcekey="tabDetailsResource1" BorderStyle="NotSet">
                    <web:base runat="server" ID="objectBase" ObjectNumberVisible="false" ObjectNumberEnabled="false" ObjectNameCaption="Contract Name" meta:resourcekey="objectBaseResource1" OnWorkflowTransitionSelected="objectBase_WorkflowTransitionSelected"></web:base>
                ...
                <ui:UITabView runat="server" ID="UITabViewLevelSurvey" Caption="Service Level Survey"  BorderStyle="NotSet">
                ...
                <ui:UITabView runat="server" ID="tabScheduledWork" Caption="Schedulesd Works" meta:resourcekey="tabScheduledWorkResource1" BorderStyle="NotSet">
