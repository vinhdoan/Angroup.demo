...
<script runat="server">
    ...
    {
        base.OnPreRender(e);
        txtTextFilePathFormat.Visible = txtDayDifference.Visible = cbIsReadFromTextFile.Checked;
    }



    protected void cbIsReadFromTextFile_CheckedChanged(object sender, EventArgs e)
    {
            ...
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabObject" BorderStyle="NotSet" 
                    ...
                    <ui:UITabView ID="uitabview1" runat="server"  Caption="Details" 
                        ...
                        <ui:UIFieldCheckBox runat="server" ID="cbIsReadFromTextFile" PropertyName = "IsReadFromTextFile" Caption="Is Read From Text F rile?" OnCheckedChanged="cbIsReadFromTextFile_CheckedChanged"></ui:UIFieldCheckBox>
                        <ui:UIFieldTextBox runat="server" ID = "txtTextFilePathFormat" PropertyName="TextFilePathFormat" Caption="Text File Path Format" ValidateRequiredField="true" MaxLength="255"></ui:UIFieldTextBox>
                        <ui:UIFieldTextBox runat="server" ID="txtDayDifference" Caption = "Reading Day Difference" PropertyName="BMSReadingDayDifference" ValidateRequiredField="true" Span="Half"></ui:UIFieldTextBox>
                    </ui:UITabView>
