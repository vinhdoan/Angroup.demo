                ...
                <ui:UITabStrip runat="server" ID="tabObject" 
                    ...
                    <ui:UITabView runat="server" ID="tabDetails" Caption="Check Out" 
                        ...
                        <ui:UIPanel runat="server" ID="panelDetails" BorderStyle="NotSet" 
                            ...
                            Caption="Moved to Store" meta:resourcekey="IsMovedToAnotherStoreResource1" 
                                OnCheckedChanged="IsMovedToAnotherStore_CheckChanged" TextAlign="Right"></ui:UIFieldCheckBox>
                            <ui:UIFieldDropDownList runat="server" ID="MoveToStoreID" PropertyName="MoveToStoreID" Caption="Store Moved To"
                                meta:resourcekey="MoveToStoreIDResource1"/>
                            ...
                            <ui:UIGridView runat="server" ID="gridCheckOutItem" PropertyName="StoreCheckOutItems"
                                ...
                                OnRowDataBound="gridCheckOutItem_RowDataBound">
