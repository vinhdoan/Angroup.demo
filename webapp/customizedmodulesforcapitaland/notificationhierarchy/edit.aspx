            ...
            <ui:UITabStrip runat="server" ID="tabObject" BorderStyle="NotSet" 
                ...
                <ui:UITabView ID="tabDetails" runat="server" Caption="Details" 
                    ...
                    <ui:UIGridView ID="gridNotificationHierarchyLevels" runat="server" Caption="Notification Hierarchy Levels"
                        ...
                        ValidateRequiredField="True" DataKeyNames="ObjectID" GridLines="Both" meta:resourcekey="gridNotificationHierarchyLevelsResource1" 
                        ...
                        <Columns>
                            ...
                            <cc1:UIGridViewBoundColumn DataField="PositionNames" HeaderText="Positions" meta:resourcekey="UIGridViewBoundColumnResource10" PropertyName="PositionNames" ResourceAssemblyName="" SortExpression="PositionNames">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                    ...
                    <ui:UIObjectPanel ID="panelNotificationHierarchyLevel" runat="server" 
                        ...
                        <table cellpadding='0' cellspacing='0' style="width: 100%">
                            <tr valign="top">
                                <td style='width: 32%'>
                                    ...
                                    <ui:UIPanel runat="server" ID="panelUsers" BorderStyle="NotSet" 
                                        ...
                                        <ui:UIGridView runat="server" ID="gridUsers" PropertyName="Users" 
                                            ...
                                            SortExpression="ObjectName" DataKeyNames="ObjectID" GridLines="Both" meta:resourcekey="gridUsersResource1" RowErrorColor="" 
                                ...
                                <td style='width: 32%'>
                                    ...
                                    <ui:UIPanel runat="server" ID="panelPositions" BorderStyle="NotSet" meta:resourcekey="panelPositionsResource1">
                                        ...
                                        <ui:UIGridView runat="server" ID="gridPositions" PropertyName="Positions" 
                                            ...
                                            DataKeyNames="ObjectID" GridLines="Both" meta:resourcekey="gridPositionsResource1" RowErrorColor="" style="clear:both;">
                                            <PagerSettings Mode="NumericFirstLast" />
                                            <commands>
                                                <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" 
                                                    CommandName="RemoveObject" CommandText="Remove Selected" 
                                ...
                                <td style='width: 32%'>
                                    <asp:label runat='server' id="labelRoles" Text="Select Roles:" meta:resourcekey="labelRolesResource1"></asp:label>
                                    <ui:UIPanel runat="server" ID="panelRoles" BorderStyle="NotSet" 
                                        ...
                                        <ui:UIGridView runat="server" ID="gridRoles" PropertyName="Roles" 
                                            ...
                                            SortExpression="RoleName" DataKeyNames="ObjectID" GridLines="Both" meta:resourcekey="gridRolesResource1" RowErrorColor="" 
                                            style="clear:both;" ImageRowErrorUrl="">
                                            <PagerSettings Mode="NumericFirstLast" />
                                            <commands>
                                                <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" 
