            ...
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabObject" 
                    ...
                    <ui:UITabView runat="server" ID="tabDetails" Caption="Details" 
                        ...
                        <ui:UIFieldRadioList ID="radioType" runat="server" Caption="Category/Line Item"
                            RepeatDirection="Vertical" PropertyName="Type" 
                        ...
                        <ui:UIFieldTextBox ID="txtReallocationGroupName" runat="server" Caption="Group Name" PropertyName ="ReallocationGroupName">
                        </ui:UIFieldTextBox>
                        <ui:UIPanel runat="server" ID="panelLineItem" BorderStyle="NotSet" 
                            meta:resourcekey="panelLineItemResource1">
                            <ui:uifielddropdownlist runat='server' id="dropAccountType" Caption="Account Type" PropertyName="AccountTypeID" meta:resourcekey="dropAccountTypeResource1"></ui:uifielddropdownlist>
                            <ui:UIFieldTextBox runat="server" ID="textAccountCode" Caption="Account Code" 
                                PropertyName="AccountCode" InternalControlWidth="95%" 
                                meta:resourcekey="textAccountCodeResource1">
                            </ui:UIFieldTextBox>
                            <ui:UIFieldTextBox runat="server" ID="textDescription" Caption="Description" 
                       ...
                       <ui:UIPanel runat="server" ID="TransactionPanel" BorderStyle="NotSet" meta:resourcekey="TransactionPanelResource1">
                        <ui:UIFieldRadioList runat = "server" ID="rdlIsAllTos" Caption="Transaction Types" PropertyName="AppliesToAllPurchaseTypes" OnSelectedIndexChanged="rdlIsAllTos_SelectedIndexChanged" ValidaterequiredField="True" meta:resourcekey="rdlIsAllTosResource1" TextAlign="Right">
                            <Items>
                            <asp:ListItem Value="1" meta:resourcekey="ListItemResource3" 
                                    Text="Apply to all transaction types"></asp:ListItem>
                            <asp:ListItem Value="0" meta:resourcekey="ListItemResource4" 
                                    Text="Apply only to the following transaction types "></asp:ListItem>    
                            </Items>
                        </ui:UIFieldRadioList>
                        <ui:UIFieldListBox ID="listPurchaseType" runat="server" ValidateRequiredField="True"
                            PropertyName="PurchaseTypes" 
                            ToolTip="Purchase Types that assigned to this Account" 
