...
<script runat="server">
    ...
    {
        dropLocation.Bind(OLocation.GetLocationsByType(OApplicationSetting.Current.LocationTypeNameForBuildingActual, null));
    }
...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" meta:resourcekey="panelMainResource1">
        <web:search runat="server" ID="panel" OnPopulateForm="panel_PopulateForm" Caption="Point Tariff"
            ...
            EditButtonVisible="true" AssignedCheckboxVisible="false" SearchAssignedOnly="true"
