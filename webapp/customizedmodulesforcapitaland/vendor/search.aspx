...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" meta:resourcekey="panelResource1" BorderStyle="NotSet">
        <web:search runat="server" ID="panel" Caption="Vendor" GridViewID="gridResults" BaseTable="tVendor" SearchType="ObjectQuery"
                ...
                <ui:UITabView runat="server" ID="uitabview2" Caption="Results" meta:resourcekey="uitabview2Resource1" BorderStyle="NotSet">
                    <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black" KeyName="ObjectID"
                        ...
                        <Columns>
                            ...
                            <cc1:UIGridViewBoundColumn DataField="OperatingAddressPostalCode" HeaderText="Postal Code" meta:resourceKey="OperatingAddressPostalCodeResource" PropertyName="OperatingAddressPostalCode" ResourceAssemblyName="" SortExpression="OperatingAddressPostalCode">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                            ...
                            <cc1:UIGridViewBoundColumn DataField="Currency.ObjectName" HeaderText="Default Currency" meta:resourceKey="UIGridViewBoundColumnResource1" PropertyName="Currency.ObjectName" ResourceAssemblyName="" SortExpression="Currency.ObjectName">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                            <cc1:UIGridViewBoundColumn DataField="TaxCode.ObjectName" HeaderText="Default Tax Code" meta:resourceKey="UIGridViewBoundColumnResource2" PropertyName="TaxCode.ObjectName" ResourceAssemblyName="" SortExpression="TaxCode.ObjectName">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                            <cc1:UIGridViewBoundColumn DataField="IsInterestedPartyText" 
                                HeaderText="Interested Party" PropertyName="IsInterestedPartyText" 
                                ResourceAssemblyName="" SortExpression="IsInterestedPartyText" 
                                meta:resourcekey="UIGridViewBoundColumnResource3">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                            <cc1:UIGridViewBoundColumn DataField="IsInterestedParty" 
                                PropertyName="IsInterestedParty" ResourceAssemblyName="" 
                                SortExpression="IsInterestedParty" Visible="false"
