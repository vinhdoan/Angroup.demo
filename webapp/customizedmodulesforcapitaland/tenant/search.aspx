...
<script runat="server">
    ...
    protected void panel_Search(objectSearchPanel.SearchEventArgs e)
    {
        ...
        e.CustomCondition = e.CustomCondition & TablesLogic.tUser.isTenant == 1;
...
<body>
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="formMain" 
            ...
            <web:search runat="server" ID="panel" Caption="Tenant" GridViewID="gridResults" 
            ...
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabSearch" 
                    ...
                    <ui:UITabView runat="server" ID="uitabview1" Caption="Search" 
                        ...
                        <ui:UIFieldDropDownList runat="server" ID="ddlTenantType" PropertyName="TenantTypeID" Caption="Tenant Type" Span="Half" meta:resourcekey="ddlTenantTypeResource1"></ui:UIFieldDropDownList>
                        <ui:UIFieldTextBox ID="UIFieldTextBox1" runat="server" PropertyName="IndustryTrade" Caption="Industry Trade" InternalControlWidth="95%" meta:resourcekey="UIFieldTextBoxResource1"></ui:UIFieldTextBox>
                        <ui:UIFieldTextBox ID="UIFieldTextBox2" runat="server" PropertyName="UserBase.Address" Caption="Address" InternalControlWidth="95%" meta:resourcekey="UIFieldTextBox2Resource1"></ui:UIFieldTextBox>
                        <ui:UIFieldTextBox ID="UIFieldTextBox3" runat="server" PropertyName="Website" Caption="Website" InternalControlWidth="95%" meta:resourcekey="UIFieldTextBox3Resource1"></ui:UIFieldTextBox>
                        ...
                        <ui:UIFieldTextBox runat="server" ID="UIFieldTextBox17" PropertyName="UserBase.Phone"
                            ...
                            InternalControlWidth="95%" />
                        <ui:UIFieldTextBox ID="UIFieldTextBox4" runat="server" PropertyName="TenantProfile" Caption="Tenant Profile" TextMode="MultiLine" Rows="5" InternalControlWidth="95%" meta:resourcekey="UIFieldTextBox4Resource1"></ui:UIFieldTextBox>
                        <ui:UIFieldTextBox ID="UIFieldTextBox5" runat="server" PropertyName="Highlights" Caption="Highlights" TextMode="MultiLine" Rows="5" InternalControlWidth="95%" meta:resourcekey="UIFieldTextBox5Resource1"></ui:UIFieldTextBox>
                        <ui:UIFieldTextBox ID="UIFieldTextBox6" runat="server" PropertyName="OperationHours" Caption="Operation Hours" InternalControlWidth="95%" meta:resourcekey="UIFieldTextBox6Resource1"></ui:UIFieldTextBox>
                       <ui:UIFieldRadioList runat="server" Caption="From Amos" ID="rdlFromAmos" RepeatColumns="3" RepeatDirection="Vertical" meta:resourcekey="rdlFromAmosResource1" TextAlign="Right">
                        ...
                        <ui:UIFieldDropDownList ID="ddlTenantContactType" runat="server" Caption="Tenant Contact Type" Span="Half" meta:resourcekey="ddlTenantContactTypeResource1"></ui:UIFieldDropDownList>
                    ...
                    <ui:UITabView runat="server" ID="uitabview2" Caption="Results" 
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black" KeyName="ObjectID"
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="ObjectName" HeaderText="Tenant Name" 
                                ...
                                <cc1:UIGridViewBoundColumn DataField="TenantType.ObjectName" HeaderText="Tenant Type" 
                                    PropertyName="TenantType.ObjectName" 
                                    ResourceAssemblyName="" SortExpression="TenantType.ObjectName" meta:resourcekey="UIGridViewBoundColumnResource1">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
