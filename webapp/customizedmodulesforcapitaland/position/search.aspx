        ...
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabSearch" 
                ...
                <ui:UITabView runat="server" ID="uitabview3" Caption="Search" 
                    ...
                    <ui:UIFieldTextBox runat="server" ID="txtUser" PropertyName="PermanentUsers.ObjectName" 
                        Caption="User" InternalControlWidth="95%" meta:resourcekey="txtUserResource3" />
                </ui:UITabView>
                    ...
                    <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" meta:resourcekey="gridResultsResource1"
                        ...
                        <Columns>
                            ...
                            <cc1:UIGridViewBoundColumn DataField="LocationAccess" HeaderText="Location" 
                                ...
                                PropertyName="LocationAccess" ResourceAssemblyName="" 
                                SortExpression="LocationAccess">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
