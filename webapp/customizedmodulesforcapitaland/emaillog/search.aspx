...
<body>
    <form id="form2" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="Received Email History" GridViewID="gridResults" EditButtonVisible="false"
                BaseTable="tEmailLog" SearchType="ObjectQuery">
            </web:search>
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabSearch" BorderStyle="NotSet" 
                    ...
                    <ui:UIFieldDateTime runat='server' ID="DateTimeReceived" SearchType="Range" 
                        PropertyName="DateTimeReceived" Caption="DateTime Received" 
                            meta:resourcekey="DateTimeReceivedResource1" ShowDateControls="True" />
                    <ui:UIFieldTextBox ID="FromRecipient" runat="server" PropertyName = "FromRecipient" 
                            Caption="From Recipient" InternalControlWidth="95%" 
                            meta:resourcekey="FromRecipientResource1" />
                    <ui:UIFieldTextBox ID="Subject" runat="server" PropertyName = "Subject" 
                            Caption="Subject" InternalControlWidth="95%" 
                            meta:resourcekey="SubjectResource1" />
                    <ui:UIFieldTextBox ID="EmailBody" runat="server" PropertyName = "EmailBody" 
                            Caption="Email Body" InternalControlWidth="95%" 
                            meta:resourcekey="EmailBodyResource1" />
                    <ui:UIFieldTextBox ID="ErrorMessage" runat="server" PropertyName = "ErrorMessage" 
                            Caption="Error Message" InternalControlWidth="95%" 
                            meta:resourcekey="ErrorMessageResource1" />
                    <ui:UIFieldRadioList ID="IsSuccessful" runat="server" PropertyName = "IsSuccessful" 
                            Caption="Is Successful" meta:resourcekey="IsSuccessfulResource1" 
                            TextAlign="Right" >
                    <Items>
                    ...
                    <ui:UITabView runat="server" ID="uitabview4" Caption="Results" 
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="DateTimeReceived" 
                                    DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}" HeaderText="DateTime Received" 
                                    meta:resourcekey="UIGridViewBoundColumnResource2" 
                                    PropertyName="DateTimeReceived" ResourceAssemblyName="" 
                                    SortExpression="DateTimeReceived">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="FromRecipient" 
                                    HeaderText="From Recipient" meta:resourcekey="UIGridViewBoundColumnResource3" 
                                    PropertyName="FromRecipient" ResourceAssemblyName="" 
                                    SortExpression="FromRecipient">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="Subject" HeaderText="Subject" 
                                    meta:resourcekey="UIGridViewBoundColumnResource4" PropertyName="Subject" 
                                    ResourceAssemblyName="" SortExpression="Subject">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="IsSuccessfulText" 
                                    HeaderText="Is Successful" meta:resourcekey="UIGridViewBoundColumnResource6" 
                                    PropertyName="IsSuccessfulText" ResourceAssemblyName="" 
                                    SortExpression="IsSuccessfulText">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="ErrorMessage" HeaderText="Error Message" 
                                    meta:resourcekey="UIGridViewBoundColumnResource7" PropertyName="ErrorMessage" 
