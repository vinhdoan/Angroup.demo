                ...
                <ui:UITabView runat="server" ID="tabDetails" Caption="Transfer"
                    ...
                    <ui:UIPanel runat='server' ID="panelDetails" BorderStyle="NotSet" 
                        ...
                        <ui:UIFieldTextBox runat="server" ID="Description" PropertyName="Description"
                            Caption="Remarks" ToolTip="Remarks for the transfer." TextMode="MultiLine" 
                        ...
                        <ui:UIGridView runat="server" ID="gridTransferItem" PropertyName="StoreTransferItems"
                            ...
                            Width="100%" BindObjectsToRows="True"
                            ...
                            style="clear:both;" OnRowDataBound="gridTransferItem_RowDataBound" 
                            ImageRowErrorUrl="">
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn HeaderText="Quantity to Transfer" 
                                    PropertyName="QuantityToTransfer" 
                        ...
                        <ui:UIObjectPanel runat="server" ID="TransferItem_Panel" 
                            ...
                            <ui:UIFieldTextBox runat="server" ID="TransferItem_QuantityToTransfer"
                                PropertyName="QuantityToTransfer" Span="Half" ValidateRequiredField="True"
                                ValidationDataType="Double" Caption="Quantity To Transfer"
                                meta:resourcekey="TransferItem_QuantityResource3" 
