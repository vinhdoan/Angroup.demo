...
<script runat="server">
    ...
    protected void panel_Search(objectSearchPanel.SearchEventArgs e)
    {
        ...
        if (ddlLocation.SelectedValue == "")
        {
            ...
            foreach (OPosition position in AppSession.User.GetPositionsByObjectType("OPurchaseOrder"))
    ...
    protected void gridResults_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (po.CurrentActivityID != null)
            {
                ...
                e.Row.Cells[17].Text = po.CurrentActivity.AssignedUserPositionsWithUserNamesText;
            }
        }
    }
</script>
    ...
    <form id="form2" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="Purchase Order / Letter of Award" GridViewID="gridResults"
                BaseTable="tPurchaseOrder" OnSearch="panel_Search" SearchType="SelectQuery" EditButtonVisible="false"
                    ...
                    <ui:UITabView runat="server" ID="uitabview4" Caption="Results" 
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" Width="100%" SortExpression="ObjectNumber DESC"
                            ...
                            <Columns>
                                ...
                                <ui:UIGridViewBoundColumn PropertyName="TotalPOAmount" 
                                    HeaderText="Total PO Amount" DataFormatString="{0:n}" DataField="TotalPOAmount" 
                                    meta:resourcekey="UIGridViewBoundColumnResource8" ResourceAssemblyName="" 
                                    SortExpression="TotalPOAmount">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </ui:UIGridViewBoundColumn>
                               ...
                               <ui:UIGridViewBoundColumn HeaderText="Assigned Position(s)" 
