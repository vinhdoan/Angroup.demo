...
<body>
    <form id="form2" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain">
            <web:search runat="server" ID="panel" Caption="User Creation" GridViewID="gridResults"  EditButtonVisible="false" SearchType="ObjectQuery"
                BaseTable="tUserCreation" OnPopulateForm="panel_PopulateForm"></web:search> 
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabSearch" meta:resourcekey="tabSearchResource1">
                    <ui:UITabView runat="server" ID="uitabview3" Caption="Search" 
                        ...
                        <ui:UIFieldTextBox runat='server' ID='UIFieldTextBox1' PropertyName="ObjectNumber"
                            Caption="User Creation Number" ToolTip="User Creation Number." MaxLength="255"/>
                        <br />
