            ...
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabSearch" 
                    ...
                    <ui:UITabView runat="server" ID="uitabview1" Caption="Search" 
                        ...
                        <ui:uifieldlistbox runat="server" id="listRoles" PropertyName="PermanentPositions.Position.Role.ObjectID" Caption="Roles" meta:resourcekey="listRolesResource1"></ui:uifieldlistbox>
                    </ui:UITabView>
