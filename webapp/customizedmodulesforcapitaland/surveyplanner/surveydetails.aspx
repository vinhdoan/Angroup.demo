            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                    ...
                    CurrentSP.CurrentActivity.ObjectName != "Cancel")
                {
                    ...
                    hl_ActualSurveyForm.NavigateUrl = Request.ApplicationPath + "/modules/surveyplanner/surveyformload.aspx?SPID=" +
                        HttpUtility.UrlEncode(Security.EncryptGuid(CurrentSP.ObjectID.Value)) + "&SRID=" +
                        HttpUtility.UrlEncode(Security.EncryptGuid(CurrentSRF.SurveyRespondentPortfolio.SurveyRespondentID.Value)) + "&REA=" +
        ...
        <ui:UIObjectPanel runat="server" ID="MainPanel" Width="100%" Style="background-color: white;
            ...
            <ui:UIGridView runat="server" ID="SubGV_SurveyLocationResponseFroms" AllowPaging="False"
                ...
                <Columns>
                    ...
                    <cc1:UIGridViewBoundColumn DataField="SurveyRespondentPortfolio.SurveyRespondentID"
                        HeaderText="SRID" meta:resourcekey="UIGridViewBoundColumnResource4" PropertyName="SurveyRespondentPortfolio.SurveyRespondentID"
                        ResourceAssemblyName="" SortExpression="SurveyRespondentPortfolio.SurveyRespondentID">
                        <ControlStyle Width="30%" />
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
