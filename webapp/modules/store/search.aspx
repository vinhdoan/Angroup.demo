...
<body>
    <form id="form1" runat="server">
        ...
        <web:search runat="server" id="panel" Caption="Store" GridViewID="gridResults" BaseTable="tStore" OnSearch="panel_Search" EditButtonVisible="false"  meta:resourcekey="panelResource1" OnPopulateForm="panel_PopulateForm" SearchType="ObjectQuery">
        </web:search>
        <div class="div-main">
                ...
                <ui:UITabView runat="server" ID="uitabview1" caption="Search"  
                    ...
                    <ui:UIFieldRadioList runat="server" ID="radioStoreType" Caption="Store Type" 
                        ...
                        <Items>
                            ...
                            <asp:listitem value="0" Selected="True" meta:resourcekey="ListItemResource2">A physical storeroom that you can check inventory into or out of.</asp:listitem>
                            <asp:listitem value="1" meta:resourcekey="ListItemResource3">An issue location that you can transfer non-consumables and equipments to.</asp:listitem>
                        </Items>
                    </ui:UIFieldRadioList>
                </ui:UITabView>
