...
<script runat="server">
    ...
    {
        return new LocationEquipmentTreePopulater(selectedLocationId, true, true, true, Security.Decrypt(Request["TYPE"]));
    }
            ...
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabSearch" meta:resourcekey="tabSearchResource1">
                    <ui:UITabView runat="server" ID="uitabview3" Caption="Search" 
                        ...
                        <ui:uifielddatetime runat="server" id="dateReportedDateTime" Caption="Reported Date/Time" PropertyName="ReportedDateTime" SearchType="Range" meta:resourcekey="dateReportedDateTimeResource1">
                            </ui:uifielddatetime>
                    ...
                    <ui:UITabView runat="server" ID="uitabview4" Caption="Results" 
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" Width="100%" meta:resourcekey="gridResultsResource1"
                            AllowPaging="True" AllowSorting="True" PagingEnabled="True" SortExpression="ObjectNumber DESC">
                            <Columns>
                                ...
                                <ui:UIGridViewBoundColumn PropertyName="ReportedDateTime" HeaderText="Reported Date/Time" DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}" meta:resourcekey="UIGridViewBoundColumnResource1" >
                                </ui:UIGridViewBoundColumn>
