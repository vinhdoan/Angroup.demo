...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" BeginningHtml="" 
        BorderStyle="NotSet" EndingHtml="" meta:resourcekey="panelMainResource1">
        ...
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabSearch" BeginningHtml="" 
                BorderStyle="NotSet" EndingHtml="" meta:resourcekey="tabSearchResource1">
                <ui:UITabView runat="server" ID="uitabview3" Caption="Search" BeginningHtml="" 
                    BorderStyle="NotSet" EndingHtml="" meta:resourcekey="uitabview3Resource1">
                    ...
                    <ui:UIFieldRadioList runat="server" ID="radioModeOfForwarding" Caption="Mode of Forwarding"
                        ...
                        <Items>
                            ...
                            <asp:ListItem Value="0" meta:resourcekey="ListItemResource2">None: No approval is required.</asp:ListItem>
                            <asp:ListItem Value="1" meta:resourcekey="ListItemResource3">Direct: The object will be routed immediately to the a user/role authorized to approve the object.</asp:ListItem>
                            <asp:ListItem Value="2" meta:resourcekey="ListItemResource4">Hierarchical: The object will be first routed to first user/role in the approval hierarchy, until it reaches a user/role authorized to approve the object.</asp:ListItem>
                            ...
                            <asp:ListItem Value="3" meta:resourcekey="ListItemResource5">All: The object will be routed to all users/roles from the first to the one authorized to approve the object.</asp:ListItem>
                        </Items>
                    </ui:UIFieldRadioList>
                ...
                <ui:UITabView runat="server" ID="uitabview4" Caption="Results" BeginningHtml="" 
                    BorderStyle="NotSet" EndingHtml="" meta:resourcekey="uitabview4Resource1">
