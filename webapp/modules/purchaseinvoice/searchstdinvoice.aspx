...
<script runat="server">
    ...
    {
        return new LocationTreePopulater(null, false, true, "OPurchaseInvoice");
    }
...
<body>
    <form id="form2" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" meta:resourcekey="panelMainResource1">
            <web:search runat="server" ID="panel" Caption="Purchase Invoice" GridViewID="gridResults" EditButtonVisible="false" AddButtonVisible="false"
                BaseTable="tPurchaseInvoice" OnPopulateForm="panel_PopulateForm" SearchType="ObjectQuery" OnSearch="panel_Search">
            </web:search>
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabSearch" meta:resourcekey="tabSearchResource1">
                    <ui:UITabView runat="server" ID="uitabview3" Caption="Search" meta:resourcekey="uitabview3Resource1">
                        ...
                        <ui:UIFieldDateTime runat='server' ID="dateDateOfInvoice" Caption="Date of Invoice" meta:resourcekey="dateDateOfInvoiceResource1"
                            ShowTimeControls="False" PropertyName="DateOfInvoice" SearchType="Range"
                            Span="Half" />
                        <div style="clear: both">
                        </div>
                        <ui:UIFieldTextBox runat="server" ID="textReferenceNumber" Caption="Reference Number" meta:resourcekey="textReferenceNumberResource1"
                        ...
                        <ui:UIFieldTextBox runat="server" ID="textVendorName" meta:resourcekey="textVendorNameResource1" Caption="Vendor Name" PropertyName="Vendor.ObjectName" MaxLength="255">
                        </ui:UIFieldTextBox>
                    </ui:UITabView>
                    <ui:UITabView runat="server" ID="uitabview4" Caption="Results" meta:resourcekey="uitabview4Resource1" >
                        <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" Width="100%" meta:resourcekey="gridResultsResource1" SortExpression="ObjectNumber DESC" OnRowDataBound="gridResults_RowDataBound" OnAction="gridResults_Action">
                            <Columns>
                                ...
                                <ui:UIGridViewBoundColumn PropertyName="ObjectNumber" HeaderText="Invoice Number" meta:resourcekey="UIGridViewBoundColumnResource1">
                                ...
                                <ui:UIGridViewBoundColumn PropertyName="Vendor.ObjectName" HeaderText="Vendor Name" meta:resourcekey="UIGridViewBoundColumnResource4">
                                </ui:UIGridViewBoundColumn>
                                <ui:UIGridViewBoundColumn PropertyName="Currency.ObjectName" HeaderText="Currency" ItemStyle-ForeColor="#777777" meta:resourcekey="UIGridViewBoundColumnResource5">
                                </ui:UIGridViewBoundColumn>
                                <ui:UIGridViewBoundColumn PropertyName="Currency.CurrencySymbol" HeaderText="" ItemStyle-ForeColor="#777777" meta:resourcekey="UIGridViewBoundColumnResource6">
                                </ui:UIGridViewBoundColumn>
                                <ui:UIGridViewBoundColumn PropertyName="TotalAmountInSelectedCurrency" HeaderText="Total Amount" DataFormatString="{0:n}" ItemStyle-ForeColor="#777777" meta:resourcekey="UIGridViewBoundColumnResource7">
                                </ui:UIGridViewBoundColumn>
                                <ui:UIGridViewBoundColumn PropertyName="TotalTaxInSelectedCurrency" HeaderText="Total Tax" DataFormatString="{0:n}" ItemStyle-ForeColor="#777777" meta:resourcekey="UIGridViewBoundColumnResource8">
                                </ui:UIGridViewBoundColumn>
                                <ui:UIGridViewBoundColumn PropertyName="TotalAmount" HeaderText="Total Amount<br/>(Base Currency)" DataFormatString="{0:c}" HtmlEncode="false" meta:resourcekey="UIGridViewBoundColumnResource9">
                                </ui:UIGridViewBoundColumn>
                                <ui:UIGridViewBoundColumn PropertyName="TotalTax" HeaderText="Total Tax<br/>(Base Currency)" DataFormatString="{0:c}" HtmlEncode="false" meta:resourcekey="UIGridViewBoundColumnResource10">
                                </ui:UIGridViewBoundColumn>
                                <ui:UIGridViewBoundColumn PropertyName="CurrentActivity.ObjectName" HeaderText="Status" meta:resourcekey="UIGridViewBoundColumnResource11"
