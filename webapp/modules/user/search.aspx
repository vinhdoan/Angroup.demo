...
<body>
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="formMain" meta:resourcekey="formMainResource1">
            ...
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabSearch" meta:resourcekey="tabSearchResource1">
                    <ui:UITabView runat="server" ID="uitabview1" Caption="Search" 
                        ...
                        <ui:uifieldlistbox runat="server" id="listPositions" PropertyName="Positions.ObjectID" Caption="Positions" meta:resourcekey="listPositionsResource1"></ui:uifieldlistbox>
                        <ui:uifieldlistbox runat="server" id="listRoles" PropertyName="Positions.Role.ObjectID" Caption="Roles" meta:resourcekey="listRolesResource1"></ui:uifieldlistbox>
                    </ui:UITabView>
