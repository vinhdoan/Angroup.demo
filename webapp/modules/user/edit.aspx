...
<script runat="server">
    ...
    protected void sddl_PositionID_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (sddl_PositionID.SelectedValue != "")
            u.Positions.AddGuid(new Guid(sddl_PositionID.SelectedValue));
        panel.ObjectPanel.BindObjectToControls(u);
    }
</script>
        ...
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1">
                <ui:UITabView runat="server" ID="tabDetails" Caption="Details" meta:resourcekey="tabDetailsResource1">
                    <web:base runat="server" ID="objectBase" ObjectNumberVisible="false" ObjectNameCaption="User Name" ObjectNameMaxLength="50"
                ...
                <ui:UITabView runat="server" ID="tabPosition" Caption="Positions" CssClass="div-from"  meta:resourcekey="tabPositionResource1">
<%--
...
--%>
                        <ui:UIFieldSearchableDropDownList ID="sddl_PositionID" runat="server" Caption="Position" Propertyname="" OnSelectedIndexChanged="sddl_PositionID_SelectedIndexChanged"  meta:resourcekey="sddl_PositionIDResource1"></ui:UIFieldSearchableDropDownList>
                        <table width="96%">
                            <tr>
                                <td width="96%">
                                    <ui:UIGridView runat="server" ID="gv_Position" PropertyName="Positions"
                                        OnAction="gv_Position_Action" Caption="Selected Positions" ValidateRequiredField="True"
                                        CaptionWidth="120px" KeyName="ObjectID" Span="Full" BindObjectsToRows="true"  meta:resourcekey="gv_PositionResource1">
                                        <Columns>
                                            <ui:UIGridViewButtonColumn ImageUrl="~/images/delete.gif" 
                                                CommandName="RemoveObject" ConfirmText="Are you sure you wish to remove this item?"
                                                HeaderText="" meta:resourcekey="UIGridViewButtonColumnResource1">
                                            </ui:UIGridViewButtonColumn>
                                            <ui:UIGridViewBoundColumn PropertyName="ObjectName" HeaderText="Name"  meta:resourcekey="UIGridViewBoundColumnResource1">
                                            </ui:UIGridViewBoundColumn>
                                        </Columns>
                                        <Commands>
                                            <ui:UIGridViewCommand CommandName="RemoveObject" CommandText="Remove" ConfirmText="Are you sure you wish to remove the selected items?"
                ...
                <ui:UITabView runat="server" ID="tabCredentials" Caption="Credentials" meta:resourcekey="tabCredentialsResource1">
                    <ui:UIFieldCheckBox runat="server" ID="checkIsBanned" PropertyName="IsBanned" Caption="Banned"
                        ...
                        OnCheckedChanged="checkIsBanned_CheckedChanged" meta:resourcekey="checkIsBannedResource1">
                    </ui:UIFieldCheckBox>
                    ...
                    <ui:UIFieldCheckBox runat="server" ID="chkResetPassword" Caption="Reset Password"
                        ...
                        OnCheckedChanged="chkResetPassword_CheckedChange" Visible="true" meta:resourcekey="chkResetPasswordResource1" />
