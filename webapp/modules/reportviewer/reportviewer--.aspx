...
<script runat="server">        
                ...
                try
                {
                    ...
                    if (report.ReportType == 1 && report.UseCSharpQuery == 1)
                    {
                        ...
                        if (dataSource is DataSet && template.ReportDataSet != null && template.ReportDataSet.Count > 1)
                        {
                            ...
                            foreach (System.Data.DataTable dt in ((DataSet)dataSource).Tables)
                            {
                            ...
                            if (NumberOfResultAdded != NumberOfReportDataSet)
                                throw new Exception("Number of System.Data.DataTable passed in does not tally with number of datasource defined in the report.");
                        }
                    ...
                    else
                    {
                        if (template != null)
                        {
                            System.Data.DataTable dt = Analysis.DoQuery(report.ReportQuery, reportFields);
                        ...
                        else
                        {
                            ...
                            {
                                System.Data.DataTable dt = GetReportDataSet(df, rDS, reportParamInfo, connectionString, positional, paramPrefix).Tables[0];
    ...
    protected void ExportToExcel()
    {
        ...
        System.IO.File.WriteAllBytes(ConfigurationManager.AppSettings["ReportTempFolder"] + "report.xls", byteImage);
        Microsoft.Office.Interop.Excel.Application oExcel = new Microsoft.Office.Interop.Excel.ApplicationClass();
        Microsoft.Office.Interop.Excel.Workbook oBook = oExcel.Workbooks.Open(ConfigurationManager.AppSettings["ReportTempFolder"] + "report.xls", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
