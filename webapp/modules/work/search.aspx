        ...
        <ui:UIObjectPanel runat="server" ID="panelMain" BeginningHtml="" 
            ...
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabSearch" 
                    meta:resourcekey="tabSearchResource1" BeginningHtml="" BorderStyle="NotSet" 
                    EndingHtml="">
                    <ui:UITabView runat="server" ID="uitabview3" Caption="Search" 
                        meta:resourcekey="uitabview3Resource1" BeginningHtml="" 
                        ...
                        <ui:UIFieldDateTime runat="server" ID="ScheduledStartDateTime" PropertyName="ScheduledStartDateTime"
                            ...
                            meta:resourcekey="ScheduledStartDateTimeResource1" SearchType="Range"></ui:UIFieldDateTime>
                        <ui:UIFieldDateTime runat="server" ID="ScheduledEndDateTime" PropertyName="ScheduledEndDateTime"
                            ...
                            ImageClearUrl="~/calendar/dateclr.gif" ImageUrl="~/calendar/date.gif" 
                            meta:resourcekey="ScheduledEndDateTimeResource1" SearchType="Range"></ui:UIFieldDateTime>
                        <br />
                        <br />
                        ...
                        <ui:UIFieldDateTime runat="server" ID="ActualStartDateTime" PropertyName="ActualStartDateTime"
                            ...
                            ImageClearUrl="~/calendar/dateclr.gif" ImageUrl="~/calendar/date.gif" 
                            meta:resourcekey="ActualStartDateTimeResource1" SearchType="Range"></ui:UIFieldDateTime>
                        <ui:UIFieldDateTime runat="server" ID="ActualEndDateTime" PropertyName="ActualEndDateTime"
                            Caption="Actual End" VisibleRoles="SYSTEMADMIN" ToolTip="The date/time in which the work actually completed."
                            ImageClearUrl="~/calendar/dateclr.gif" ImageUrl="~/calendar/date.gif" 
                            meta:resourcekey="ActualEndDateTimeResource1" SearchType="Range"></ui:UIFieldDateTime>
                        <br />
                        <br />
                    ...
                    <ui:UITabView runat="server" ID="uitabview4" Caption="Results" 
                        meta:resourcekey="uitabview4Resource1" BeginningHtml="" 
                        BorderStyle="NotSet" EndingHtml="">
                        ...
                        <ui:UIButton ID="buttonExportProject" runat="server" ImageUrl="~/images/view.gif" 
                            Text="Export to Microsoft Project" OnClick="buttonExportProject_Click" 
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" meta:resourcekey="gridResultsResource1"
                            Width="100%" SortExpression="ObjectNumber DESC" DataKeyNames="ObjectID" 
