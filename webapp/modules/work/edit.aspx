...
<script runat="server">
    ...
    {
        OWork work = panel.SessionObject as OWork;
        return new LocationEquipmentTreePopulater(work.LocationID, false, true, true, Security.Decrypt(Request["TYPE"]));
    }
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        WorkCost_ActualUnitCost.Enabled = WorkCost_CostType.SelectedIndex == 2;
        WorkCost_EstimatedCostFactor.Enabled = (WorkCost_CostType.SelectedIndex != 0 && WorkCost_CostType.SelectedIndex != 1);
        WorkCost_ActualCostFactor.Enabled = (WorkCost_CostType.SelectedIndex != 0 && WorkCost_CostType.SelectedIndex != 1);
        WorkCost_EstimatedOvertime.Visible = WorkCost_CostType.SelectedIndex == 0;
        WorkCost_ActualOvertime.Visible = WorkCost_CostType.SelectedIndex == 0;
        ...
        Location.Enabled = work.WorkCost.Count == 0;
        Equipment.Enabled = work.WorkCost.Count == 0;
        TypeOfWorkID.Enabled = work.WorkCost.Count == 0;
        TypeOfServiceID.Enabled = work.WorkCost.Count == 0;
        ...
        tabChecklist.Enabled = state.Is("Start", "Draft", "PendingExecution", "PendingMaterial", "PendingContractor", "PendingClosure");
        tabResolution.Visible = state.Is("PendingExecution", "PendingMaterial", "PendingContractor", "PendingClosure");
        ...
        panelActualCost.Visible = state.Is("PendingExecution", "PendingMaterial", "PendingContractor", "PendingClosure");
    ...
    protected void WorkCost_SubPanel_PopulateForm(object sender, EventArgs e)
    {
        ...
        if (workCost.CostType == WorkCostType.Material)
        {
            ...
            WorkCost_StoreID.Enabled = workCost.EstimatedUnitCost == null && workCost.ActualUnitCost == null;
            WorkCost_StoreBinID.Enabled = workCost.EstimatedUnitCost == null && workCost.ActualUnitCost == null;
    ...
    protected void CostType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else if (WorkCost_CostType.SelectedIndex == 1)
        {
            WorkCost_EstimatedCostFactor.Text = "1.0";
            WorkCost_ActualCostFactor.Text = "1.0";
        }
    ...
    protected void gridChecklist_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            Guid id = (Guid)gridChecklist.DataKeys[e.Row.DataItemIndex][0];
            OWork work = (OWork)panel.SessionObject;
    ...
    protected void buttonApplyPoints_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < idlist.Count; i++)
        {
            ...
            temp.Source = ReadingSource.Work;
        ...
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabObject" 
                ...
                <ui:UITabView runat="server" ID="uitabview1" Caption="Details" 
                    ...
                    <web:base runat="server" ID="objectBase" ObjectNameVisible="false" ObjectNumberCaption="Work Number" ObjectNumberEnabled="false" ObjectNumberVisible="false" meta:resourcekey="objectBaseResource1" ></web:base>
                            ...
                            <tr>
                                <td style="width: 450px">
                                    <ui:UIFieldDateTime runat="server" ID="ArrivalDateTime" 
                                        ...
                                        ImageClearUrl="~/calendar/dateclr.gif" ImageUrl="~/calendar/date.gif" 
                                        meta:resourcekey="ArrivalDateTimeResource1" ShowDateControls="True">
                                    </ui:UIFieldDateTime>
                                </td>
                                <td>
                    ...
                    <ui:UIPanel runat="server" ID="panelWorkCost" 
                        ...
                        <ui:UIGridView runat="server" ID="WorkCost" Caption="Work Cost and Labor" 
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="CraftStore" HeaderText="Craft / Store" 
                                    meta:resourcekey="UIGridViewBoundColumnResource1" PropertyName="CraftStore" 
                                    ResourceAssemblyName="" SortExpression="CraftStore">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="UnitOfMeasureText" HeaderText="Unit" 
                                    ...
                                    SortExpression="UnitOfMeasureText">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="EstimatedUnitCost" 
                                    DataFormatString="{0:c}" HeaderText="Est. Unit Cost&lt;br/&gt;(Base Currency)" 
                                    HtmlEncode="False" meta:resourcekey="UIGridViewBoundColumnResource3" 
                                ...
                                <cc1:UIGridViewBoundColumn DataField="EstimatedSubTotal" 
                                    DataFormatString="{0:c}" HeaderText="Total&lt;br/&gt;(Base Currency)" 
                                    HtmlEncode="False" meta:resourcekey="UIGridViewBoundColumnResource4" 
                                    PropertyName="EstimatedSubTotal" ResourceAssemblyName="" 
                                    SortExpression="EstimatedSubTotal">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="ActualUnitCost" DataFormatString="{0:c}" 
                                    HeaderText="Act. Unit Cost&lt;br/&gt;(Base Currency)" HtmlEncode="False" 
                                    meta:resourcekey="UIGridViewBoundColumnResource5" PropertyName="ActualUnitCost" 
                                    ResourceAssemblyName="" SortExpression="ActualUnitCost">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="ActualSubTotal" DataFormatString="{0:c}" 
                                    HeaderText="Total&lt;br/&gt;(Base Currency)" HtmlEncode="False" 
                                ...
                                <cc1:UIGridViewBoundColumn DataField="ChargeOut" DataFormatString="{0:c}" 
                                    HeaderText="Charge&lt;br/&gt;(Base Currency)" HtmlEncode="False" 
                        ...
                        <ui:UIObjectPanel runat="server" ID="WorkCost_ObjectPanel" 
                            ...
                            <ui:UIPanel runat="server" ID="WorkCost_Panel1" 
                                ...
                                <ui:UIFieldDropDownList runat="server" ID="WorkCost_UserID" PropertyName="UserID" Caption="Technician" ValidateRequiredField="True" meta:resourcekey="WorkCost_UserIDResource1" ToolTip="The technician that will be assigned to the work.">
                                </ui:UIFieldDropDownList>
                            </ui:UIPanel>
                ...
                <ui:UITabView runat="server" ID="tabChecklist" Caption="Checklist" 
                    ...
                    <ui:UIGridView runat="server" ID="gridChecklist" Caption="Checklist" 
                        ...
                        <Columns>
                            ...
                            <cc1:UIGridViewTemplateColumn HeaderText="123" 
