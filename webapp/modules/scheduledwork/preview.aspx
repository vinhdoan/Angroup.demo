...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" meta:resourcekey="panelMainResource1">
        ...
        <asp:Table ID="Table1" runat="server" meta:resourcekey="TableResource1">
            <asp:TableRow ID="TableRow1" runat="server" meta:resourcekey="TableRowResource1">
                ...
                <asp:TableCell ID="TableCell1" runat="server" Width="100px" meta:resourcekey="TableCellResource4"
                    Text="Holiday"></asp:TableCell>
                <asp:TableCell ID="TableCell2" runat="server" Width="50px" meta:resourcekey="TableCellResource5"
                    Text="&amp;nbsp"></asp:TableCell>
                <asp:TableCell runat="server" ID="WorkLegend" Width="50px" meta:resourcekey="WorkLegendResource2"
                    Text="&amp;nbsp"></asp:TableCell>
                <asp:TableCell ID="TableCell3" runat="server" Width="150px" meta:resourcekey="TableCellResource6"
