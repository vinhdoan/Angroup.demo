...
<script runat="server">
    ...
    protected void gridResults_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
            e.Row.Cells[6].Text = (e.Row.Cells[6].Text == "0" ? "No" : "Yes");
    }
</script>
...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" BeginningHtml="" BorderStyle="NotSet"
        ...
        <web:search runat="server" ID="panel" Caption="Survey Group" GridViewID="gridResults" EditButtonVisible="false"
            BaseTable="tSurveyGroup" meta:resourcekey="panelResource1"></web:search>
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabSearch" BeginningHtml="" BorderStyle="NotSet"
                ...
                <ui:UITabView runat="server" ID="uitabview4" Caption="Results" BeginningHtml="" BorderStyle="NotSet"
                    ...
                    <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" Width="100%" OnRowDataBound="gridResults_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <cc1:UIGridViewBoundColumn DataField="ObjectName" HeaderText="Survey Group Name"
                            ...
                            <cc1:UIGridViewBoundColumn DataField="Checklist.ObjectName" HeaderText="Default Survey Checklist"
                                meta:resourcekey="UIGridViewBoundColumnResource2" PropertyName="Checklist.ObjectName"
                                ResourceAssemblyName="" SortExpression="Checklist.ObjectName">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                            <cc1:UIGridViewBoundColumn DataField="ContractMandatory" HeaderText="Contract Mandatory"
                                meta:resourcekey="UIGridViewBoundColumnResource3" PropertyName="ContractMandatory"
                                ResourceAssemblyName="" SortExpression="ContractMandatory">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                        </Columns>
