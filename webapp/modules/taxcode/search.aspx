                ...
                <ui:UITabStrip runat="server" ID="tabSearch" meta:resourcekey="tabSearchResource1">
                    <ui:UITabView runat="server" ID="uitabview3" Caption="Search" 
                        ...
                        <ui:UIFieldTextBox ID="TaxPercentage" runat="server" Caption="Tax (%)" Span="Half"
                            SearchType="Range" ValidateDataTypeCheck='True' ValidationDataType="Currency"
                            meta:resourcekey="TaxPercentageResource1" />
                        <ui:UIFieldDateTime runat="server" ID="dateStartDate" PropertyName="StartDate" Caption="Valid From:" Span="Half" SearchType="Range"></ui:UIFieldDateTime>
