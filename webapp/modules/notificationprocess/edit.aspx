...
<script runat="server">
    ...
    {
        ONotificationProcess obj = (ONotificationProcess)panel.SessionObject;
        return new LocationTreePopulater(obj.LocationID, true, true, Security.Decrypt(Request["TYPE"]));
    }
                    ...
                    <ui:UIPanel runat="server" ID="panelNotificationHierarchy" BorderStyle="NotSet" 
                        ...
                        <tr>
                            <td style='width: 120px'><asp:label runat="server" 
                                    ...
                                    meta:resourcekey="labelNotificationLevelAsLimitResource1">Limit:</asp:label></td>
                            <td>
                                <asp:label runat="server" id="labelNotificationLevelAsLimit1" 
                                    meta:resourcekey="labelNotificationLevelAsLimit1Resource1">Use notification level </asp:label>
                                ...
                                <asp:label runat="server" id="labelNotificationLevelAsLimit2" 
                                    meta:resourcekey="labelNotificationLevelAsLimit2Resource1">as the timings for the service level limit.</asp:label>
                            </td>
                        </tr>
                        </table>
