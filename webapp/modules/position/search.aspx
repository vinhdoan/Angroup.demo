...
<script runat="server">
    ...
    {
        ddlRoleCode.Bind(ORole.GetAllRoles(), "RoleCode", "ObjectID");
...
<body>
    <form id="form2" runat="server">
        ...
        <web:search runat="server" ID="panel" Caption="Position" GridViewID="gridResults" EditButtonVisible="false"
            BaseTable="tPosition" OnSearch="panel_Search" meta:resourcekey="panel"
            ...
            <ui:UITabStrip runat="server" ID="tabSearch" 
                ...
                <ui:UITabView runat="server" ID="uitabview3" Caption="Search" 
                    ...
                    <ui:UIFieldTextBox runat="server" ID="txtPositionName" PropertyName="ObjectName"
                        ...
                        meta:resourcekey="txtPositionNameResource1" />
                    <ui:UIFieldDropDownList runat="server" ID="ddlRoleCode" PropertyName="RoleID" Caption="Role"
                        OnSelectedIndexChanged="ddlRoleCode_SelectedIndexChanged" 
                        meta:resourcekey="ddlRoleCodeResource1" />
                    <ui:UIFieldTextBox runat="server" ID="txtUser" PropertyName="Users.ObjectName" 
                        Caption="User" InternalControlWidth="95%" meta:resourcekey="txtUserResource1" />
                </ui:UITabView>
                    ...
                    <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" meta:resourcekey="gridResultsResource1"
                        ...
                        <Columns>
                            ...
                            <cc1:UIGridViewBoundColumn DataField="Role.RoleName" HeaderText="Role Name" 
                                meta:resourcekey="UIGridViewBoundColumnResource2" PropertyName="Role.RoleName" 
                                ResourceAssemblyName="" SortExpression="Role.RoleName">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                            <cc1:UIGridViewBoundColumn DataField="LocationAccess" HeaderText="Location" 
                                meta:resourcekey="UIGridViewBoundColumnResource3" PropertyName="LocationAccess" 
                                ResourceAssemblyName="" SortExpression="LocationAccess">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                            <cc1:UIGridViewBoundColumn DataField="EquipmentAccess" HeaderText="Equipment" 
                                meta:resourcekey="UIGridViewBoundColumnResource4" 
                                PropertyName="EquipmentAccess" ResourceAssemblyName="" 
                                SortExpression="EquipmentAccess">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                        </Columns>
