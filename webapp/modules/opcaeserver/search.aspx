...
<body>
    <form id="form2" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="OPC AE Server" GridViewID="gridResults" EditButtonVisible="false"
                BaseTable="tOPCAEServer" SearchType="ObjectQuery" meta:resourcekey="panelResource1">
            </web:search>
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabSearch" BorderStyle="NotSet" 
                    ...
                    <ui:UITabView runat="server" ID="uitabview3" Caption="Search" 
                        ...
                        <ui:UIFieldRadioList runat="server" ID="radioReceivingEventsEnabled" 
                            Caption="Events Enabled" PropertyName="ReceivingEventsEnabled" 
                            RepeatColumns="0" meta:resourcekey="radioReceivingEventsEnabledResource1" 
                            TextAlign="Right">
                            <Items>
                    ...
                    <ui:UITabView runat="server" ID="uitabview4" Caption="Results" 
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="ReceivingEventsEnabledText" 
                                    HeaderText="Events Enabled" meta:resourcekey="UIGridViewBoundColumnResource2" 
                                    PropertyName="ReceivingEventsEnabledText" ResourceAssemblyName="" 
                                    SortExpression="ReceivingEventsEnabledText">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                            </Columns>
