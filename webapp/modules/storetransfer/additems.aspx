...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
        ...
        <web:search runat="server" ID="panel" Caption="Add Consumables/Non-Consumables"
                ...
                <ui:UITabView runat="server" ID="tabResults" Caption="Results" 
                    ...
                    <ui:UIObjectPanel runat="server" ID="panelAddItems" BorderStyle="NotSet" 
                        ...
                        <ui:UIHint runat="server" ID="hintNonConsumablesOnly" 
                            meta:resourcekey="hintNonConsumablesOnlyResource1"><asp:Table 
                            runat="server" CellPadding="4" CellSpacing="0" Width="100%"><asp:TableRow 
                                runat="server"><asp:TableCell runat="server" VerticalAlign="Top" Width="16px"><asp:Image 
                                    ...
                                    runat="server" VerticalAlign="Top"><asp:Label runat="server"> You can only add non-consumables for this transfer because you have selected an issue location to transfer items from OR an issue location to transfer items to. </asp:Label></asp:TableCell></asp:TableRow></asp:Table></ui:UIHint>
