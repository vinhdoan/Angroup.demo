    ...
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="Transfer" GridViewID="gridResults"
                ...
                OnPopulateForm="panel_PopulateForm" meta:resourcekey="panelResource1" OnSearch="panel_Search"></web:search>
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabSearch" 
                    ...
                    <ui:UITabView runat="server" ID="uitabview1" Caption="Search" 
                        ...
                        <ui:UIFieldTextBox runat='server' ID="Description" PropertyName="Description" Caption="Description"
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black" SortExpression="ObjectNumber"
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="ObjectNumber" 
                                    HeaderText="Transfer Number" meta:resourceKey="UIGridViewColumnResource4" 
                                    PropertyName="ObjectNumber" ResourceAssemblyName="" 
                                    SortExpression="ObjectNumber">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="FromStoreTypeText" HeaderText="From Type" 
                                    meta:resourcekey="UIGridViewBoundColumnResource1" 
                                    PropertyName="FromStoreTypeText" ResourceAssemblyName="" 
                                    SortExpression="FromStoreTypeText">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="FromStoreText" HeaderText="From" 
                                    meta:resourceKey="UIGridViewColumnResource5" PropertyName="FromStoreText" 
                                    ResourceAssemblyName="" SortExpression="FromStoreText">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="ToStoreTypeText" HeaderText="From Type" 
                                    meta:resourcekey="UIGridViewBoundColumnResource2" 
                                    PropertyName="ToStoreTypeText" ResourceAssemblyName="" 
                                    SortExpression="ToStoreTypeText">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="ToStoreText" HeaderText="To" 
                                    meta:resourceKey="UIGridViewColumnResource6" PropertyName="ToStoreText" 
                                    ResourceAssemblyName="" SortExpression="ToStoreText">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="Description" HeaderText="Description" 
                                    meta:resourceKey="UIGridViewColumnResource7" PropertyName="Description" 
