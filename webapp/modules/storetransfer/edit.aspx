...
<script runat="server">
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        if (storeTransfer.FromStoreType == StoreType.Storeroom)
            FromStoreID.Bind(OStore.FindAccessibleStores(AppSession.User, Security.Decrypt(Request["TYPE"]), storeTransfer.FromStoreID, true, false));
        else
        ...
        if (storeTransfer.ToStoreType == StoreType.Storeroom)
            ToStoreID.Bind(OStore.FindAccessibleStores(AppSession.User, Security.Decrypt(Request["TYPE"]), storeTransfer.ToStoreID, true, false));
        else
            ToStoreID.Bind(OStore.GetIssueLocationAsList(storeTransfer.ToLocationID, storeTransfer.ToStoreID), false);

        if (!IsPostBack)
        {
            ((UIGridViewBoundColumn)gridTransferItem.Columns[8]).DataFormatString = OApplicationSetting.Current.BaseCurrency.CurrencySymbol + "{0:n}";
    ...
    {
        OStoreTransferItem storeTransferItem = TransferItem_SubPanel.SessionObject as OStoreTransferItem;
        return new CatalogueTreePopulater(storeTransferItem.CatalogueID, true, true, true, true);
    }
    ...
    protected void TransferItem_CatalogueID_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        TransferItem_FromStoreBinID.Bind(
            OStore.FindBinsByCatalogue((Guid)transfer.FromStoreID, item.CatalogueID, true), "ObjectName", "ObjectID", true);
        TransferItem_ToStoreBinID.Bind(
    ...
    protected TreePopulater treeFromLocation_AcquireTreePopulater(object sender)
    {
        ...
        return new LocationTreePopulater(storeTransfer.FromLocationID, false, true, "OStoreTransfer");
    }
    ...
    protected TreePopulater treeToLocation_AcquireTreePopulater(object sender)
    {
        ...
        return new LocationTreePopulater(storeTransfer.ToLocationID, false, true, "OStoreTransfer");
    }
    ...
    <ui:UIObjectPanel runat="serveR" ID="panelMain" BorderStyle="NotSet" 
        ...
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabObject" 
                ...
                <ui:UITabView runat="server" ID="tabDetails" Caption="Transfer"
                    meta:resourcekey="uitabview1Resource1" BorderStyle="NotSet">
                    <web:base runat="server" ID="objectBase" ObjectNumberVisible="false"
                        ObjectNameVisible="false" ObjectNumberEnabled="false" ObjectNumberCaption="Transfer Number"
                    ...
                    <ui:UIPanel runat='server' ID="panelDetails" BorderStyle="NotSet" 
                        ...
                        <ui:UIPanel runat="server" ID="panelStore" BorderStyle="NotSet" 
                            meta:resourcekey="panelStoreResource1">
                            <table cellpadding='0' cellspacing='0' border='0'>
                                <tr valign="top">
                                    <td>
                                        <ui:UISeparator runat="server" ID="UISeparator1" Caption="From Store" 
                                            meta:resourcekey="UISeparator1Resource1" />
                                        <ui:UIFieldRadioList runat="server" ID="radioFromStoreType" Caption="Store Type"
                                            PropertyName="FromStoreType" 
                                            OnSelectedIndexChanged="radioFromStoreType_SelectedIndexChanged" 
                                            ValidateRequiredField="True" meta:resourcekey="radioFromStoreTypeResource1" 
                                            TextAlign="Right">
                                            <Items>
                                        ...
                                        <ui:UIFieldTreeList runat="server" ID="treeFromLocation" PropertyName="FromLocationID"
                                            ...
                                            OnSelectedNodeChanged="treeFromLocation_SelectedNodeChanged"
                                            ValidateRequiredField="True" meta:resourcekey="treeFromLocationResource1" 
                                        ...
                                        <ui:UIFieldDropDownList runat="server" ID="FromStoreID" ValidateRequiredField="True"
                                            ...
                                            OnSelectedIndexChanged="FromStoreID_SelectedIndexChanged"
                                            meta:resourcekey="FromStoreIDResource1" />
                                    </td>
                                    <td style="width:5%">
                                    </td>
                                    <td>
                                        <ui:UISeparator runat="server" ID="UISeparator2" Caption="To Store" 
                                            meta:resourcekey="UISeparator2Resource1" />
                                        <ui:UIFieldRadioList runat="server" ID="radioToStoreType" Caption="Store Type"
                                            PropertyName="ToStoreType" OnSelectedIndexChanged="radioToStoreType_SelectedIndexChanged"
                                            ValidateRequiredField="True" meta:resourcekey="radioToStoreTypeResource1" 
                                            TextAlign="Right">
                                            <Items>
                                        ...
                                        <ui:UIFieldTreeList runat="server" ID="treeToLocation" PropertyName="ToLocationID"
                                            ...
                                            OnSelectedNodeChanged="treeToLocation_SelectedNodeChanged"
                                            ValidateRequiredField="True" meta:resourcekey="treeToLocationResource1" 
                                            ShowCheckBoxes="None" TreeValueMode="SelectedNode">
                                        </ui:UIFieldTreeList>
                        ...
                        <br />
                        <br />
                        <ui:UIFieldTextBox runat="server" ID="Description" PropertyName="Description"
                            Caption="Remarks" ToolTip="Remarks for the transfer." 
                        ...
                        <ui:UIButton runat="server" ID="buttonAddItems" Text="Add Consumables/Non-Consumables"
                            ImageUrl="~/images/add.gif" CausesValidation="False" 
                            OnClick="buttonAddItems_Click" meta:resourcekey="buttonAddItemsResource1" />
                        <ui:UIButton runat="server" ID="buttonAddEquipment" Text="Add Equipment"
                            ImageUrl="~/images/add.gif" CausesValidation="False" 
                            OnClick="buttonAddEquipment_Click" 
                        ...
                        <ui:UIGridView runat="server" ID="gridTransferItem" PropertyName="StoreTransferItems"
                            ...
                            Width="100%"
                            PagingEnabled="True" RowErrorColor="" ValidateRequiredField="True" 
                            ShowFooter="True" PageSize="1000" DataKeyNames="ObjectID" GridLines="Both" 
                            style="clear:both;">
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="Catalogue.ObjectName" HeaderText="Item" 
                                ...
                                <cc1:UIGridViewBoundColumn DataField="StoreBinItem.Equipment.ObjectName" 
                                    HeaderText="Equipment Name" meta:resourcekey="UIGridViewBoundColumnResource1" 
                                    PropertyName="StoreBinItem.Equipment.ObjectName" ResourceAssemblyName="" 
                                    SortExpression="StoreBinItem.Equipment.ObjectName">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="FromStoreBin.ObjectName" 
                                    HeaderText="From Bin" meta:resourceKey="UIGridViewColumnResource8" 
                                    PropertyName="FromStoreBin.ObjectName" ResourceAssemblyName="" 
                                    SortExpression="FromStoreBin.ObjectName">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="ToStoreBin.ObjectName" 
                                    HeaderText="To Bin" meta:resourceKey="UIGridViewColumnResource9" 
                                    PropertyName="ToStoreBin.ObjectName" ResourceAssemblyName="" 
                                    SortExpression="ToStoreBin.ObjectName">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="Quantity" HeaderText="Quantity" 
                                    meta:resourceKey="UIGridViewColumnResource10" PropertyName="Quantity" 
                                ...
                                <cc1:UIGridViewBoundColumn DataField="EstimatedUnitCost" 
                                    HeaderText="Estimated Unit Cost" 
                                ...
                                <cc1:UIGridViewBoundColumn DataField="SubTotal" DataFormatString="{0:n}" 
                                    FooterAggregate="Sum" HeaderText="Sub Total" 
                        ...
                        <ui:UIObjectPanel runat="server" ID="TransferItem_Panel" 
                            meta:resourcekey="TransferItem_PanelResource1" BorderStyle="NotSet">
                            ...
                            <ui:UIFieldTreeList runat="server" ID="TransferItem_CatalogueID"
                                PropertyName="CatalogueID" Caption="Catalogue" ValidateRequiredField="True"
                                OnAcquireTreePopulater="TransferItemID_AcquireTreePopulater"
                                ToolTip="Item being transferred." OnSelectedNodeChanged="TransferItem_CatalogueID_SelectedNodeChanged"
                                meta:resourcekey="TransferItem_CatalogueIDResource1" ShowCheckBoxes="None" 
                                TreeValueMode="SelectedNode" />
                            <ui:UIFieldLabel runat="server" ID="TransferItem_UnitOfMeasure"
                                PropertyName="Catalogue.UnitOfMeasure.ObjectName" Caption="Unit of Measure"
                                meta:resourcekey="TransferItem_UnitOfMeasureResource1" 
                                DataFormatString="" />
                            <ui:UIFieldDropDownList runat="server" ID="TransferItem_FromStoreBinID"
                                ValidateRequiredField="True" PropertyName="FromStoreBinID"
                                Caption="From Bin" Span="Half" ToolTip="Bin of the store where the item is transferred from."
                            ...
                            <ui:UIFieldDropDownList runat="server" ID="dropStoreBinItem"
                                PropertyName="StoreBinItemID" Caption="Equipment" 
                                ToolTip="The equipment to be transferred." 
                                meta:resourcekey="dropStoreBinItemResource1">
                            </ui:UIFieldDropDownList>
                            <ui:UIFieldDropDownList runat="server" ID="TransferItem_ToStoreBinID"
                                ValidateRequiredField="True" PropertyName="ToStoreBinID"
                                Caption="To Bin" Span="Half" ToolTip="Bin of the store where the item is transferred to."
                                meta:resourcekey="TransferItem_ToStoreBinIDResource1">
                            </ui:UIFieldDropDownList>
                            <ui:UIFieldTextBox runat="server" ID="TransferItem_Quantity"
                                PropertyName="Quantity" Span="Half" ValidateRequiredField="True"
                                ValidationDataType="Double" Caption="Quantity to Transfer"
                                meta:resourcekey="TransferItem_QuantityResource1" 
