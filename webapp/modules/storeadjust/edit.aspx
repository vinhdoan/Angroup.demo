...
<script runat="server">
    ...
    protected TreePopulater Adjust_CatalogueID_AcquireTreePopulater(object sender)
    {
        ...
        List<OStore> storeList = TablesLogic.tStore.LoadList(TablesLogic.tStore.ObjectID == storeAdjust.StoreID);
        return new CatalogueTreePopulater(storeAdjustItem.CatalogueID, true, true,true,true,storeList);
    }
