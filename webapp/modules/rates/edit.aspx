                ...
                <ui:UITabStrip runat="server" ID="tabObject" 
                    ...
                    <ui:UITabView runat="server" ID="uitabview1" Caption="Details" 
                        ...
                        <ui:UIFieldTreeList runat="server" ID="ParentID" PropertyName="ParentID" Caption="Belongs Under"
                            ...
                            ToolTip="Indicates the book or group under which this item belongs." 
                            meta:resourcekey="ParentIDResource1" ShowCheckBoxes="None" 
                            TreeValueMode="SelectedNode" />
                        <ui:UIPanel runat="server" ID="nonBookPanel" 
                            ...
                            <ui:UIPanel runat="server" ID="ratePanel" meta:resourcekey="ratePanelResource1" 
                                BorderStyle="NotSet">
                                ...
                                <ui:UIFieldTextBox runat="server" ID="UnitPrice" PropertyName="UnitPrice" Caption="Unit Price ($)"
                                    ...
                                    meta:resourcekey="UnitPriceResource1" ValidationNumberOfDecimalPlaces="2" 
                                    InternalControlWidth="95%" />
                                <ui:UIFieldTextBox runat="server" ID="textItemCode" PropertyName="ItemCode" 
                                    Caption="Item Code" meta:resourcekey="textItemCodeResource1" 
                                ...
                                <ui:UIFieldTextBox runat="server" ID="PageNumber" PropertyName="PageNumber" Caption="Page Number"
                                    Span="Half" ToolTip="The page number of the item." 
                                    meta:resourcekey="PageNumberResource1" InternalControlWidth="95%" />
                            </ui:UIPanel>
                        </ui:UIPanel>
                    </ui:UITabView>
