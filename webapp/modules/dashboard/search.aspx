...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain">
        <web:search runat="server" ID="panel" Caption="Dashboard" GridViewID="gridResults"
            SearchType="ObjectQuery" BaseTable="tDashboard" OnSearch="panel_Search" EditButtonVisible="false"
            SearchTextBoxHint="E.g.: Dashboard Name" AutoSearchOnLoad="true"
            MaximumNumberOfResults="100" SearchTextBoxPropertyNames="ObjectName"
        ...
        <div class="div-form">
            ...
            <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" meta:resourcekey="gridResultsResource1"
                ...
                <Columns>
                    ...
                    <ui:UIGridViewBoundColumn PropertyName="ObjectName" HeaderText="Dashboard Name" meta:resourcekey="UIGridViewColumnResource4">
                    </ui:UIGridViewBoundColumn>
                    <ui:UIGridViewBoundColumn PropertyName="DashboardTypeText" HeaderText="Dashboard Type"
