...
<script runat="server">
    ...
    {
        return new LocationTreePopulater(((OEquipment)panel.SessionObject).LocationID, false, true, Security.Decrypt(Request["TYPE"]));
    }
...
<body>
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BeginningHtml="" BorderStyle="NotSet" EndingHtml="" meta:resourcekey="panelMainResource1">
            ...
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1" BeginningHtml="" BorderStyle="NotSet" EndingHtml="">
                    <ui:UITabView runat="server" ID="uitabview1" Caption="Details" 
                        meta:resourcekey="uitabview1Resource1" BeginningHtml="" BorderStyle="NotSet" EndingHtml="">
                        ...
                        <ui:UIPanel runat="server" ID="panelEquipment1" meta:resourcekey="panelEquipment1Resource1" BeginningHtml="" BorderStyle="NotSet" EndingHtml="">
                            ...
                            <ui:uipanel runat="server" id="panelLocation">
                                <ui:uifieldradiolist runat="server" id="radioIsInstore" PropertyName="IsInStore" caption="Store/Location" validaterequiredfield="true" OnSelectedIndexChanged="radioIsInstore_SelectedIndexChanged">   
                                    <Items>
                                        <asp:ListItem value="0">This equipment is currently in a Location.</asp:ListItem>
                                        <asp:ListItem value="1">This equipment is currently in a Store.</asp:ListItem>
                                    </Items>
                                </ui:uifieldradiolist>
                                ...
                                <ui:uifielddropdownlist runat="server" id="dropStoreID" PropertyName="StoreID" Caption="Store" ValidaterequiredField="true">
                                </ui:uifielddropdownlist>
                                <ui:uihint runat="server" id="hintStoreBinLocked" Text="The location or the store bin is currently locked for stock-taking" Visible="false"></ui:uihint>
                            </ui:uipanel>
                            ...
                            <ui:UIFieldDateTime runat="server" ID="DateOfManufacture" PropertyName="DateOfManufacture"
                                ...
                                ImageClearUrl="~/calendar/dateclr.gif" ImageUrl="~/calendar/date.gif" meta:resourcekey="DateOfManufactureResource1" ShowDateControls="True" />
                            ...
                            <ui:UIFieldDateTime runat="server" ID="DateOfOwnership" PropertyName="DateOfOwnership"
                                ...
                                ImageClearUrl="~/calendar/dateclr.gif" ImageUrl="~/calendar/date.gif" meta:resourcekey="DateOfOwnershipResource1" ShowDateControls="True" />
                            ...
                            <ui:UIFieldDateTime runat="server" ID="WarrantyExpiryDate" PropertyName="WarrantyExpiryDate"
                                ...
                                ImageClearUrl="~/calendar/dateclr.gif" ImageUrl="~/calendar/date.gif" meta:resourcekey="WarrantyExpiryDateResource1" ShowDateControls="True" />
                        </ui:UIPanel>
                    </ui:UITabView>
                    <ui:UITabView ID="attributeTabView" runat="server" Caption="Attributes" meta:resourcekey="attributeTabViewResource1" BeginningHtml="" BorderStyle="NotSet" EndingHtml="">
                    </ui:UITabView>
                    
                    <ui:UITabView runat="server" ID="tabPoints" Caption="Points" meta:resourcekey="tabPointsResource1" BeginningHtml="" BorderStyle="NotSet" EndingHtml=""
                        >
                       ...
                       <ui:UIGridView ID="UIGridViewReading" runat="server" Caption="Readings" PropertyName="Point" 
                            KeyName="ObjectID" meta:resourcekey="ReadingResource1" Width="100%" CheckBoxColumnVisible="False"  OnAction="UIGridViewReading_Action"  OnRowDataBound="UIGridViewReading_RowDataBound" OnPreRender="UIGridViewReading_PreRender" DataKeyNames="ObjectID" GridLines="Both" ImageRowErrorUrl="" RowErrorColor="" style="clear:both;">
                    ...
                    <ui:UITabView runat="server" ID="tabEvents" Caption="Events" BeginningHtml="" BorderStyle="NotSet" EndingHtml="" meta:resourcekey="tabEventsResource1" 
                        >
                       ...
                       <ui:UIGridView ID="UIGridViewEvent" runat="server" Caption="Events" PropertyName="OPCAEEvents"
                            KeyName="ObjectID" meta:resourcekey="EventResource1" Width="100%" CheckBoxColumnVisible="False"  OnAction="UIGridViewEvent_Action" DataKeyNames="ObjectID" GridLines="Both" ImageRowErrorUrl="" RowErrorColor="" style="clear:both;">
                            <PagerSettings Mode="NumericFirstLast" />
                            <Columns>
                    ...
                    <ui:UITabView runat="server" ID="uitabview4" Caption="Memo"  meta:resourcekey="uitabview4Resource1" BeginningHtml="" BorderStyle="NotSet" EndingHtml="">
                        <web:memo ID="Memo1" runat="server"></web:memo>
                    </ui:UITabView>
                    <ui:UITabView runat="server" ID="uitabview2" Caption="Attachments" 
                        meta:resourcekey="uitabview2Resource1" BeginningHtml="" BorderStyle="NotSet" EndingHtml="">
