...
<body>
    <form id="form2" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="Attachment Type" GridViewID="gridResults"
                BaseTable="tAttachmentType" EditButtonVisible="false" meta:resourcekey="panelResource1">
            </web:search>
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabSearch" BorderStyle="NotSet" 
                    ...
                    <ui:UITabView runat="server" ID="uitabview3" Caption="Search" 
                        ...
                        <ui:UIFieldTextBox runat="server" ID="textObjectName" Caption="Attachment Type"
                    ...
                    <ui:UITabView runat="server" ID="uitabview4" Caption="Results" 
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="ObjectName" HeaderText="Attachment Type" 
