...
<body>
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet"
            ...
            <web:search runat="server" ID="panel" Caption="Check-In" GridViewID="gridResults" EditButtonVisible="false"
                BaseTable="tStoreCheckIn" OnPopulateForm="panel_PopulateForm"
                meta:resourcekey="panelResource1" OnSearch="panel_Search" SearchType="ObjectQuery" ></web:search>
            <div class="div-main">
