...
<script runat="server">
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        // Commented out, replace searchable dropdown list
        // by searchable dialog box.
        ...
        if (Request["MODE"] != null && Security.Decrypt(Request["MODE"]) == "EDITPROFILE")
        {
            ...
            panel.CloneButtonVisible = false;
        ...
        //gv_Position.Commands[2].Visible
    ...
    protected void gv_Position_Action(object sender, string commandName, List<object> objectIds)
    {
        ...
        else if (commandName == "DelegatePosition")
        {
            if (objectIds.Count == 0)
            {
                panel.PopupMessage = "Please select at least one position to delegate to other users.";
                return;
            }

            if (dropGrantedToUser.Items.Count == 0)
                dropGrantedToUser.Bind(OUser.GetUsersByPositions(OPosition.GetPositionsByRoleCode("APPROVER")));

            dropGrantedToUser.SelectedIndex = 0;

            popupDelegatePositions.Show();
        }
        else if (commandName == "AddObjects")
        {
            searchPositions.Show();
        }
    ...
    protected void searchPositions_Searched(objectSearchDialogBox.SearchEventArgs e)
    {
        List<OLocation> locations = new List<OLocation>();
        List<ORole> assignableRoles = new List<ORole>();
        foreach (OPosition position in AppSession.User.GetPositionsByObjectType("OUser"))
        ...
        e.CustomCondition = TablesLogic.tPosition.ObjectID.In(OPosition.GetPositionsAtOrBelowLocations(locations, assignableRoles));

    }

    protected void searchPositions_Selected(object sender, EventArgs e)
    {
        OUser u = (OUser)panel.SessionObject;
        panel.ObjectPanel.BindControlsToObject(u);
        foreach (Guid id in searchPositions.SelectedDataKeys)
        {
            if (u.PermanentPositions.Find((pp) => pp.PositionID == id) == null)
            {
                OUserPermanentPosition p = TablesLogic.tUserPermanentPosition.Create();
                p.PositionID = id;
                u.PermanentPositions.Add(p);
    ...
    protected void popupDelegatePositions_ButtonClicked(object sender, ButtonClickedEventArgs e)
    {
    ...
    {
        OUser code = panel.SessionObject as OUser;
        panel.ObjectPanel.BindControlsToObject(code);
    }

    /// <summary>
    /// Constructs and returns the user tree populater.
    /// </summary>
    /// <param name="sender"></param>
    /// <returns></returns>
    protected TreePopulater ParentID_AcquireTreePopulater(object sender)
    {
        return new UserTreePopulater(panel.SessionObject.ParentID);
    }
</script>
...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" meta:resourcekey="panelMainResource1"
        ...
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1"
                ...
                <ui:UITabView runat="server" ID="tabDetails" Caption="Details" meta:resourcekey="tabDetailsResource1"
                    ...
                    <web:base runat="server" ID="objectBase" ObjectNumberVisible="false" ObjectNameCaption="User Name"
                        ObjectNameMaxLength="50" meta:resourcekey="objectBaseResource1"></web:base>
                    <ui:UIFieldTreeList runat="server" ID="ParentID" PropertyName="ParentID" Caption="Supervisor"
                        OnSelectedNodeChanged="ParentID_SelectedNodeChanged" OnAcquireTreePopulater="ParentID_AcquireTreePopulater"
                        ToolTip="IB cấp trên của IB này"
                        ShowCheckBoxes="None" TreeValueMode="SelectedNode" />
                    <ui:UIFieldTextBox runat="server" ID="textDescription" PropertyName="Description"
                        Caption="Description" MaxLength="255" InternalControlWidth="95%" meta:resourcekey="textDescriptionResource1">
                    </ui:UIFieldTextBox>
                    <ui:UIFieldTextBox runat="server" ID="uifieldstring4" PropertyName="UserBase.Cellphone"
                        Caption="Cell Phone" Span="Half" meta:resourcekey="uifieldstring4Resource1" InternalControlWidth="95%" />
                    <ui:UIFieldTextBox runat="server" ID="textEmail" PropertyName="UserBase.Email" Caption="Email"
                        Span="Half" meta:resourcekey="uifieldstring5Resource1" InternalControlWidth="95%" />
                    <ui:UIFieldTextBox runat="server" ID="uifieldstring6" PropertyName="UserBase.Fax"
                        Caption="Fax" Span="Half" meta:resourcekey="uifieldstring6Resource1" InternalControlWidth="95%" />
                    <ui:UIFieldTextBox runat="server" ID="UIFieldTextBox1" PropertyName="UserBase.Phone"
                        Caption="Phone" Span="Half" meta:resourcekey="UIFieldTextBox1Resource1" InternalControlWidth="95%" />
                ...
                <ui:UITabView runat="server" ID="tabPosition" Caption="Positions" CssClass="div-from"
                    meta:resourcekey="tabPositionResource1" BorderStyle="NotSet">
                    <ui:UIFieldSearchableDropDownList ID="sddl_PositionID" runat="server" Caption="Position"
                        Visible="false" OnSelectedIndexChanged="sddl_PositionID_SelectedIndexChanged"
                        meta:resourcekey="sddl_PositionIDResource1" SearchInterval="300">
                    </ui:UIFieldSearchableDropDownList>
                    <web:searchdialogbox runat="server" ID="searchPositions" AllowMultipleSelection="true"
                        Title="Grant Positions" SearchTextBoxPropertyNames="ObjectName,LocationAccess.ObjectName,EquipmentAccess.ObjectName"
                        BaseTable="tPosition" MaximumNumberOfResults="500" OnSearched="searchPositions_Searched"
                        OnSelected="searchPositions_Selected">
                        <Columns>
                            <ui:UIGridViewBoundColumn HeaderText="Position Name" HeaderStyle-Width="300px" PropertyName="ObjectName">
                            </ui:UIGridViewBoundColumn>
                            <ui:UIGridViewBoundColumn HeaderText="Location" HeaderStyle-Width="200px" PropertyName="LocationAccessText">
                            </ui:UIGridViewBoundColumn>
                            <ui:UIGridViewBoundColumn HeaderText="Equipment" HeaderStyle-Width="200px" PropertyName="EquipmentAccessText">
                            </ui:UIGridViewBoundColumn>
                        </Columns>
                        <AdvancedPanel>
                            <ui:UIFieldTreeList runat='server' ID='treeLocation' PropertyName="LocationAccess.ObjectID"
                                Caption="Location" CaptionWidth="120px" Span="Half" OnAcquireTreePopulater="treeLocation_AcquireTreePopulater">
                            </ui:UIFieldTreeList>
                        </AdvancedPanel>
                    </web:searchdialogbox>
                    <ui:UIHint runat="server" ID="hintDelegation" meta:resourcekey="hintDelegationResource1"
                        Visible="true" Text="
                        ...
                        <tr valign='top'>
                            <td style='width: 50%'>
                                <ui:UIGridView runat="server" ID="gv_Position" PropertyName="PermanentPositions"
                                    ...
                                    KeyName="ObjectID" BindObjectsToRows="True" meta:resourcekey="gv_PositionResource1"
                                    ...
                                    <Commands>
                                        <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" CommandName="AddObjects"
                                            CommandText="Grant Position" ImageUrl="~/images/add.gif" />
                                        ...
                                        <cc1:UIGridViewCommand AlwaysEnabled="True" CausesValidation="False" CommandName="DelegatePosition"
                                            CommandText="Delegate Selected Positions" ImageUrl="~/images/right.png" meta:resourcekey="UIGridViewCommandResource1" />
                                    </Commands>
                                    <Columns>
                                        ...
                                        <cc1:UIGridViewBoundColumn DataField="Position.ObjectName" HeaderText="Name" meta:resourceKey="UIGridViewBoundColumnResource1"
                                        ...
                                        <cc1:UIGridViewTemplateColumn HeaderText="Start Date" meta:resourcekey="UIGridViewTemplateColumnResource1">
                                            <ItemTemplate>
                                                <cc1:UIFieldDateTime ID="textStartDate" runat="server" Caption="Start Date" FieldLayout="Flow"
                                                    InternalControlWidth="130px" PropertyName="StartDate" ShowCaption="False" ValidateCompareField="True"
                                                    ValidationCompareControl="textEndDate" ValidationCompareOperator="LessThanEqual"
                                                    ValidationCompareType="Date" meta:resourcekey="textStartDateResource1" ShowDateControls="True">
                                                </cc1:UIFieldDateTime>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        ...
                                        <cc1:UIGridViewTemplateColumn HeaderText="End Date" meta:resourcekey="UIGridViewTemplateColumnResource2">
                                            <ItemTemplate>
                                                <cc1:UIFieldDateTime ID="textEndDate" runat="server" Caption="End Date" FieldLayout="Flow"
                                                    InternalControlWidth="130px" PropertyName="EndDate" ShowCaption="False" ValidateCompareField="True"
                                                    ValidationCompareControl="textStartDate" ValidationCompareOperator="GreaterThanEqual"
                                                    ValidationCompareType="Date" meta:resourcekey="textEndDateResource1" ShowDateControls="True">
                                                </cc1:UIFieldDateTime>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" Width="150px" />
                            ...
                            <td style='width: 50%' runat="server" id="tdDelegation">
                                <ui:UIGridView runat='server' ID="gridDelegatedToOthersPositions" PropertyName="DelegatedToOthersPositions"
                                    ...
                                    DataKeyNames="ObjectID" GridLines="Both" RowErrorColor="" Style="clear: both;"
                                    ImageRowErrorUrl="" meta:resourcekey="gridDelegatedToOthersPositionsResource1"
                                    Visible="true">
                                    <PagerSettings Mode="NumericFirstLast" />
                                    <Commands>
                                        <cc1:UIGridViewCommand AlwaysEnabled="True" CausesValidation="False" CommandName="RemoveObject"
                                            CommandText="Remove" ConfirmText="Are you sure you wish to remove the selected items?"
                                            ImageUrl="~/images/delete.gif" meta:resourceKey="UIGridViewCommandResource2" />
                                    </Commands>
                                    <Columns>
                                        <cc1:UIGridViewButtonColumn AlwaysEnabled="True" ButtonType="Image" CommandName="RemoveObject"
                                        ...
                                        <cc1:UIGridViewBoundColumn DataField="User.ObjectName" HeaderText="User" PropertyName="User.ObjectName"
                                            ResourceAssemblyName="" SortExpression="User.ObjectName" meta:resourcekey="UIGridViewBoundColumnResource5">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </cc1:UIGridViewBoundColumn>
                                        <cc1:UIGridViewBoundColumn DataField="Position.ObjectName" HeaderText="Position"
                                            PropertyName="Position.ObjectName" ResourceAssemblyName="" SortExpression="Position.ObjectName"
                                            meta:resourcekey="UIGridViewBoundColumnResource6">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </cc1:UIGridViewBoundColumn>
                                        <cc1:UIGridViewBoundColumn DataField="StartDate" DataFormatString="{0:dd-MMM-yyyy}"
                                        ...
                                        <cc1:UIGridViewBoundColumn DataField="EndDate" DataFormatString="{0:dd-MMM-yyyy}"
                    ...
                    <ui:UIGridView runat='server' ID="gridDelegatedByOthersPositions" PropertyName="DelegatedByOthersPositions"
                        ...
                        GridLines="Both" RowErrorColor="" Style="clear: both;" meta:resourcekey="gridDelegatedByOthersPositionsResource1"
                        Visible="true">
                        <PagerSettings Mode="NumericFirstLast" />
                        <Columns>
                            <cc1:UIGridViewBoundColumn DataField="Position.ObjectName" HeaderText="Position"
                ...
                <ui:UITabView runat="server" ID="tabCredentials" Caption="Credentials" meta:resourcekey="tabCredentialsResource1"
                    ...
                    <ui:UIFieldCheckBox runat="server" ID="checkIsBanned" PropertyName="IsBanned" Caption="Banned"
                        ...
                        meta:resourcekey="checkIsBannedResource1" TextAlign="Right">
                    </ui:UIFieldCheckBox>
                    ...
                    <ui:UIFieldCheckBox runat="server" ID="IsActiveDirectoryUser" Caption="Active Directory"
                        ...
                        OnCheckedChanged="IsActiveDirectoryUser_checkChanged" meta:resourcekey="IsActiveDirectoryUserResource2"
                        TextAlign="Right" Visible="false">
                    </ui:UIFieldCheckBox>
                    <ui:UIFieldTextBox runat="server" ID="ActiveDirectoryDomain" PropertyName="ActiveDirectoryDomain"
                        Caption="Active Directory Domain" ValidateRequiredField="True" meta:resourcekey="ActiveDirectoryDomainResource1"
                        InternalControlWidth="95%" />
                    <ui:UIPanel runat="server" ID="panelPassword">
                        ...
                        <ui:UIFieldCheckBox runat="server" ID="chkResetPassword" Caption="Reset Password"
                            ...
                            OnCheckedChanged="chkResetPassword_CheckedChange" meta:resourcekey="chkResetPasswordResource1"
                            TextAlign="Right" />
                ...
                <ui:UITabView runat="server" ID="tabTheme" Caption="Theme" CssClass="div-from" meta:resourcekey="tabThemeResource1"
                    BorderStyle="NotSet">
                    <ui:UIPanel runat="server" ID="panelTheme" meta:resourcekey="panelThemeResource1"
                        BorderStyle="NotSet">
            ...
            <ui:UIDialogBox runat="server" ID="popupDelegatePositions" Title="I would like to delegate selected positions to"
                Button1AlwaysEnabled="false" Button1AutoClosesDialogBox="true" Button1CausesValidation="true"
                Button1CommandName="Confirm" Button1ImageUrl="~/images/tick.gif" Button1Text="Confirm"
                Button2AlwaysEnabled="true" Button2AutoClosesDialogBox="true" Button2CausesValidation="false"
                Button2CommandName="Cancel" Button2ImageUrl="~/images/delete.gif" Button2Text="Cancel"
                OnButtonClicked="popupDelegatePositions_ButtonClicked">
                <ui:UIPanel runat="server" ID="panelDelegateTo" BorderStyle="NotSet">
                    <ui:UIFieldSearchableDropDownList runat="server" ID="dropGrantedToUser" Caption="User"
                        ValidateRequiredField="True" meta:resourcekey="dropGrantedToUserResource1" SearchInterval="300">
                    </ui:UIFieldSearchableDropDownList>
                    <ui:UIFieldDateTime runat="server" ID="dateDelegateStartDate" Caption="Start Date"
                        ValidateRequiredField="True" meta:resourcekey="dateDelegateStartDateResource1"
                        ShowDateControls="True">
                    </ui:UIFieldDateTime>
                    <ui:UIFieldDateTime runat="server" ID="dateDelegateEndDate" Caption="End Date" ValidateRequiredField="True"
                        meta:resourcekey="dateDelegateEndDateResource1" ShowDateControls="True">
                    </ui:UIFieldDateTime>
                </ui:UIPanel>
            </ui:UIDialogBox>
