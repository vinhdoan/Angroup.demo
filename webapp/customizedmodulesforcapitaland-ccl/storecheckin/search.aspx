...
<script runat="server">
    ...
    /// <summary>
    /// Adds custom condition to the search.
    /// </summary>
    /// <param name="e"></param>
    protected void panel_Search(objectSearchPanel.SearchEventArgs e)
    {
        foreach (OPosition position in AppSession.User.GetPositionsByObjectType("OStoreCheckIn"))
        {
            foreach (OLocation location in position.LocationAccess)
            {
                if (e.CustomCondition == null)
                    e.CustomCondition = TablesLogic.tStoreCheckIn.Store.Location.HierarchyPath.Like(location.HierarchyPath + "%");
                else
                    e.CustomCondition = e.CustomCondition | TablesLogic.tStoreCheckIn.Store.Location.HierarchyPath.Like(location.HierarchyPath + "%");
            }
        }
    }
</script>
...
<body>
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="Store Check-In" GridViewID="gridResults" EditButtonVisible="false"
                BaseTable="tStoreCheckIn" OnPopulateForm="panel_PopulateForm" SearchType="ObjectQuery"
                AutoSearchOnLoad="true" MaximumNumberOfResults="30" 
                SearchTextBoxPropertyNames="ObjectNumber,Description" AdvancedSearchPanelID="panelAdvanced"
                SearchTextBoxHint="Check-In Number, Description"
            ...
            <div class="div-form">
                ...
                <%--<ui:UITabStrip runat="server" ID="tabSearch" 
                    ...
                    <ui:UITabView runat="server" ID="uitabview1" Caption="Search" 
                        ...
                        <%--<ui:UIFieldTextBox runat='server' ID="ObjectNumber" PropertyName="ObjectNumber" Caption="Check-In Number"
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black" SortExpression="ObjectNumber"
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="ObjectNumber" 
                                    HeaderText="Check-In Number" meta:resourceKey="UIGridViewColumnResource4" 
