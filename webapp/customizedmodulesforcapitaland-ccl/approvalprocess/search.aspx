...
<script runat="server">
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        //DataTable dt = OCode.GetCodesByTypeOrderByParentPathAsDataTable("PurchaseType");
        //dt.Merge(OCode.GetCodesByTypeOrderByParentPathAsDataTable("PaymentType"));
        //dt.DefaultView.Sort = "Path ASC";
        //listTransactionTypes.Bind(dt, "Path", "ObjectID");
    }
...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" 
        ...
        <web:search runat="server" ID="panel" Caption="Approval Process" GridViewID="gridResults"
            BaseTable="tApprovalProcess" EditButtonVisible="false" AutoSearchOnLoad="false" MaximumNumberOfResults="2000" SearchTextBoxHint="Description, Applicable Conditions"
            AdvancedSearchOnLoad="false" AdvancedSearchPanelID="panelAdvanced" SearchTextBoxPropertyNames="Description,FLEECondition"
            OnSearch="panel_Search" OnPopulateForm="panel_PopulateForm" SearchType="ObjectQuery" meta:resourcekey="panelResource1"></web:search>
        <div class="div-form">
            <%--<ui:UITabStrip runat="server" ID="tabSearch" 
                ...
                <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                    ...
                    <ui:UIFieldRadioList runat="server" ID="radioModeOfForwarding" Caption="Mode of Forwarding"
                        ...
                        <Items>
                            <asp:ListItem Value="" Selected="True" Text="Any"></asp:ListItem>
                            ...
                            <asp:ListItem Value="4" meta:resourcekey="ListItemResource6" 
                                Text="Hierarchical with Last Rejected Skipping: Same as Hierarchical, except when a rejected task is re-submitted for approval, it starts at the same level that rejected the task." ></asp:ListItem>
                            <asp:ListItem Value="5" meta:resourcekey="ListItemResource6" 
                                Text="Hierarchical with Requestor and Last Rejected Skipping: Same as Hierarchical with Last Rejected Skipping, except when a task is submitted for approval by a person who in this approval process, it starts at the next level of that person's level." ></asp:ListItem>
                    ...
                    <ui:UIGridView runat="server" ID="gridResults" SortExpression="ObjectTypeName" 
                        ...
                        <Columns>
                            ...
                            <cc1:UIGridViewBoundColumn DataField="Location.ObjectName" HeaderText="Location" 
                                meta:resourcekey="UIGridViewBoundColumnResource3" PropertyName="Location.ObjectName" 
                            ...
                            <cc1:UIGridViewBoundColumn DataField="FLEECondition" 
                                HeaderText="Approval Condition" 
                                PropertyName="FLEECondition" ResourceAssemblyName="" 
                                SortExpression="FLEECondition">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                        </Columns>
