...
<script runat="server">
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        treeServingLocation.PopulateTree();
    ...
    protected void ServingArea_Action(object sender, string commandName, List<object> objectIds)
    {
    ...
    protected void LocationID_TreeNodeChange(object sender, EventArgs e)
    {
        OEquipment eqp = (OEquipment)panel.SessionObject;
        panel.ObjectPanel.BindControlsToObject(eqp);
        
        if (treeServingLocation.SelectedValue != "")
            eqp.ServingAreas.AddGuid(new Guid(treeServingLocation.SelectedValue));
                ...
                <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1" BorderStyle="NotSet">
                    <ui:UITabView runat="server" ID="uitabview1" Caption="Details" 
                        ...
                        <ui:UIPanel runat="server" ID="panelEquipment1" meta:resourcekey="panelEquipment1Resource1" BorderStyle="NotSet">
                            ...
                            <ui:UIFieldTreeList runat="server" ID="treeServingLocation" Caption="Serving Location" 
                                OnAcquireTreePopulater="LocationID_AcquireTreePopulater" 
                                ToolTip="The location in which this equipment serving to." 
                                ShowCheckBoxes="None" TreeValueMode="SelectedNode"
                                OnTreeNodeChange="LocationID_TreeNodeChange">
                            </ui:UIFieldTreeList>
                            <ui:UIGridView runat="server" ID="gridServingArea" PropertyName="ServingAreas" 
                                Caption="Serving areas"  ToolTip="The areas this equipment serving to." 
                                KeyName="ObjectID" Width="100%"
                                OnAction="ServingArea_Action" DataKeyNames="ObjectID" GridLines="Both" 
                                ...
                                <Columns>
                                    ...
                                    <cc1:UIGridViewBoundColumn DataField="LocationType.ObjectName" HeaderText="Type" 
                            ...
                            <ui:UISeparator runat="server" ID="UISeparator1" Caption="Warranty" meta:resourcekey="UISeparator1Resource1"></ui:UISeparator>
                            ...
                            <asp:Label ID="Label2" runat="server" Text="Warranty Period:" meta:resourcekey="WarrantyPeriodResource1" Width="157px"></asp:Label>
