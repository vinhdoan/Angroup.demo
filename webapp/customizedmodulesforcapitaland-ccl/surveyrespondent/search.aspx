...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" BeginningHtml="" BorderStyle="NotSet"
        ...
        <web:search runat="server" ID="panel" Caption="Survey Address Book" 
            GridViewID="gridResults" EditButtonVisible="false" SearchType="ObjectQuery"
            AutoSearchOnLoad="true" MaximumNumberOfResults="300" 
            SearchTextBoxPropertyNames="ObjectName, Locations.ObjectName, SurveyRespondents.ObjectName, SurveyRespondents.EmailAddress" AdvancedSearchPanelID=""
            SearchTextBoxHint="Address Book Name, Locations, etc..."
            BaseTable="tSurveyRespondentPortfolio" meta:resourcekey="panelResource1"></web:search>
        <div class="div-main">
            <%--<ui:UITabStrip runat="server" ID="tabSearch" BeginningHtml="" BorderStyle="NotSet"
                ...
                <ui:UITabView runat="server" ID="uitabview3" Caption="Search" BeginningHtml="" BorderStyle="NotSet"
                    ...
                    <ui:UIFieldTextBox runat="server" ID="SurveyRespondentName" PropertyName="ObjectName"
                        Caption="Survey Respondent Portfolio Name" Width="99%" MaxLength="255" InternalControlWidth="95%"
                    ...
                    <ui:UIFieldTextBox runat="server" ID="Email" PropertyName="EmailAddress"
                        Caption="Survey Respondent Portfolio Email" InternalControlWidth="95%" meta:resourcekey="EmailResource1" />
                </ui:UITabView>--%>
                <ui:UITabView runat="server" ID="uitabview4" Caption="Results" BeginningHtml="" BorderStyle="NotSet"
                    ...
                    <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" Width="100%" DataKeyNames="ObjectID"
                        ...
                        <Columns>
                            ...
                            <cc1:UIGridViewBoundColumn DataField="" HeaderText="No. of contacts"
                                PropertyName="SurveyRespondents.Count" ResourceAssemblyName=""
                                SortExpression="SurveyRespondents.Count">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                        </Columns>
