    ...
    <form id="form2" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="Message Template" GridViewID="gridResults" EditButtonVisible="false"
                AutoSearchOnLoad="false" MaximumNumberOfResults="1000" SearchTextBoxHint="Template Name, Message Template Code"
                AdvancedSearchOnLoad="false" AdvancedSearchPanelID="panelAdvanced" SearchTextBoxPropertyNames="ObjectName,MessageTemplateCode"
                ...
                <%--<ui:UITabStrip runat="server" ID="tabSearch" BorderStyle="NotSet" 
                    ...
                    <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                        ...
                        <ui:UIPanel runat="server" ID="panelNotifyAssignedWorkflowRecipients" 
                            BorderStyle="NotSet" meta:resourcekey="panelNotifyAssignedWorkflowRecipientsResource1">
