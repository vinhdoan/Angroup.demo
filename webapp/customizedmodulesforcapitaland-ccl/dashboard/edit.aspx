                ...
                <ui:UITabView ID="tabDetails" runat="server" Caption="Details" 
                    ...
                    <ui:UIObjectPanel ID="panelDashboardField" runat="server" BorderStyle="NotSet" 
                        ...
                        <ui:UIFieldDropDownList ID="ControlType" runat="server" Caption="Control Type" PropertyName="ControlType"
                            ...
                            meta:resourcekey="ControlTypeResource1" OnSelectedIndexChanged="ControlType_SelectedIndexChanged">
                            <%--<Items>
                        ...
                        <ui:UIFieldCheckBox runat="server" ID="checkIsInsertBlank" Caption="Insert Blank?" Text="Yes, insert blank row to the dropdown list" PropertyName="IsInsertBlank" Span="Full">
                        </ui:UIFieldCheckBox>
