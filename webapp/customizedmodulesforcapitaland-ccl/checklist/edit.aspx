...
<script runat="server">
    ...
    protected void panel_ValidateAndSave(object sender, EventArgs e)
    {
        using (Connection c = new Connection())
        {
            ...
            int count = 0;
            if (checklist.Type == ChecklistType.Survey)
            {
    ...
    protected void ChecklistItem_SubPanel_ValidateAndUpdate(object sender, EventArgs e)
    {
        ...
        if (checklistItem.ChecklistType != (int)ChecklistItemType.Choice &&
            checklistItem.ChecklistType != (int)ChecklistItemType.MultipleSelections)
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        ChecklistItem_ChecklistResponseSetID.Visible = 
            (ChecklistItem_ChecklistType.SelectedValue == ((int)ChecklistItemType.Choice).ToString() ||
            ChecklistItem_ChecklistType.SelectedValue == ((int)ChecklistItemType.MultipleSelections).ToString());
        
        chkIsOverall.Visible = (CurrentCL.Type == ChecklistType.Survey);

        chkIsOverall.Enabled = (ChecklistItem_ChecklistType.SelectedValue == ((int)ChecklistItemType.Choice).ToString() || ChecklistItem_ChecklistType.SelectedValue == ((int)ChecklistItemType.Remarks).ToString());
    ...
    {
        OChecklist CurrentCL = (OChecklist)panel.CurrentObject;
        // 2012.03.08, Kien Trung
        // Temporarily enable the checklist to allow edit.
        //
                    ...
                    <ui:UITabView runat="server" ID="tab_Details" Caption="Details" 
                        ...
                        <ui:UIPanel runat="server" ID="checklistPanel" Width="100%" 
                            ...
                            <ui:UIFieldDropDownList runat="server" ID="Type" PropertyName="Type" Caption="Type"
                                ValidateRequiredField="True" OnSelectedIndexChanged="Type_SelectedIndexChanged" 
                                meta:resourcekey="TypeResource1">
                                <Items>
                                    <asp:ListItem value="0" text="Work" />
                                    <asp:ListItem value="1" text="Survey" />
                                    <asp:ListItem value="2" text="Others" />
                                </Items>
