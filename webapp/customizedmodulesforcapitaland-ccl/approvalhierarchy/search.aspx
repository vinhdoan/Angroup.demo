...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" meta:resourcekey="panelMainResource1" BorderStyle="NotSet">
        <web:search runat="server" ID="panel" Caption="Approval Hierarchy"
            ...
            SearchTextBoxPropertyNames="ObjectName,ApprovalHierarchyLevels.Users.ObjectName" AdvancedSearchPanelID="panelAdvanced"
            SearchTextBoxHint="Hierarchy Name"
        ...
        <div class="div-form">
            <%--<ui:UITabStrip runat="server" ID="tabSearch" meta:resourcekey="tabSearchResource1" BorderStyle="NotSet">
                ...
                <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                    ...
                    <ui:uifieldlistbox runat="server" id="listPositions" PropertyName="ApprovalHierarchyLevels.Positions.ObjectID" Caption="Positions" meta:resourcekey="listPositionsResource1"></ui:uifieldlistbox>
                    <ui:UIFieldListBox runat="server" ID="listRoles" PropertyName="ApprovalHierarchyLevels.Roles.ObjectID" Caption="Roles" meta:resourcekey="listRolesResource1"></ui:UIFieldListBox>
                </ui:UIPanel>
                <%--</ui:UITabView>
                <ui:UITabView runat="server" ID="uitabview4" Caption="Results" meta:resourcekey="uitabview4Resource1" BorderStyle="NotSet">--%>
                    <ui:UIGridView runat="server" ID="gridResults" SortExpression="ObjectName ASC"
