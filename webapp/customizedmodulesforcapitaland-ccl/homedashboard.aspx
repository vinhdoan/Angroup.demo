...
<script runat="server">
    ...
    protected void BindDashboardWebParts()
    {
        ...
        checkboxlistDashboards.DataSource = dashboards;
        checkboxlistDashboards.DataBind();
    }
    ...
    protected void modalAddDashboard_ButtonClicked(object sender, ButtonClickedEventArgs e)
    {
        if (e.CommandName == "Add")
        {
            if (checkboxlistDashboards.GetSelectedKeys().Count == 0)
            {
                modalAddDashboard.Show();
            ...
            foreach (Guid id in checkboxlistDashboards.GetSelectedKeys())
            {
                ODashboard dashboard = TablesLogic.tDashboard.Load(id);

                if (zoneToAddDashboard != null && dashboard != null)
                {
                    webpartDashboard d = new webpartDashboard();
                    d.ID = "db" + id.ToString().Replace("-", "");
                    ...
                    wp.Title = title;
                    ((webpartDashboard)wp.Controls[0]).DashboardID = id;
	...
	protected void buttonRefresh_Click(object sender, EventArgs e)
    {
        ...
        {
            ((webpartDashboard)wp.Controls[0]).RefreshChart();
        }
    }
</script>
        ...
        <div class="div-main">
            <ui:UIPanel runat="server" ID="panelDashboards" BeginningHtml="" BorderStyle="NotSet"
                ...
                <div class="div-form" id="dvPrintContent">
                    ...
                    <ui:UIButton runat="server" CssClass="divNoDisplay" ID="buttonRefresh" Text="Refresh Charts"
                        ImageUrl="~/images/Symbol-Refresh-big.gif" CausesValidation="False" OnClick="buttonRefresh_Click" />
                    <br />
                    <br />
                        ...
                        <tr valign="top">
                            <td class="webpart-zonecontainerleft">
                                <asp:WebPartZone runat="server" ID="webpartZone1" BorderStyle="None" WebPartVerbRenderMode="TitleBar" EmptyZoneText="Click 'Add Dashboards' to add a new dashboard to this zone, or drag a dashboard from another zone to this zone."
                                    ...
                                    <DeleteVerb Text="" Description="Hide {0}" ImageUrl="~/images/close.png" />
                                    <MinimizeVerb Description="Minimize {0}" ImageUrl="~/images/minimize.png" />
                                    <RestoreVerb Description="Maximize {0}" ImageUrl="~/images/maximize.png" />
                ...
                <ui:UIDialogBox runat="server" ID="modalAddDashboard" Title="Add Dashboards" DialogWidth="530px"
                    Button1AlwaysEnabled="true" Button1AutoClosesDialogBox="true" Button1CausesValidation="false" Button1ImageUrl="~/images/tick.gif" Button1Text="Add Selected" Button1CommandName="Add"
                    Button2AlwaysEnabled="true" Button2AutoClosesDialogBox="true" Button2CausesValidation="false" Button2ImageUrl="~/images/delete.gif" Button2Text="Cancel" Button2CommandName="Cancel" OnButtonClicked="modalAddDashboard_ButtonClicked">
                    ...
                    <ui:UIGridView runat="server" ID="checkboxlistDashboards" ShowCaption="false" ShowCommands="false" ShowFooter="false" ShowHeader="true" 
                        CheckBoxColumnVisible="true" ScrollableHeight="200px" ScrollableRows="true" AllowPaging="false" DataKeyNames="ObjectID">
                        <Columns>
                            <ui:UIGridViewBoundColumn HeaderStyle-Width="360px" HeaderText="Dashboard Name" PropertyName="ObjectName" ResourceName="Resources.Dashboards"></ui:UIGridViewBoundColumn>
                            <ui:UIGridViewBoundColumn HeaderStyle-Width="95px" HeaderText="Type" PropertyName="DashboardTypeText"></ui:UIGridViewBoundColumn>
                        </Columns>
                    </ui:UIGridView>
                    <br />
                    <br />
