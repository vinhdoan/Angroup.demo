...
<body>
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="Check-Out" GridViewID="gridResults" EditButtonVisible="false"
                BaseTable="tStoreCheckOut" SearchType="ObjectQuery" AutoSearchOnLoad="true" MaximumNumberOfResults="300" 
                AdvancedSearchPanelID="panelAdvanced"
                SearchTextBoxHint="Check Out Number, Description"
                SearchTextBoxPropertyNames="ObjectNumber,Description"
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black" SortExpression="ObjectNumber"
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="ObjectNumber" 
                                    HeaderText="Check-Out Number" meta:resourceKey="UIGridViewColumnResource4" 
