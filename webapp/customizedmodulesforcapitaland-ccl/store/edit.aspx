...
<script runat="server">
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            TotalCostOfStock.Caption += " (" + OApplicationSetting.Current.BaseCurrency.CurrencySymbol + ")";
            gridBin.Columns[4].HeaderText += " (" + OApplicationSetting.Current.BaseCurrency.CurrencySymbol + ")";
            StoreBin_GridView.Columns[4].HeaderText += " (" + OApplicationSetting.Current.BaseCurrency.CurrencySymbol + ")";
            gridCatalogue.Columns[13].HeaderText += " (" + OApplicationSetting.Current.BaseCurrency.CurrencySymbol + ")";
            textStandardCostingUnitPrice.Caption += " (" + OApplicationSetting.Current.BaseCurrency.CurrencySymbol + ")";
            gridStoreItemBatches.Columns[4].HeaderText += " (" + OApplicationSetting.Current.BaseCurrency.CurrencySymbol + ")";
            //gridCatalogue.Columns[12].HeaderText += " (" + OApplicationSetting.Current.BaseCurrency.CurrencySymbol + ")";
            gridStoreItemBatches.Columns[6].HeaderText += " (" + OApplicationSetting.Current.BaseCurrency.CurrencySymbol + ")";
            
            Session["StoreItems"] = store.StoreItems;
        }
    ...
    protected TreePopulater Location_AcquireTreePopulater(object sender)
    {
        ...
        return new LocationTreePopulaterForCapitaland(((OStore)panel.SessionObject).LocationID, false, true,
    ...
    protected void buttonGeneratePR_Click(object sender, EventArgs e)
    {
        ...
        {
            ORequestForQuotation wj = store.GenerateRFQForLowInventoryItems((Guid)AppSession.User.ObjectID);
            Window.OpenEditObjectPage(this, "ORequestForQuotation", wj.ObjectID.ToString(), "");
        }
        else
        {
    ...
    /// <summary>
    /// Occurs when the user selects a node in the location 1`.
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    ...
    protected void gridCatalogue_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                if(e.Row.Cells[11].Text != null && e.Row.Cells[11].Text != "")
                    e.Row.Cells[11].Text = string.Format("{0:#,##0}", decimal.Parse(e.Row.Cells[11].Text));

                if (e.Row.Cells[13].Text != null && e.Row.Cells[13].Text != "")
                    e.Row.Cells[13].Text = string.Format("{0:#,##0}", decimal.Parse(e.Row.Cells[13].Text));
            }
            else
            {

                if (e.Row.Cells[11].Text != null && e.Row.Cells[11].Text != "")
                    e.Row.Cells[11].Text = string.Format("{0:n}", decimal.Parse(e.Row.Cells[11].Text));

                if (e.Row.Cells[13].Text != null && e.Row.Cells[13].Text != "")
                    e.Row.Cells[13].Text = string.Format("{0:n}", decimal.Parse(e.Row.Cells[13].Text));
            }
        }
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (panel.SessionObject.IsModified)
            Session["StoreItems"] = ((OStore)panel.SessionObject).StoreItems;

        // Filter the Catalogue grid to display according to the checkbox filter
        // of low inventory items
        filterLowInventoryItems_CheckedChanged(null, null);
        
        // Also filter the Catalogue grid according to the current search keyword
        catalogueSearchButton_Click(null, null);
    }
    ...
    /// <summary>
    /// Repopulate the Store Catalog grid view when this filter is changed.
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void filterLowInventoryItems_CheckedChanged(object sender, EventArgs e)
    {
        OStore store = panel.SessionObject as OStore;
        panel.ObjectPanel.BindControlsToObject(store);

        if (filterLowInventoryItems.Checked)
        {
            List<OStoreItem> filteredStoreItemList = ((DataList<OStoreItem>)Session["StoreItems"])
                                                        .FindAll(lf => lf.HasLowInventory);
            gridCatalogue.Bind(filteredStoreItemList);
        }
        else
            panel.ObjectPanel.BindObjectToControls(store);
    ...
    /// <summary>
    /// Search and display Catalogue items in the Catalogue grid.
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void catalogueSearchButton_Click(object sender, EventArgs e)
    {
        string searchText = catalogueSearchTextBox.Text;
        ...
        List<OStoreItem> filteredStoreItemList = ((DataList<OStoreItem>)Session["StoreItems"])
                                                    .FindAll(lf => lf.Catalogue.ObjectName.Contains(searchText));

        if (filterLowInventoryItems.Checked)
            filteredStoreItemList = filteredStoreItemList.FindAll(lf => lf.HasLowInventory);
        ...
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabObject" 
                ...
                <ui:UITabView runat="server" ID="uitabview1" Caption="Details"
                    ...
                    <ui:UIFieldCheckBox runat="server" ID="IsActiveForCheckIn" Caption="Active for check in?" PropertyName="IsActiveForCheckIn"></ui:UIFieldCheckBox>
                    ...
                    <ui:UIGridView runat="server" ID="gridBin" PropertyName="StoreBins"
                        ...
                        <Columns>
                            ...
                            <cc1:UIGridViewBoundColumn 
                                ...
                                PropertyName="IsLockedText" DataField="IsLockedText" 
                                meta:resourcekey="UIGridViewBoundColumnResource2" ResourceAssemblyName="" 
                                SortExpression="IsLockedText">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                        </Columns>
                    ...
                    <ui:UIObjectPanel runat="server" ID="StoreBin_Panel" 
                        ...
                        <ui:UIGridView runat="server" ID="StoreBin_GridView" PropertyName="StoreBinItemsConsolidated"
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="AvailableQuantity" HeaderText="Available Bal" 
                ...
                <ui:UITabView runat="server" ID="tabCatalog" Caption="Catalog"
                    ...
                    <ui:UIButton runat="server" ID="buttonGeneratePR" ImageUrl="~/images/add.gif"
                        Text="Generate Work Justification for Low Inventory Items"
                        ConfirmText="Are you sure you wish to generate a Work Justification from low inventory store items?"
                        OnClick="buttonGeneratePR_Click" meta:resourcekey="buttonGeneratePRResource2" />
                    <br />
                    <br />
                    <ui:UIPanel runat="server" ID="panelAddCatalogButtons" BorderStyle="NotSet" 
                        ...
                        <ui:UIButton runat="server" ID="buttonItemsAdded" CausesValidation="False"
                            ...
                            <br />
                            <br />
                            <ui:UIPanel runat="server" ID="filterPanel">
                                <ui:UIFieldCheckBox runat="server" ID="filterLowInventoryItems" Caption="Display Low Inventory Items only"
                                    OnCheckedChanged="filterLowInventoryItems_CheckedChanged" CaptionWidth="200px"></ui:UIFieldCheckBox>
                                <ui:UIFieldTextBox runat="server" ID="catalogueSearchTextBox" Caption="Filter Catalogue" 
                                    Span="Half" CaptionWidth="200px"></ui:UIFieldTextBox>
                                <ui:UIButton runat="server" ID="catalogueSearchButton" Text="Filter" ImageUrl="~/images/tick.gif"
                                    OnClick="catalogueSearchButton_Click"/>
                            </ui:UIPanel>
                        <br />
                        <br />
                    </ui:UIPanel>
                    <ui:UIPanel runat="server" ID="panelCatalogue" BorderStyle="NotSet" 
                        ...
                        <ui:UIGridView runat="server" ID="gridCatalogue" PropertyName="StoreItems"
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="Catalogue.Parent.ObjectName" 
                                    HeaderText="Folder" 
                                    PropertyName="Catalogue.Parent.ObjectName" ResourceAssemblyName="" 
                                    SortExpression="Catalogue.Parent.ObjectName">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="TotalAvailableQuantity"  HeaderText="Available Bal" 
                                ...
                                <cc1:UIGridViewBoundColumn DataField="Catalogue.UnitOfMeasure.IsWholeNumberUnit" 
                                    HeaderText="Unit of Measure"
                                    PropertyName="Catalogue.UnitOfMeasure.IsWholeNumberUnit" ResourceAssemblyName="" 
                                    SortExpression="Catalogue.UnitOfMeasure.IsWholeNumberUnit">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                            </Columns>
