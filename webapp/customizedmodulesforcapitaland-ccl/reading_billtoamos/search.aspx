...
<script runat="server">
    ...
    protected void panel_Search(objectSearchPanel.SearchEventArgs e)
    {
        ...
        e.CustomCondition = e.CustomCondition
            ...
            & TablesLogic.tReading.BillToAMOSStatus != (int)EnumBillToAMOSStatus.NotPostedDueToCancelled);
    }
            ...
            if (IsDataValid())
            {
                if (dataKeys.Count > 0)
                {
                    List<OReading> readingList = TablesLogic.tReading.LoadList(TablesLogic.tReading.ObjectID.In(dataKeys),
                        TablesLogic.tReading.Point.Tenant.AmosOrgID.Asc,
                        TablesLogic.tReading.Point.TenantLease.AmosLeaseID.Asc,
                        TablesLogic.tReading.Point.TenantLease.Tenant.AmosOrgID.Asc,
                        TablesLogic.tReading.Point.TenantContact.AmosContactID.Asc);
                    ...
                    using(Connection c= new Connection())
                    {
                        for (int i = 0; i < readingList.Count; i++)
                        {
                            ...
                            if (reading.BillToAMOSStatus == (int)EnumBillToAMOSStatus.NotPostedToAMOS || 
                                reading.BillToAMOSStatus == (int)EnumBillToAMOSStatus.PostedToAMOSFailed || 
                                reading.BillToAMOSStatus == (int)EnumBillToAMOSStatus.UnableToPostDueToError ||
                                reading.BillToAMOSStatus == (int)EnumBillToAMOSStatus.NotPostedDueToCancelled)
                            {
                                String currentKey = "";
                                ...
                                {
                                    currentKey = currentKey + reading.Point.TenantLease.AmosLeaseID;
                                    if (reading.Point.TenantLease.TenantID != null)
                                        currentKey = currentKey + "$" + reading.Point.TenantLease.Tenant.AmosOrgID;
                                }
                                
                                if (reading.Point.TenantContactID != null)
                                    currentKey = currentKey + "$" + reading.Point.TenantContact.AmosContactID;
...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
        ...
        <web:search runat="server" ID="panel" Caption="Bill To AMOS" GridViewID="gridResults"
            ...
            SearchTextBoxHint="E.g.: Point Name, etc..."
            AutoSearchOnLoad="true" MaximumNumberOfResults="10000" 
            SearchTextBoxPropertyNames="Point.ObjectName" AdvancedSearchPanelID="panelAdvanced"
            ...
            <%--<ui:UITabStrip runat="server" ID="tabSearch" BorderStyle="NotSet" 
                ...
                <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                    <ui:UIFieldRadioList runat='server' ID="radioIsApplicableForLocation" PropertyName="Point.IsApplicableForLocation"
                        Caption="Location/Equipment" RepeatColumns="3"
                    ...
                    <ui:UIFieldListBox runat="server" ID="listBillToAMOSStatus" Caption="Billing Status" PropertyName="BillToAMOSStatus" Rows="6">
                        <Items>
                    ...
                    <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" Width="100%" OnAction="gridResults_Action"
                        ...
                        <Columns>
                            ...
                            <cc1:UIGridViewBoundColumn DataField="BillAmount" 
                                ...
                                SortExpression="BillAmount" DataFormatString="{0:#,##0.0000}" meta:resourcekey="UIGridViewBoundColumnResource32">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
