...
<script runat="server">
    ...
    void grid_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            for (int i = 0; i < grid.Columns.Count; i++)
            {
                ...
                {
                    if (grid.Columns[i] is UIGridViewBoundColumn && e.Row.RowType == DataControlRowType.Header)
    ...
    protected void gridAdjustmentDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        // Show the currency (and highlight in red if negative.
        // 
        for (int i = 0; i < gridAdjustmentDetails.Columns.Count; i++)
        {
            if (gridAdjustmentDetails.Columns[i] is UIGridViewBoundColumn &&
                (((UIGridViewBoundColumn)gridAdjustmentDetails.Columns[i]).DataField.StartsWith("Amount")))
            {
                try
                {
        ...
        <div class="div-main">
            ...
            <div class="div-form">
                ...
                <ui:UIPanel runat="server" ID="summaryPanel" BorderStyle="NotSet" meta:resourcekey="summaryPanelResource1">
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridSummaryView" runat="server" DataKeyNames="AccountID"
                        BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                        Width="100%" meta:resourcekey="gridSummaryViewResource1" PageSize="1000" ShowCaption="false" AllowSorting="false">
                        <Columns>
                            ...
                            <ui:uigridviewboundcolumn PropertyName="TotalOpeningBalance" ReadOnly="True" HeaderText="(1) Opening Balance">
                            ...
                            <ui:uigridviewboundcolumn PropertyName="TotalAdjustedAmount" ReadOnly="True" HeaderText="(2) Adjusted Amount">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalReallocatedAmount" ReadOnly="True" HeaderText="(3) Reallocated Amount">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalBalanceAfterVariation" ReadOnly="True" HeaderText="(4) Total After Adjustments&lt;br/&gt;(1)+(2)+(3)" HtmlEncode="false">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalPendingApproval" ReadOnly="True" HeaderText="(5) Total Pending Approval">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalApproved" ReadOnly="True" HeaderText="(6) Total Approved">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalInvoiceApproved" ReadOnly="True" HeaderText="(7) Total Invoiced">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalDirectInvoicePendingApproval" ReadOnly="True" HeaderText="(8) Total Direct Invoice Pending Approval ">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalDirectInvoiceApproved" ReadOnly="True" HeaderText="(9) Total Direct Invoice Approved ">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalAvailableBalance" ReadOnly="True" HeaderText="(10) Total Available&lt;br/&gt;(4)-(5)-(6)-(8)-(9)" HtmlEncode="false">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                        </Columns>
                ...
                <ui:UIPanel runat="server" ID="yearPanel" BorderStyle="NotSet" meta:resourcekey="yearPanelResource1">
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridYearView" runat="server" DataKeyNames="AccountID" CssClass="datagrid"
                        BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                        Width="100%" meta:resourcekey="gridYearViewResource1" PageSize="1000" ShowCaption="false" AllowSorting="false">
                        <Columns>
                            <ui:uigridviewboundcolumn PropertyName="AccountID" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Level" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Type" ReadOnly="True"></ui:uigridviewboundcolumn>
                            ...
                            <ui:uigridviewboundcolumn PropertyName="TotalBalanceAfterVariationYTD" ReadOnly="True" HeaderText="(5) Total After Adjustments YTD&lt;br/&gt;" HtmlEncode="false">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalCommittedYTD" ReadOnly="True" HeaderText="(6) Committed YTD&lt;br/&gt;" HtmlEncode="false">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalCommittedRestOfBudgetPeriod" ReadOnly="True" HeaderText="(7) Committed Rest of Budget Period&lt;br/&gt;" HtmlEncode="false">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalCommittedAfterCurrentBudgetPeriod" ReadOnly="True" HtmlEncode="false"
                                HeaderText="(8) Committed for Future Years&lt;br/&gt;">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="PercentageVarianceYTD" ReadOnly="True" HeaderText="(9) % YTD Variance&lt;br/&gt;((5)-(6))/(5) * 100%" HtmlEncode="false"
                                DataFormatString="{0:##0.00}">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalAvailableBalanceExcludingPendingApprovals" ReadOnly="True" HtmlEncode="false"
                                HeaderText="(10) Total Available&lt;br/&gt;(4)-(6)-(7)">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalPendingApproval" ReadOnly="True" HeaderText="(11) Total Pending Approval">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalAvailableBalance" ReadOnly="True" HeaderText="(12) Total Available After Deducting Pending Approval&lt;br/&gt;(10)-(11)"  HtmlEncode="false">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="TotalPendingApprovalYTD" ReadOnly="True" HeaderText="(11) Current Pending Approval">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="80px" />
                            </ui:uigridviewboundcolumn>
                        </Columns>
                ...
                <ui:UIPanel runat="server" ID="availablePanel" BorderStyle="NotSet" meta:resourcekey="availablePanelResource1">
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridAvailable" runat="server" DataKeyNames="AccountID" CssClass="datagrid"
                        BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                        Width="100%" meta:resourcekey="gridAvailableResource1" PageSize="1000" ShowCaption="false" AllowSorting="false">
                        <Columns>
                            <ui:uigridviewboundcolumn PropertyName="AccountID" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Level" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Type" ReadOnly="True"></ui:uigridviewboundcolumn>
                            ...
                            <ui:uigridviewboundcolumn PropertyName="TotalAmount" ReadOnly="True" HeaderText="Total">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                ...
                <ui:UIPanel runat="server" ID="monthPanel" BorderStyle="NotSet" meta:resourcekey="monthPanelResource1">
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridMonthView" runat="server" DataKeyNames="AccountID" CssClass="datagrid"
                        BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                        Width="100%" meta:resourcekey="gridMonthViewResource1" PageSize="1000" ShowCaption="false" AllowSorting="false">
                        <Columns>
                            <ui:uigridviewboundcolumn PropertyName="AccountID" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Level" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Type" ReadOnly="True"></ui:uigridviewboundcolumn>
                ...
                <ui:UIPanel runat="server" ID="reallocatePanel" BorderStyle="NotSet" meta:resourcekey="reallocatePanelResource1">
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridReallocated" runat="server" DataKeyNames="AccountID" CssClass="datagrid"
                        BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                        Width="100%" meta:resourcekey="gridReallocatedResource1" PageSize="1000" ShowCaption="false" AllowSorting="false">
                        <Columns>
                            <ui:uigridviewboundcolumn PropertyName="AccountID" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Level" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Type" ReadOnly="True"></ui:uigridviewboundcolumn>
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridReallocationDetails" runat="server" DataKeyNames="AccountID"
                        ...
                        PageSize="1000" ShowCaption="false" AllowSorting="false">
                        <Columns>
                            ...
                            <ui:uigridviewboundcolumn PropertyName="Amount" ReadOnly="True" HeaderText="Amount">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                        </Columns>
                ...
                <ui:UIPanel runat="server" ID="adjustedPanel" BorderStyle="NotSet" meta:resourcekey="adjustedPanelResource1">
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridAdjusted" runat="server" DataKeyNames="AccountID" CssClass="datagrid"
                        BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                        Width="100%" meta:resourcekey="gridAdjustedResource1" PageSize="1000" ShowCaption="false" AllowSorting="false">
                        <Columns>
                            <ui:uigridviewboundcolumn PropertyName="AccountID" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Level" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Type" ReadOnly="True"></ui:uigridviewboundcolumn>
                    ...
                    <br />
                    <ui:uigridview ID="gridAdjustmentDetails" runat="server" DataKeyNames="AccountID"
                        CssClass="datagrid" BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                        Width="100%" OnRowDataBound="gridAdjustmentDetails_RowDataBound" meta:resourcekey="gridAdjustmentDetailsResource1" PageSize="1000" ShowCaption="false" AllowSorting="false">
                        <Columns>
                ...
                <ui:UIPanel runat="server" ID="pendingPanel" BorderStyle="NotSet" meta:resourcekey="pendingPanelResource1">
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridPendingApproval" runat="server" DataKeyNames="AccountID" CssClass="datagrid"
                        BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                        Width="100%" meta:resourcekey="gridPendingApprovalResource1" PageSize="1000" ShowCaption="false" AllowSorting="false">
                        <Columns>
                            <ui:uigridviewboundcolumn PropertyName="AccountID" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Level" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Type" ReadOnly="True"></ui:uigridviewboundcolumn>
                ...
                <ui:UIPanel runat="server" ID="approvePanel" BorderStyle="NotSet" meta:resourcekey="approvePanelResource1">
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridApproved" runat="server" DataKeyNames="AccountID" CssClass="datagrid"
                        BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                        Width="100%" meta:resourcekey="gridApprovedResource1" PageSize="1000" ShowCaption="false" AllowSorting="false">
                        <Columns>
                            <ui:uigridviewboundcolumn PropertyName="AccountID" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Level" ReadOnly="True"></ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Type" ReadOnly="True"></ui:uigridviewboundcolumn>
                ...
                <ui:UIPanel runat="server" ID="expensePendingApprovalPanel" BorderStyle="NotSet"
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridExpensedPendingApproval" runat="server" DataKeyNames="AccountID"
                        CssClass="datagrid" BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                ...
                <ui:UIPanel runat="server" ID="expensePanel" BorderStyle="NotSet" meta:resourcekey="expensePanelResource1">
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridExpensed" runat="server" DataKeyNames="AccountID" CssClass="datagrid"
                        BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                ...
                <ui:UIPanel runat="server" ID="invoicedPanel" BorderStyle="NotSet" meta:resourcekey="invoicedPanelResource1">
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridInvoiced" runat="server" DataKeyNames="AccountID" CssClass="datagrid"
                        BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                ...
                <ui:UIPanel runat="server" ID="paymentPanel" BorderStyle="NotSet" meta:resourcekey="paymentPanelResource1">
                    ...
                    <br />
                    <br />
                    <ui:uigridview ID="gridPayment" runat="server" DataKeyNames="AccountID" CssClass="datagrid"
                        BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="1" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <ui:uigridviewboundcolumn PropertyName="Payment" ReadOnly="True" HeaderText="(8) Total Paid by Finance">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month01Amount" ReadOnly="True" HeaderText="Jan">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month02Amount" ReadOnly="True" HeaderText="Feb">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month03Amount" ReadOnly="True" HeaderText="Mar">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month04Amount" ReadOnly="True" HeaderText="Apr">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month05Amount" ReadOnly="True" HeaderText="May">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month06Amount" ReadOnly="True" HeaderText="Jun">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month07Amount" ReadOnly="True" HeaderText="Jul">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month08Amount" ReadOnly="True" HeaderText="Aug">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month09Amount" ReadOnly="True" HeaderText="Sep">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month10Amount" ReadOnly="True" HeaderText="Oct">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month11Amount" ReadOnly="True" HeaderText="Nov">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                            <ui:uigridviewboundcolumn PropertyName="Month12Amount" ReadOnly="True" HeaderText="Dec">
                                <HeaderStyle HorizontalAlign="Right" /><FooterStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                            </ui:uigridviewboundcolumn>
                        </Columns>
