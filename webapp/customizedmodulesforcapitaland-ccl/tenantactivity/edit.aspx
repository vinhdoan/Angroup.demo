...
<script runat="server">
    ...
    protected void gv_Tenants_Action(object sender, string commandName, List<object> objectIds)
    {
        ...
        if (commandName == "AddTenants")
            searchTenants.Show();
    }

    protected void searchTenants_Searched(objectSearchDialogBox.SearchEventArgs e)
    {
        e.CustomCondition = TablesLogic.tUser.isTenant == 1;
    }

    protected void searchTenants_Selected(object sender, EventArgs e)
    {
        OTenantActivity activity = panel.SessionObject as OTenantActivity;
        foreach (Guid id in searchTenants.SelectedDataKeys)
            activity.Tenants.AddGuid(id);
            ...
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabObject" BorderStyle="NotSet" meta:resourcekey="tabObjectResource1" >
                    <ui:UITabView ID="tabDetails" runat="server" Caption="Details" BorderStyle="NotSet" meta:resourcekey="tabDetailsResource2">
                        ...
                        <web:searchdialogbox runat="server" ID="searchTenants" BaseTable="tUser" 
                            AutoSearchOnLoad="true"
                            MaximumNumberOfResults="100" AllowMultipleSelection="true" OnSearched="searchTenants_Searched" OnSelected="searchTenants_Selected">
                            <Columns>
                                <ui:UIGridViewBoundColumn HeaderText="Tenant" PropertyName="ObjectName" HeaderStyle-Width="600px"></ui:UIGridViewBoundColumn>
                            </Columns>
                        </web:searchdialogbox>
                        <table width="96%">
                            <tr>
                                    ...
                                    <ui:UIGridView runat="server" ID="gv_Tenants" PropertyName="Tenants"
                                       Caption="List of Tenants" ValidateRequiredField="True"
                                        ...
                                        <commands>
                                            ...
                                            <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" CommandName="AddTenants" CommandText="Add Tenants" ImageUrl="~/images/add.gif" />
                                        </commands>
                                        <Columns>
                        ...
                        <ui:uifieldtextbox runat="server" id="textDescription" PropertyName="Description" MaxLength="0" CAption="Description" TextMode="MultiLine" Rows="10" InternalControlWidth="95%" meta:resourcekey="textDescriptionResource2"></ui:uifieldtextbox>
                    </ui:UITabView>
