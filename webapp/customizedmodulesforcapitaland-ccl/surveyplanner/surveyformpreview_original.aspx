...
<script runat="server">
    ...
    {
        if (Request["SID"] != null && Request["SRFID"] != null)
        {
                ...
                if (SRT != null && SRT.Checklist != null)
                {
                    ...
                    foreach (OChecklistItem CLI in CL.ChecklistItems)
                    {
                        dt.Rows.Add(
                            ...
                            CL.ObjectID,
                            CL.ObjectName,
                            SRT.SurveyTrade.SurveyGroup.ObjectName,
                            (SRT.Contract != null && SRT.Contract.Vendor != null ? SRT.Contract.Vendor.ObjectName : SRT.EvaluatedPartyName),
                            CLI.StepNumber,
                            CLI.ObjectName,
                            CLI.ChecklistType
                            );
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ht_ChecklistResult[CL.ObjectID.Value.ToString() + "::" + SRT.SurveyTrade.ObjectID.Value.ToString() + "::" + (SRT.Contract != null && SRT.Contract.Vendor != null ? SRT.Contract.Vendor.ObjectName : SRT.EvaluatedPartyName)
                            ]
                    = dt;
                        dt0.Rows.Add(CL.ObjectID,
                            SRT.SurveyTrade.ObjectID,
                            (SRT.Contract != null && SRT.Contract.Vendor != null ? SRT.Contract.Vendor.ObjectName : SRT.EvaluatedPartyName)
                            );
                    }
                }
