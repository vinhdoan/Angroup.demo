    ...
    <div>
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;" class="menu">
            <tr class="menu-top">
                <td>
                    &nbsp;
                    <asp:Label runat="server" ID="labelUserName" meta:resourcekey="labelUserNameResource1">John Doe</asp:Label>
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <img id="menu_imageEditProfile" src="../../images/user_edit.gif" align="absmiddle"
                        style="border-width: 0px;" />
                    &nbsp;
                    <asp:Label runat="server" ID="labelEditProfile" meta:resourcekey="labelEditProfileResource1">Edit Profile</asp:Label>
                    &nbsp;
                    <img id="menu_imageLogout" src="../../images/logout.gif" align="absmiddle" style="border-width: 0px;" />
                    <asp:Label runat="server" ID="label1" meta:resourcekey="label1Resource1">Logout</asp:Label>
                    &nbsp; &nbsp;
                </td>
            </tr>
            <tr>
        ...
        <div class='search-name'>
            <span id="panel_labelCaption" meta:resourcekey="panel_labelCaptionResource1">Work</span>
        </div>
                                        ...
                                        <div style="clear: both;">
                                            <span id="panel_buttonSearch">
                                                <img src="../../images/find.gif" align="absmiddle" style="border-width: 0px;" />&nbsp;<a
                                                    id="panel_buttonSearch_bt" href='javascript:void(0)'><asp:Label runat="server" ID="labelPerformSearch" meta:resourcekey="labelPerformSearchResource1">Perform Search</asp:Label></a>&nbsp;
                                                &nbsp; </span>
                                        </div>
                                    </span></span></span>
                                </td>
                                <td>
                                    <span id="panel_buttonSearchNoFocus" style="display: none"><a id="panel_buttonSearchNoFocus_bt"
                                        ...
                                        <img src="../../images/symbol-refresh-big.gif" align="absmiddle" style="border-width: 0px;" />&nbsp;<a
                                            ...
                                            <asp:Label runat="server" ID="labelResetAllFields" meta:resourcekey="labelResetAllFieldsResource1">Reset All Fields</asp:Label>
                                        </a>&nbsp; &nbsp; </span>
                                </td>
                                <td>
                ...
                <td>
                    <ul>
                        <li id="uitabview3_li" style="display: inline;"><a href="#">
                            <asp:Label runat="server" ID="labelSearch" meta:resourcekey="labelSearchResource1">Search</asp:Label></a></li><li class="selected"
                                id="uitabview4_li" style="display: inline;"><a href="#">
                                    <asp:Label runat="server" ID="labelResults" meta:resourcekey="labelResultsResource1">Results</asp:Label></a></li>
                    </ul>
                </td>
            </tr>
        </table>
            ...
            <table cellspacing="0" cellpadding="0" border="0" style="width: 100%; border-collapse: collapse;">
                <tr>
                    <td class="grid-caption" valign="top">
                        <div>
                            <span></span><span><asp:Label runat="server" ID="labelItems" meta:resourcekey="labelItemsResource1">1 item(s)</asp:Label></span>
                        </div>
                    </td>
                </tr>
            </table>
                        ...
                        <div>
                            <span>
                                <img src="../../images/delete.gif" align="absmiddle" style="border-width: 0px;" />&nbsp;<a
                                    ...
                                    <asp:Label runat="server" ID="labelDeleteSelected" meta:resourcekey="labelDeleteSelectedResource1">Delete Selected</asp:Label>
                                    </a>&nbsp; &nbsp; </span>
                        </div>
                    </td>
                </tr>
            ...
            <div>
                <table cellspacing="0" border="0" id="gridResults_gridResults_gv" style="width: 100%;
                    ...
                    <tr class="grid-header">
                        ...
                        <th align="left" scope="col">
                            <a href="javascript:void(0)">
                                <asp:Label runat="server" ID="labelHeaderWorkNumber" meta:resourcekey="labelHeaderWorkNumberResource1">Work Number</asp:Label>
                                </a><img src="../../images/sort_descending.gif" align="absmiddle" style="border-width: 0px;" />
                        </th>
                        <th align="left" scope="col">
                            <a href="javascript:void(0)">
                                <asp:Label runat="server" ID="labelHeaderWorkDescription" meta:resourcekey="labelHeaderWorkDescriptionResource1">Work Description</asp:Label>
                                </a>
                        </th>
                        <th align="left" scope="col">
                            <a href="javascript:void(0)">
                                <asp:Label runat="server" ID="labelHeaderTypeOfWork" meta:resourcekey="labelHeaderTypeOfWorkResource1">Type of Work</asp:Label>
                                </a>
                        </th>
                        <th align="left" scope="col">
                            <a href="javascript:void(0)">
                                <asp:Label runat="server" ID="labelHeaderTypeOfService" meta:resourcekey="labelHeaderTypeOfServiceResource1">Type of Service</asp:Label>
                                </a>
                        </th>
                        <th align="left" scope="col">
                            <a href="javascript:void(0)">
                                <asp:Label runat="server" ID="labelHeaderStatus" meta:resourcekey="labelHeaderStatusResource1">Status</asp:Label>
                                </a>
                        </th>
                    </tr>
                    <tr class="grid-row" style="background-color: White;">
                        ...
                        <td align="left">
                            <asp:Label runat="server" ID="labelWorkDescription1" meta:resourcekey="labelWorkDescription1Resource1">Air-con too cold</asp:Label>
                        </td>
                        <td align="left">
                            <asp:Label runat="server" ID="labelTypeOfWork1" meta:resourcekey="labelTypeOfWork1Resource1">Corrective Maintenance</asp:Label>
                        </td>
                        <td align="left">
                            <asp:Label runat="server" ID="labelTypeOfService1" meta:resourcekey="labelTypeOfService1Resource1">Air-Conditioning</asp:Label>
                        </td>
                        <td align="left">
                            <asp:Label runat="server" ID="labelStatus1" meta:resourcekey="labelStatus1Resource1">Pending Execution</asp:Label>
                        </td>
                    </tr>
                    <tr class="grid-pager">
                        <td colspan="9">
