...
<script runat="server">
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        if (Request["MODE"] != null && Security.Decrypt(Request["MODE"]) == "EDITPROFILE")
        {
            ...
            cbEnableAllBuilding.Enabled = false;
        }
        else
        ...
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1" BorderStyle="NotSet">
                <ui:UITabView runat="server" ID="tabDetails" Caption="Details" meta:resourcekey="tabDetailsResource1" BorderStyle="NotSet">
                    ...
                    <ui:UIFieldCheckBox runat="server" ID="cbEnableAllBuilding" PropertyName="EnableAllBuildingForGWJ" Caption="Group WJ" Span="Half" Text="Yes, allow to select all buildings in a group WJ regardless of where the user is assigned to." ForeColor="Red"></ui:UIFieldCheckBox>
                    <br />
                    ...
                    <ui:UIFieldCheckBox runat="server" Enabled="False" ID="cbIsTenant" Caption="Is Tenant" PropertyName="isTenant" meta:resourcekey="cbIsTenantResource1" TextAlign="Right" Span="Half">
                    </ui:UIFieldCheckBox>
                    <ui:UIFieldCheckBox runat="server" ID="cbIsSupporter" Caption="Is Supporter" PropertyName="IsSupporter" TextAlign="Right" Span="Half">
                    </ui:UIFieldCheckBox>
                </ui:UITabView>
                <ui:UITabView runat="server" ID="tabPosition" Caption="Positions" CssClass="div-from" meta:resourcekey="tabPositionResource1" BorderStyle="NotSet">
                    <ui:UIFieldSearchableDropDownList ID="sddl_PositionID" runat="server" Caption="Position" Visible="false"
                        OnSelectedIndexChanged="sddl_PositionID_SelectedIndexChanged" meta:resourcekey="sddl_PositionIDResource1" SearchInterval="300">
                    </ui:UIFieldSearchableDropDownList>
                    <web:searchdialogbox runat="server" ID="searchPositions" 
                        AllowMultipleSelection="true" Title="Grant Positions"
                        SearchTextBoxPropertyNames="ObjectName,LocationAccess.ObjectName,EquipmentAccess.ObjectName"
                        BaseTable="tPosition" MaximumNumberOfResults="500" OnSearched="searchPositions_Searched" OnSelected="searchPositions_Selected">
                        <Columns>
                            <ui:UIGridViewBoundColumn HeaderText="Position Name" HeaderStyle-Width="300px" PropertyName="ObjectName"></ui:UIGridViewBoundColumn>
                            <ui:UIGridViewBoundColumn HeaderText="Location" HeaderStyle-Width="200px" PropertyName="LocationAccessText"></ui:UIGridViewBoundColumn>
                            <ui:UIGridViewBoundColumn HeaderText="Equipment" HeaderStyle-Width="200px" PropertyName="EquipmentAccessText"></ui:UIGridViewBoundColumn>
                        </Columns>
                        <AdvancedPanel>
                            <ui:UIFieldTreeList runat='server' ID='treeLocation' PropertyName="LocationAccess.ObjectID" 
                                Caption="Location" CaptionWidth="120px" Span="Half"
                                OnAcquireTreePopulater="treeLocation_AcquireTreePopulater" >
                            </ui:UIFieldTreeList>
                        </AdvancedPanel>
                    </web:searchdialogbox>
                    <ui:UIHint runat="server" ID="hintDelegation" meta:resourcekey="hintDelegationResource1" Visible="true" Text="
                    ...
                    <table>
                        <tr valign='top'>
                            ...
                            <ui:UIGridView runat="server" ID="gv_Position" PropertyName="PermanentPositions" OnAction="gv_Position_Action" Caption="Granted Positions" ValidateRequiredField="True" KeyName="ObjectID" BindObjectsToRows="True" meta:resourcekey="gv_PositionResource1" DataKeyNames="ObjectID" GridLines="Both" RowErrorColor="" style="clear: both;" ImageRowErrorUrl="" OnRowDataBound="gv_Position_RowDataBound">
                                ...
                                <commands>
                                    <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" CommandName="AddObjects" CommandText="Grant Position" ImageUrl="~/images/add.gif" />
                    ...
                    <ui:UIGridView runat='server' ID="gridDelegatedByOthersPositions" PropertyName="DelegatedByOthersPositions" Caption="Positions Delegated to Me" 
                        CheckBoxColumnVisible="False" DataKeyNames="ObjectID" GridLines="Both"
                        RowErrorColor="" style="clear:both;" meta:resourcekey="gridDelegatedByOthersPositionsResource1"  Visible="true">
                        <PagerSettings Mode="NumericFirstLast" />
                        <Columns>
            ...
            <ui:UIDialogBox runat="server" ID="popupDelegatePositions" Title="I would like to delegate selected positions to"
                Button1AlwaysEnabled="false" Button1AutoClosesDialogBox="true" Button1CausesValidation="true" Button1CommandName="Confirm" Button1ImageUrl="~/images/tick.gif" Button1Text="Confirm"
                Button2AlwaysEnabled="true" Button2AutoClosesDialogBox="true" Button2CausesValidation="false" Button2CommandName="Cancel" Button2ImageUrl="~/images/delete.gif" Button2Text="Cancel" OnButtonClicked="popupDelegatePositions_ButtonClicked">
