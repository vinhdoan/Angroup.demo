...
<body>
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" meta:resourcekey="panelMainResource1">
            <web:object runat="server" ID="panel" Caption="Email" BaseTable="tEmailLog" SaveButtonsVisible="false"
            ...
            <div class="div-main">
                <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1" BorderStyle="NotSet">
                    <ui:UITabView runat="server" ID="uitabview1" Caption="Details" 
                        ...
                        <br />
                        <br />
                        <ui:UIFieldRichTextBox runat="server" ID="richEmailBody" PropertyName="EmailBody" CaptionPosition="Top" ForeColor="GradientActiveCaption"></ui:UIFieldRichTextBox>
                        <%--<ui:UIFieldLabel runat="server" ID="labelEmailBody" PropertyName="" Caption="Email Body" ForeColor="GradientActiveCaption"></ui:UIFieldLabel>--%>
                    </ui:UITabView>
                </ui:UITabStrip>
            </div>
        </ui:UIObjectPanel>
