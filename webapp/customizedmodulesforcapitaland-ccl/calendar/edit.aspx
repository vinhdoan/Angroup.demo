...
<script runat="server">
    ...
    protected void panel_ValidateAndSave(object sender, EventArgs e)
    {
        ...
        if (calendar.IsWorkDay0 == 0 && calendar.IsWorkDay1 == 0 &&
            ...
            labelWorkDay.ErrorMessage = Resources.Errors.Calendar_NoWorkDays;
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        dropLocation.Bind(OLocation.GetLocationsByType(OApplicationSetting.Current.LocationTypeNameForBuildingActual, false, positions, calendar.LocationID));

        panel.ObjectPanel.BindObjectToControls(calendar);        
    }
</script>
...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain">
        <web:object runat="server" ID="panel" Caption="Calendar" BaseTable="tCalendar"
            ...
            AutomaticBindingAndSaving="true" OnPopulateForm="panel_PopulateForm"></web:object>
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1">
                <ui:UITabView ID="uitabview1" runat="server" Caption="Details"
                    ...
                    <ui:UIFieldDropDownList runat="server" ID="dropLocation" PropertyName="LocationID" ValidateRequiredField="true" Caption="Location"></ui:UIFieldDropDownList>
                    <table>
                        <tr class="field-required">
                            <td style='width: 157px'>
                                <ui:UIFieldLabel runat="server" id="labelWorkDay" FieldLayout="Flow" Text="Work Day*:"></ui:UIFieldLabel>
                            </td>
                            <td>
                                <ui:UIFieldCheckBox ID="IsWorkDay0" runat="server" ShowCaption="false"
                                    Text="Sunday" PropertyName="IsWorkDay0" meta:resourcekey="IsWorkDay0Resource1"
                                    ToolTip="The days of the week that are working days." FieldLayout="Flow">
                                </ui:UIFieldCheckBox>
                            </td>
                            <td>
                                <ui:UIFieldCheckBox ID="IsWorkDay1" runat="server" Text="Monday" FieldLayout="Flow"
                                    PropertyName="IsWorkDay1" meta:resourcekey="IsWorkDay1Resource1">
                                </ui:UIFieldCheckBox>
                            </td>
                            <td>
                                <ui:UIFieldCheckBox ID="IsWorkDay2" runat="server" Text="Tuesday" FieldLayout="Flow"
                                    PropertyName="IsWorkDay2" meta:resourcekey="IsWorkDay2Resource1">
                                </ui:UIFieldCheckBox>
                            </td>
                            <td>
                                <ui:UIFieldCheckBox ID="IsWorkDay3" runat="server" Text="Wednesday" FieldLayout="Flow"
                                    PropertyName="IsWorkDay3" meta:resourcekey="IsWorkDay3Resource1">
                                </ui:UIFieldCheckBox>
                            </td>
                            <td>
                                <ui:UIFieldCheckBox ID="IsWorkDay4" runat="server" Text="Thursday" FieldLayout="Flow"
                                    PropertyName="IsWorkDay4" meta:resourcekey="IsWorkDay4Resource1">
                                </ui:UIFieldCheckBox>
                            </td>
                            <td>
                                <ui:UIFieldCheckBox ID="IsWorkDay5" runat="server" Text="Friday" FieldLayout="Flow"
                                    PropertyName="IsWorkDay5" meta:resourcekey="IsWorkDay5Resource1">
                                </ui:UIFieldCheckBox>
                            </td>
                            <td>
                                <ui:UIFieldCheckBox ID="IsWorkDay6" runat="server" Text="Saturday" FieldLayout="Flow"
                                    PropertyName="IsWorkDay6" meta:resourcekey="IsWorkDay6Resource1">
                                </ui:UIFieldCheckBox>
                            </td>
                        </tr>
                    </table>
                    <ui:UIFieldDropDownList runat="server" ID="dropFirstDayOfWeek" PropertyName="" Caption="First day of week">
                        <Items>
                            <asp:ListItem Text="" Value=""></asp:ListItem>
                            <asp:ListItem Text="Sunday" Value="0"></asp:ListItem>
                            <asp:ListItem Selected="True" Text="Monday" Value="1"></asp:ListItem>
                    ...
                    <ui:UIFieldDateTime runat="server" ID="timeWorkHourStart" PropertyName="WorkHourStart" Caption="Start time" ShowTimeControls="true" ShowDateControls="false"></ui:UIFieldDateTime>
                    <ui:UIFieldDateTime runat="server" ID="timeWorkHourEnd" PropertyName="WorkHourEnd" Caption="End time" ShowTimeControls="true" ShowDateControls="false"></ui:UIFieldDateTime>
                    <br />
                    <br />
                    <br />
