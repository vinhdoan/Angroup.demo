...
<script runat="server">
    ...
    protected void ddlmetername_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (meter != null)
        {
            try
            {
                pt.Barcode = meter.Barcode;
                pt.UnitOfMeasureID = meter.UnitOfMeasureID;
                pt.BMSCode = meter.BMSCode;
                pt.TypeOfMeterID = meter.TypeOfMeterID;
                pt.IsIncreasingMeter = meter.IsIncreasingMeter;
                pt.MaximumReading = meter.MaximumReading;
                pt.Factor = meter.Factor;
            ...
            <ui:UITabStrip runat="server" ID="tabObject" BorderStyle="NotSet" meta:resourcekey="tabObjectResource1">
                <ui:UITabView ID="uitabview1" runat="server" Caption="Details" BorderStyle="NotSet" meta:resourcekey="uitabview1Resource1">
                    <ui:uipanel runat="server" id="panelDetails" BorderStyle="NotSet" 
                        ...
                        <ui:UIFieldSearchableDropDownList runat="server" ID="ddlmetername" Caption="Meter Name" PropertyName="meterID" OnSelectedIndexChanged="ddlmetername_SelectedIndexChanged"></ui:UIFieldSearchableDropDownList>
