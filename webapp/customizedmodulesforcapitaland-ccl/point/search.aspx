...
<script runat="server">
    ...
    protected void panel_Search(objectSearchPanel.SearchEventArgs e)
    {
        ...
        //if (IsActive.SelectedValue == "1")
            e.CustomCondition &= TablesLogic.tPoint.IsActive == (IsActive.SelectedValue == "" ? 1 : Convert.ToInt16(IsActive.SelectedValue));
    }
...
<body>
    <form id="form2" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="Point" GridViewID="gridResults" EditButtonVisible="false"
                BaseTable="tPoint" meta:resourcekey="panelResource1" 
                AutoSearchOnLoad="false" MaximumNumberOfResults="100" AdvancedSearchPanelID="panelAdvanced"
                SearchTextBoxHint="Point Name, Description, Tenant Name, Barcode" AdvancedSearchOnLoad="false"
                SearchTextBoxPropertyNames="ObjectName,Description,Tenant.ObjectName,TenantLease.Tenant.ObjectName,TenantLease.ShopName,Barcode"
            ...
            <div class="div-form">
                <%--<ui:UITabStrip runat="server" ID="tabSearch" BorderStyle="NotSet" 
                    ...
                    <ui:UITabView runat="server" ID="uitabview4" Caption="Results" 
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" Caption="" 
                            ...
                            <commands>
                                ...
                                <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" CommandName="MassAssign" CommandText="Mass Assign (Reminder Users)" ImageUrl="~/images/tick.gif" meta:resourcekey="UIGridViewCommandResource3" />
                            </commands>
                            <Columns>
