    ...
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="formMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="Company" GridViewID="gridResults" 
                ...
                AutoSearchOnLoad="false" MaximumNumberOfResults="100" SearchTextBoxHint="Company Name, Payment Name, Description"
                AdvancedSearchOnLoad="false" AdvancedSearchPanelID="panelAdvanced" SearchTextBoxPropertyNames="ObjectName,PaymentName,Description"
