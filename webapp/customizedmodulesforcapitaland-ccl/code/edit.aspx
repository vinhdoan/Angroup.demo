...
<script runat="server">
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (CodeTypeID.SelectedItem.Text.ToString() == "PurchaseType")
            OnlyApplicableForTermContract.Visible =
            RequiredCRVSerialNumber.Visible = true;
        else
            OnlyApplicableForTermContract.Visible =
            RequiredCRVSerialNumber.Visible = false;
            ...
            <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1"
                ...
                <ui:UITabView runat="server" ID="uitabview1" Caption="Details" meta:resourcekey="uitabview1Resource1"
                    ...
                    <ui:UIFieldDropDownList runat="server" ID="CodeTypeID" PropertyName="CodeTypeID"
                        ...
                        OnSelectedIndexChanged="CodeTypeID_SelectedIndexChanged" meta:resourcekey="CodeTypeIDResource1">
                    ...
                    <ui:UIFieldCheckBox runat="server" ID="IsWholeNumberUnit" PropertyName="IsWholeNumberUnit"
                        ...
                        meta:resourcekey="IsWholeNumberUnitResource1" TextAlign="Right">
                    </ui:UIFieldCheckBox>
                    <ui:UIFieldCheckBox runat="server" ID="RequiredCRVSerialNumber" PropertyName="RequiredCRVSerialNumber"
                        Caption="Required CRV Serial Number?">
                    </ui:UIFieldCheckBox>
                    <ui:UIFieldCheckBox runat="server" ID="OnlyApplicableForTermContract" PropertyName="OnlyApplicableForTermContract"
                        Caption="Only applicable for term contract?">
                    </ui:UIFieldCheckBox>
                    &nbsp; &nbsp;&nbsp;
                </ui:UITabView>
