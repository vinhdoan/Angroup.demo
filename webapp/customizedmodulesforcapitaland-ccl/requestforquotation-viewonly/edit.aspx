...
<script runat="server">
    ...
    protected void Workflow_Setting(ORequestForQuotation RFQ)
    {
        ...
        panelBudget2.Enabled = !state.Is("PendingApproval", "Awarded", "Close", "Cancelled");
        ...
        textAwardedJustification.ValidateRequiredField =
            ...
            cbDeliverToOther.ValidateRequiredField = action.Is("SubmitForApproval", "Approve");
                    ...
                    <ui:UIPanel runat="server" ID="panelDetails" meta:resourcekey="panelDetailsResource1"
                        ...
                        <ui:UIPanel runat="server" ID="panelDetails2">
                            ...
                            <ui:UIPanel runat="server" ID="panelGroupWJ" BorderStyle="NotSet" meta:resourcekey="panelGroupWJResource1">
                                ...
                                <ui:UIGridView runat="server" ID="gridLocations" Caption="Locations" OnAction="gridLocations_Action" ValidateRequiredField="true"
                                    PropertyName="GroupWJLocations" BindObjectsToRows="true">
                                    <Commands>
                            ...
                            <ui:UIFieldTextBox ID="DeliverToAddress" runat="server" Caption="Deliver To" TextMode="MultiLine" Rows="3"
                                PropertyName="DeliverToAddress" Visible="false">
                            </ui:UIFieldTextBox>
