    ...
    protected void panel_Search(objectSearchPanel.SearchEventArgs e)
    {
        if (e.CustomCondition == null)
            e.CustomCondition = TablesLogic.tStoreStockTake.StoreID.In(OStore.FindAccessibleStores(AppSession.User, Security.Decrypt(Request["TYPE"]), null))
                | (TablesLogic.tStoreStockTake.StoreID == null & TablesLogic.tStoreStockTake.CurrentActivity.Users.ObjectID == AppSession.User.ObjectID);
    }
...
<body>
    <form id="form2" runat="server">
        ...
        <web:search runat="server" ID="panel" Caption="Stock Take" GridViewID="gridResults" EditButtonVisible="false" meta:resourcekey="panelResource1" AssignedCheckboxVisible="true"
            ObjectPanelID="tabSearch" BaseTable="tStoreStockTake" OnSearch="panel_Search" 
            AutoSearchOnLoad="true" MaximumNumberOfResults="300" 
            AdvancedSearchPanelID="panelAdvanced"
            SearchTextBoxHint="Stocktake Number, Description"
