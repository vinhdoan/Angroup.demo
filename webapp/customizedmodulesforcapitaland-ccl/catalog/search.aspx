    ...
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" meta:resourcekey="panelMainResource1">
            <web:search runat="server" ID="panel" Caption="Inventory Catalog" GridViewID="gridResults" 
                BaseTable="tCatalogue" OnSearch="panel_Search" meta:resourcekey="panelResource1" 
                AutoSearchOnLoad="false" MaximumNumberOfResults="30" SearchTextBoxHint="Catalogue Name, Stockcode, Model"
                SearchTextBoxPropertyNames="ObjectName,StockCode,Model" AdvancedSearchPanelID="panelAdvanced"
                OnPopulateForm="panel_PopulateForm" SearchType="ObjectQuery" SearchAssignedOnly="false" ></web:search>
            <div class="div-form">
                    <ui:UIFieldTreeList runat="server" ID="treeCatalogue" 
                        Caption="Inventory Catalog" OnAcquireTreePopulater="treeCatalogue_AcquireTreePopulater" 
                        meta:resourcekey="treeCatalogueResource1" ShowCheckBoxes="None" TreeValueMode="SelectedNode">
                    </ui:UIFieldTreeList>
                    ...
                    <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                        ...
                        <ui:UIFieldRadioList runat="server" ID="IsCatalogueItem" PropertyName="IsCatalogueItem"
                            ...
                            <Items>
                                ...
                                <asp:ListItem selected="True" Value="1" meta:resourcekey="ListItemResource3" Text="Inventory Catalog Item"></asp:ListItem>
                            </Items>
                        </ui:UIFieldRadioList>
                    ...
                    <ui:UITabView runat="server" ID="uitabview2" Caption="Results" 
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black"
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="Parent.ObjectName" HeaderText="Folder"  PropertyName="Parent.ObjectName" ResourceAssemblyName="" SortExpression="Parent.ObjectName">
