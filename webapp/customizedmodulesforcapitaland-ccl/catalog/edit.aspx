        ...
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1"
                ...
                <ui:UITabView runat="server" ID="uitabview1" Caption="Details" meta:resourcekey="uitabview1Resource1"
                    ...
                    <ui:UIPanel runat="server" ID="panelGeneratedFromEquipmentType" BorderStyle="NotSet"
                        meta:resourcekey="panelGeneratedFromEquipmentTypeResource2">
                        <img src="../../images/information.png" style="border: 0px" alt='' />
                        <asp:Label runat="server" ID="labelGeneratedFromEquipmentType" Text="This record has been generated from an Equipment Type record"
                            meta:resourcekey="labelGeneratedFromEquipmentTypeResource2"></asp:Label>
                        <br />
                        <br />
                    </ui:UIPanel>
                    ...
                    <ui:UIPanel runat="server" ID="panelCatalogueItem1" meta:resourcekey="panelCatalogueItem1Resource1"
                        ...
                        <ui:UIFieldTextBox runat="server" ID="UnitPrice" PropertyName="UnitPrice" Span="Half"
                            ...
                            ValidationDataType='Currency' meta:resourcekey="UnitPriceResource1" ValidateRangeField="True"
                            ValidationRangeMin="0" ValidationRangeMinInclusive="True" ValidationRangeType="Currency"
                            InternalControlWidth="95%" />
                        ...
                        <ui:UIFieldTextBox ID="DefaultChargeOut" runat="server" Caption="Default Charge Out"
                            DataFormatString="{0:#,##0.00}" PropertyName="DefaultChargeOut" Span="Half" ValidateDataTypeCheck="True"
                            ...
                            meta:resourcekey="DefaultChargeOutResource1" />
                        ...
                        <ui:UIFieldRadioList runat="server" ID="radioInventoryCatalogType" Caption="Type"
                            ...
                            ValidateRequiredField="True" meta:resourcekey="radioInventoryCatalogTypeResource2"
                            TextAlign="Right">
                        </ui:UIFieldRadioList>
                        <ui:UIFieldLabel runat='server' ID="labelInventoryCatalogType" Text="Select the appropriate type for this inventory catalog. This cannot be changed once the inventory catalog is saved."
                            DataFormatString="" meta:resourcekey="labelInventoryCatalogTypeResource2" />
                        ...
                        <ui:UIFieldTextBox runat='server' ID='textObtainedMethod' PropertyName='ObtainedMethod'
                            Caption="How Premium is Obtained?">
                        </ui:UIFieldTextBox>
                        <ui:UIFieldRadioList runat='server' ID="radioHasInputTax" PropertyName="HasInputTax"
                            Caption="Input Tax?" RepeatColumns="0" RepeatDirection="Horizontal">
                            <Items>
                        ...
                        <ui:UIFieldCheckBox runat="server" ID="IsRemovedAfterExpended" Caption="Removed after expended"
                            ...
                            meta:resourcekey="IsRemovedAfterExpendedResource1" TextAlign="Right">
                        </ui:UIFieldCheckBox>
                    </ui:UIPanel>
                    <ui:UISeparator runat="server" ID="separator" meta:resourcekey="separatorResource1" />
                    <ui:UIFieldCheckBox runat="server" ID="IsSharedAcrossAllStores" Caption="Share across all stores"
                        ...
                        meta:resourcekey="IsSharedAcrossAllStoresResource1" OnCheckedChanged="IsSharedAcrossAllStores_CheckedChanged"
                        TextAlign="Right">
                    </ui:UIFieldCheckBox>
                    <br />
                    <br />
                    <ui:UIFieldListBox runat="server" ID="listStore" PropertyName="Store" ToolTip="Store list assigned to this catalog"
                        Caption="List of Applicable Stores" meta:resourcekey="listStoreResource2"></ui:UIFieldListBox>
                </ui:UITabView>
