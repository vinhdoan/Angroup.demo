    ...
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
            ...
            <web:search runat="server" ID="panel" Caption="Location" GridViewID="gridResults" EditButtonVisible="true"
                BaseTable="tLocation" OnSearch="panel_Search" SearchType="ObjectQuery"
                ...
                SearchTextBoxHint="Location Name"
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td width="150px" valign="middle">
                            <ui:UIFieldCheckBox id="IncludeInactive" runat="server" caption="Show Inactive area as well" ShowCaption="false" FieldLayout="Flow" Text="include inactive area." TextAlign="Right" Span="Half" OnCheckedChanged="IncludeInactive_CheckedChanged" />
                ...
                <%--<ui:UITabStrip runat="server" ID="tabSearch" 
                    ...
                    <ui:UITabView runat="server" ID="uitabview1" Caption="Search" 
                        ...
                        <ui:UIFieldRadioList runat="server" ID="IsPhysicalLocation" PropertyName="IsPhysicalLocation"
                            ...
                            meta:resourcekey="IsPhysicalLocationResource1" RepeatColumns="3"
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black" KeyName="ObjectID"
                            ...
                            <Columns>
                                ...
                                <ui:UIGridViewBoundColumn PropertyName="AmosSuiteID" HeaderText="AMOS Suite ID" DataField="AmosSuiteID" meta:resourcekey="UIGridViewBoundColumnResource5" ResourceAssemblyName="" SortExpression="AmosSuiteID">
                                 ...
                                 <ui:UIGridViewBoundColumn PropertyName="AMOSInstanceID" HeaderText="AMOS Instance ID" DataField="AMOSInstanceID"  ResourceAssemblyName="" SortExpression="AMOSInstanceID">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </ui:UIGridViewBoundColumn>
                            </Columns>
