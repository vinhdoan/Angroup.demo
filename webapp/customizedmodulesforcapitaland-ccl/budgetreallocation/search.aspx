    ...
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" meta:resourcekey="panelMainResource1" BorderStyle="NotSet">
            <web:search runat="server" ID="panel" Caption="Budget Reallocation" SearchType="ObjectQuery"
                ...
                AutoSearchOnLoad="true" SearchTextBoxHint="Budget Reallocation Number, Description of budget reallocation" 
                MaximumNumberOfResults="300" SearchTextBoxPropertyNames="ObjectNumber,Description"
            ...
            <div class="div-form">
                <%--<ui:UITabStrip runat="server" ID="tabSearch" meta:resourcekey="tabSearchResource1" BorderStyle="NotSet">
                    ...
                    <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                        <ui:UIFieldTreeList Caption="Location" runat="server" ID="treeLocation" 
                        ...
                        <ui:UIFieldListBox runat="server" ID="listStatus" PropertyName="CurrentActivity.ObjectName"
                            Caption="Status" Rows="5" meta:resourcekey="StatusIDResource1"></ui:UIFieldListBox>
                    </ui:UIPanel>
                    <%--</ui:UITabView>
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" 
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="Description" HeaderText="Description"
                                    HtmlEncode="false"
                                    meta:resourceKey="UIGridViewBoundColumnResource6" PropertyName="Description" 
