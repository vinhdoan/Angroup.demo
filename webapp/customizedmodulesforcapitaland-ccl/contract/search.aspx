    ...
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" meta:resourcekey="panelResource1" BorderStyle="NotSet">
            <web:search runat="server" ID="panel" Caption="Contract" GridViewID="gridResults"
                BaseTable="tContract" EditButtonVisible="false" AssignedCheckboxVisible="true" 
                AutoSearchOnLoad="false" SearchTextBoxHint="E.g. Contract Number, Contract Name, Vendor Name, Description" 
                MaximumNumberOfResults="30" SearchTextBoxPropertyNames="ObjectNumber,ObjectName,Description,Vendor.ObjectName"
            ...
            <div class="div-form">
                <%--<ui:UITabStrip runat="server" ID="tabSearch" meta:resourcekey="tabSearchResource1" BorderStyle="NotSet">
                    ...
                    <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                        ...
                        <%--<ui:UIFieldTextBox runat='server' ID='UIFieldTextBox4' PropertyName="Vendor.ObjectName" Span="Half"
                        ...
                        <ui:UIFieldListBox runat="server" ID="listStatus" PropertyName="CurrentActivity.ObjectName"
                            Caption="Status" Rows="4" meta:resourcekey="listStatusResource1" />
                    </ui:UIPanel>
                    </ui:UITabView>
                    <%--<ui:UITabView runat="server" ID="uitabview2" Caption="Results" 
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black" KeyName="ObjectID"
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="ContractSum" DataFormatString="{0:c}" HeaderText="Contract Sum" PropertyName="ContractSum" ResourceAssemblyName="" SortExpression="ContractSum">
