    ...
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="formMain" 
            ...
            <web:search runat="server" ID="panel" Caption="Tenant Lease" GridViewID="gridResults" 
                BaseTable="tTenantLease" EditButtonVisible="false"  SearchType="ObjectQuery"
                AutoSearchOnLoad="false" MaximumNumberOfResults="300" AdvancedSearchPanelID="panelAdvanced"
                SearchTextBoxHint="Tenant Name, Location (Unit No.)" AdvancedSearchOnLoad="false"
                SearchTextBoxPropertyNames="Tenant.ObjectName,Location.ObjectName,ShopName"
                ...
                <%--<ui:UITabStrip runat="server" ID="tabSearch" 
                    ...
                    <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                        <ui:uifieldtreelist id="treeLocation" runat="server" caption="Location" 
                            propertyname="" showcheckboxes="None" treevaluemode="SelectedNode" OnAcquireTreePopulater="treeLocation_AcquireTreePopulater" meta:resourcekey="treeLocationResource1">
                        </ui:uifieldtreelist>
                        ...
                        <ui:UIFieldDateTime runat="server" ID="StartDate" Caption="Start Date" PropertyName="LeaseStartDate" SearchType="Range" meta:resourcekey="StartDateResource1" ShowDateControls="True"></ui:UIFieldDateTime>
                        <ui:UIFieldDateTime runat="server" ID="EndDate" Caption="End Date" PropertyName="LeaseEndDate" SearchType="Range" meta:resourcekey="EndDateResource1" ShowDateControls="True"></ui:UIFieldDateTime>
                        <ui:UIFieldDropDownList runat="server" ID="ddlStatus" Caption="Lease Status" PropertyName="LeaseStatus" meta:resourcekey="ddlStatusResource1"></ui:UIFieldDropDownList>
                        <ui:uifieldtextbox id="LeaseAmosOrgID" runat="server" 
                        caption="Amos Org ID" internalcontrolwidth="95%" SearchType="Range"
                        propertyname="AmosOrgID" meta:resourcekey="LeaseAmosOrgIDResource1" />
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black" KeyName="ObjectID"
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="Location.Path" HeaderText="Location" 
                                    PropertyName="Location.Path" meta:resourcekey="UIGridViewBoundColumnResource1" ResourceAssemblyName="" SortExpression="Location.Path" >
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="Tenant.ObjectName" 
                                    HeaderText="Tenant's Name"   
                                    PropertyName="Tenant.ObjectName" ResourceAssemblyName="" meta:resourcekey="UIGridViewBoundColumnResource2" SortExpression="Tenant.ObjectName" >
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                               <cc1:UIGridViewBoundColumn DataField="ShopName" 
                                    HeaderText="Shop Name"  
                                    PropertyName="ShopName" ResourceAssemblyName="" 
                                    SortExpression="ShopName">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="LeaseStartDate" 
                                    HeaderText="Start Date"  
                                    PropertyName="LeaseStartDate" ResourceAssemblyName="" 
                                    DataFormatString="{0:dd-MMM-yyyy}" meta:resourcekey="UIGridViewBoundColumnResource3" SortExpression="LeaseStartDate">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                  <cc1:UIGridViewBoundColumn DataField="LeaseEndDate" 
                                    HeaderText="End Date"  
                                    PropertyName="LeaseEndDate" ResourceAssemblyName="" 
                                    DataFormatString="{0:dd-MMM-yyyy}" meta:resourcekey="UIGridViewBoundColumnResource4" SortExpression="LeaseEndDate">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="LeaseStatus" 
                                    HeaderText="Status"   
                                    PropertyName="LeaseStatus" ResourceAssemblyName="" meta:resourcekey="UIGridViewBoundColumnResource5" SortExpression="LeaseStatus" >
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="" HeaderText="Active?" 
                                    PropertyName="Location.IsActiveText" 
                                    ResourceAssemblyName="" SortExpression="Location.IsActiveText">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="AmosAssetID" HeaderText="Amos Asset ID" 
                                    PropertyName="AmosAssetID" 
                                    ResourceAssemblyName="" SortExpression="AmosAssetID" meta:resourcekey="UIGridViewBoundColumnResource6">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="AmosOrgID" 
                                    HeaderText="Amos Org ID" 
                                    PropertyName="AmosOrgID" ResourceAssemblyName="" 
                                    SortExpression="AmosOrgID" meta:resourcekey="UIGridViewBoundColumnResource7">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="AmosSuiteID" HeaderText="Amos Suite ID" 
                                    PropertyName="AmosSuiteID" 
                                    ResourceAssemblyName="" SortExpression="AmosSuiteID" meta:resourcekey="UIGridViewBoundColumnResource8">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="AmosLeaseID" HeaderText="Amos Lease ID" 
                                    PropertyName="AmosLeaseID" 
                                    ResourceAssemblyName="" SortExpression="AmosLeaseID" meta:resourcekey="UIGridViewBoundColumnResource9">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="updatedOn" HeaderText="AMOS Updated On" 
                                    PropertyName="updatedOn" 
                                    ResourceAssemblyName="" SortExpression="updatedOn" DataFormatString="{0:dd-MMM-yyyy}" meta:resourcekey="UIGridViewBoundColumnResource10">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                            </Columns>
