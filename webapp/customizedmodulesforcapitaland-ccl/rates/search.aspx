    ...
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" meta:resourcekey="panelMainResource1">
            <web:search runat="server" ID="panel" Caption="Service Catalog" GridViewID="gridResults"
                BaseTable="tFixedRate" AutoSearchOnLoad="false" MaximumNumberOfResults="30" AdvancedSearchPanelID="panelAdvanced"
                SearchTextBoxHint="Name, Item Code, LongDescription, etc.." AdvancedSearchOnLoad="false"
                SearchTextBoxPropertyNames="ObjectName,ObjectNumber,LongDescription"
            ...
            <div class="div-form">
                <%--<ui:UITabStrip runat="server" ID="tabSearch" meta:resourcekey="tabSearchResource1" BorderStyle="NotSet">
                    ...
                    <ui:UIFieldTreeList runat="server" ID="treeFixedRate" Caption="Service Catalog" OnAcquireTreePopulater="treeFixedRate_AcquireTreePopulater" meta:resourcekey="treeFixedRateResource1" ShowCheckBoxes="None" TreeValueMode="SelectedNode">
                    </ui:UIFieldTreeList>
                    <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                        ...
                        <ui:UIPanel runat="server" ID="nonBookPanel" Width="100%" meta:resourcekey="nonBookPanelResource1" BorderStyle="NotSet">
                            <ui:UIFieldRadioList runat="server" ID="IsFixedRate" PropertyName="IsFixedRate" OnSelectedIndexChanged="IsFixedRate_SelectedIndexChanged"
                                Caption="Service Catalog Type" ToolTip="Indicates if this item is a group or a physical fixed rate item." RepeatColumns="3"
                                ...
                                <Items>
                                    ...
                                    <asp:ListItem Value="0" meta:resourcekey="ListItemResource5" Text="Service Catalog Group "></asp:ListItem>
                                    <asp:ListItem Selected="True" Value="1" meta:resourcekey="ListItemResource6" Text="Physical Service Catalog Item "></asp:ListItem>
                                </Items>
                            </ui:UIFieldRadioList>
                            <ui:UIPanel runat="server" ID="ratePanel" Width="100%" meta:resourcekey="ratePanelResource1" BorderStyle="NotSet">
                                ...
                                <ui:UIFieldDropDownList runat="server" ID="UnitOfMeasureID" PropertyName="UnitOfMeasureID"
                                    Caption="Unit of Measure" Span="Full" ToolTip="The unit of measure for this fixed rate item."
                                ...
                                <ui:UIFieldTextBox runat="server" ID="UnitPrice" PropertyName="UnitPrice" Caption="Unit Price"
                                    ...
                                    SearchType="Range" InternalControlWidth="95%" /><br />
                    ...
                    <ui:UITabView runat="server" ID="uitabview2" Caption="Results" 
                        ...
                        <ui:UIGridView runat="server" ID="gridResults" KeyName="ObjectID" meta:resourcekey="gridResultsResource1"
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewBoundColumn DataField="ObjectName" HeaderText="Name" meta:resourceKey="UIGridViewColumnResource4" PropertyName="ObjectName" ResourceAssemblyName="" SortExpression="ObjectName">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="ObjectNumber" HeaderText="Item Code" meta:resourceKey="UIGridViewBoundColumnResource1" PropertyName="ObjectNumber" ResourceAssemblyName="" SortExpression="ObjectNumber">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="UnitOfMeasure.ObjectName" HeaderText="Unit of Measure" meta:resourceKey="UIGridViewBoundColumnResource2" PropertyName="UnitOfMeasure.ObjectName" ResourceAssemblyName="" SortExpression="UnitOfMeasure.ObjectName">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="UnitPrice" HeaderText="Unit Price" meta:resourceKey="UIGridViewBoundColumnResource3" PropertyName="UnitPrice" ResourceAssemblyName="" SortExpression="UnitPrice">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                                <cc1:UIGridViewBoundColumn DataField="DefaultChargeOut" DataFormatString="{0:#,##0.00}" HeaderText="Default Charge Out" meta:resourcekey="UIGridViewBoundColumnResource4" PropertyName="DefaultChargeOut" ResourceAssemblyName="" SortExpression="DefaultChargeOut">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                            </Columns>
