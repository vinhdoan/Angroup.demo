...
<script runat="server">
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        gridResults.Commands[2].Visible = AppSession.User.AllowCreate("OReading");
    ...
    protected void gridResults_Action(object sender, string commandName, List<object> dataKeys)
    {
        ...
        else if (commandName == "UploadObject")
        {
    ...
    private bool ValidateInputFile()
    {
        ...
        if (this.fileDialogBox.GetUploadFiles().Count == 0 || this.fileDialogBox.GetUploadFiles()[0] == null
            || this.fileDialogBox.GetUploadFiles()[0].ContentLength == 0
            || !this.fileDialogBox.GetUploadFiles()[0].FileName.ToLower().EndsWith(".xls"))
        {
            validate = false;
    ...
    protected void UploadExcelTemplate()
    {
        panel.Message = "";
        ...
        if (ValidateInputFile())
        {
            ...
            try
            {
                ...
                this.fileDialogBox.GetUploadFiles()[0].SaveAs(filePath);
            ...
            if (gridResults.DataKeys[e.Row.RowIndex][0] != DBNull.Value)
            {
                ...
                if (reading != null)
                {
                    if (reading.Point != null)
                    {
                        ...
                        {
                            if (reading.Point.TenantLease.LeaseStatus != EnumLeaseStatus.New)
                            {
    ...
    protected void fileDialogBox_Uploaded(object sender, EventArgs e)
    {
        UploadExcelTemplate();
    }

    protected void gridUpload_Action(object sender, string commandName, List<object> dataKeys)
    {
        if (commandName == "SaveObject")
        {
            try
            {
                if (!ExcelDataError())
        ...
        else if (commandName == "ClearObject")
        {
            panel.Message = Resources.Errors.ExcelUpload_UploadedDataCleared;
            gridUpload.DataBind();
...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" meta:resourcekey="panelMainResource1">
        <web:search runat="server" ID="panel" Caption="Reading (Multiple)" GridViewID="gridResults"
            ...
            SearchTextBoxHint="E.g.: Point Name, etc..." AutoSearchOnLoad="false" SearchTextBoxPropertyNames="Point.ObjectName"
            AdvancedSearchPanelID="panelAdvanced" MaximumNumberOfResults="10000" OnSearch="panel_Search"
        ...
        <div class="div-form">
            ...
            <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                <ui:UIFieldDateTime runat="server" ID="dateApplicableMonth" Caption="Applicable Month"
                ...
                <ui:UIFieldRadioList runat='server' ID="radioIsApplicableForLocation" PropertyName="IsApplicableForLocation"
                    Caption="Location/Equipment" meta:resourcekey="radioIsApplicableForLocationResource1"
                    TextAlign="Right">
                    <Items>
                ...
                <ui:UIFieldTextBox runat="server" ID="textObjectName" PropertyName="ObjectName" Caption="Point Name"
                    Span="Half" InternalControlWidth="95%" meta:resourcekey="textObjectNameResource1">
                </ui:UIFieldTextBox>
                ...
                <ui:UIFieldTextBox runat="server" ID="textDescription" PropertyName="Description"
                    Caption="Description" InternalControlWidth="95%" meta:resourcekey="textDescriptionResource1">
                </ui:UIFieldTextBox>
            </ui:UIPanel>
            <%--</ui:UITabView>--%>
            ...
            <ui:UIGridView runat="server" ID="gridResults" Caption="Results" KeyName="ObjectID"
                Width="100%" OnAction="gridResults_Action" PageSize="1000" DataKeyNames="ObjectID"
                ...
                <Commands>
                    <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" CommandName="UpdateObject"
                        CommandText="Add New Readings of Selected Points" ImageUrl="~/images/add.gif"
                        meta:resourcekey="UIGridViewCommandResource1" />
                    <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" CommandName="DownloadObject"
                        CommandText="Download Excel Template" ImageUrl="~/images/download.png" meta:resourcekey="UIGridViewCommandResource2" />
                    <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" CommandName="UploadObject"
                        CommandText="Upload Excel Template" ImageUrl="~/images/upload.png" />
                </Commands>
                <Columns>
                    ...
                    <cc1:UIGridViewBoundColumn DataField="OPCDAServer.ObjectName" HeaderText="OPC DA Server"
                        meta:resourcekey="UIGridViewBoundColumnResource2" PropertyName="OPCDAServer.ObjectName"
                        ResourceAssemblyName="" SortExpression="OPCDAServer.ObjectName">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Location.Path" HeaderText="Location" meta:resourcekey="UIGridViewBoundColumnResource3"
                        PropertyName="Location.Path" ResourceAssemblyName="" SortExpression="Location.Path">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Equipment.Path" HeaderText="Equipment" meta:resourcekey="UIGridViewBoundColumnResource4"
                        PropertyName="Equipment.Path" ResourceAssemblyName="" SortExpression="Equipment.Path">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="UnitOfMeasure.ObjectName" HeaderText="Unit Of Measure"
                        meta:resourcekey="UIGridViewBoundColumnResource5" PropertyName="UnitOfMeasure.ObjectName"
                        ResourceAssemblyName="" SortExpression="UnitOfMeasure.ObjectName">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="TenantName" HeaderText="Tenant Name" PropertyName="TenantName"
                        ResourceAssemblyName="" SortExpression="TenantName" meta:resourcekey="UIGridViewBoundColumnResource12">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="TenantLease.ShopName" HeaderText="Shop Name"
                        PropertyName="TenantLease.ShopName" ResourceAssemblyName="" SortExpression="TenantLease.ShopName">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="TenantLease.LeaseStartDate" HeaderText="Lease Start Date"
                        PropertyName="TenantLease.LeaseStartDate" ResourceAssemblyName="" SortExpression="TenantLease.LeaseStartDate"
                        DataFormatString="{0:dd-MMM-yyyy}" meta:resourcekey="UIGridViewBoundColumnResource13">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="TenantLease.LeaseEndDate" HeaderText="Lease End Date"
                        PropertyName="TenantLease.LeaseEndDate" ResourceAssemblyName="" SortExpression="TenantLease.LeaseEndDate"
                        DataFormatString="{0:dd-MMM-yyyy}" meta:resourcekey="UIGridViewBoundColumnResource14">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="TenantLease.Status" HeaderText="Lease Status"
                        PropertyName="TenantLease.Status" ResourceAssemblyName="" SortExpression="TenantLease.Status"
            ...
            <%--</ui:UITabView>--%>
            <web:fileuploaddialogbox runat="server" ID="fileDialogBox" Cancelled="false" 
                FileUploadMultiple="false" Visible="true"
                NumberOfFileUploads="1" Title="Upload Excel Template" OnUploaded="fileDialogBox_Uploaded" />
            <%--<ui:UITabView runat="server" ID="tabExcelUpload" Caption="Excel Upload" BorderStyle="NotSet"
                    meta:resourcekey="tabExcelUploadResource1">--%>
            <ui:UIPanel runat="server" ID="panelExcelUpload" BorderStyle="NotSet" meta:resourcekey="panelExcelUploadResource1"
                Visible="false">
                <ui:UIFieldInputFile runat="server" ID="InputFile" Caption="Point Readings" Span="Half"
                    meta:resourcekey="InputFileResource1" />
                <ui:UIButton runat="server" ID="BtnUpload" Text="Upload" OnClick="Upload_Click" ImageUrl="~/images/document-attach.gif"
                    meta:resourcekey="BtnUploadResource1" />
            </ui:UIPanel>
            <ui:UIPanel runat="server" ID="panelExcelConfirm" Visible="False" BorderStyle="NotSet"
                meta:resourcekey="panelExcelConfirmResource1">
                <ui:UIHint runat="server" ID="hintExcelUpload" Text="Please review the data you have uploaded. You must click the 'Save' button to commit."
                    meta:resourcekey="hintExcelUploadResource2"></ui:UIHint>
                <%--<ui:UIButton runat="server" ID="BtnSave" Text="Save" OnClick="Save_Click" ImageUrl="~/images/disk-big.gif"
                    meta:resourcekey="BtnSaveResource1" />
                <ui:UIButton runat="server" ID="BtnClear" Text="Clear" OnClick="Clear_Click" ImageUrl="~/images/Symbol-Refresh-big.gif"
                    meta:resourcekey="BtnClearResource1" />--%>
            </ui:UIPanel>
            <ui:UIHint runat="server" ID="Hint" Visible="False" meta:resourcekey="HintResource2">
                        
                    &nbsp;&nbsp;&nbsp;&nbsp;
                        
            </ui:UIHint>
            <ui:UIGridView runat="server" ID="gridUpload" Width="100%" CheckBoxColumnVisible="False"
                DataKeyNames="ObjectID" GridLines="Both" meta:resourcekey="gridUploadResource1" Visible="false"
                RowErrorColor="" Style="clear: both;" OnRowDataBound="gridUpload_RowDataBound"
                PageSize="1000" ImageRowErrorUrl="" OnAction="gridUpload_Action">
                <PagerSettings Mode="NumericFirstLast" />
                <Commands>
                    <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" CommandName="SaveObject"
                        CommandText="Save" ImageUrl="~/images/tick.gif" />
                    <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" CommandName="ClearObject"
                        CommandText="Clear" ImageUrl="~/images/delete.gif" />
                </Commands>
                <Columns>
                    <cc1:UIGridViewBoundColumn DataField="Location" HeaderText="Location" meta:resourcekey="UIGridViewBoundColumnResource6"
                        PropertyName="Location" ResourceAssemblyName="" SortExpression="Location">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Equipment" HeaderText="Equipment" meta:resourcekey="UIGridViewBoundColumnResource7"
                        PropertyName="Equipment" ResourceAssemblyName="" SortExpression="Equipment">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Point Name" HeaderText="Point Name" meta:resourcekey="UIGridViewBoundColumnResource8"
                        PropertyName="Point Name" ResourceAssemblyName="" SortExpression="Point Name">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Reading Date" DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}"
                        HeaderText="Reading Date" meta:resourcekey="UIGridViewBoundColumnResource9" PropertyName="Reading Date"
                        ResourceAssemblyName="" SortExpression="Reading Date">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Reading Value" HeaderText="Reading Value" meta:resourcekey="UIGridViewBoundColumnResource10"
                        PropertyName="Reading Value" ResourceAssemblyName="" SortExpression="Reading Value">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Validation" HeaderText="Error" meta:resourcekey="UIGridViewBoundColumnResource11"
                        PropertyName="Validation" ResourceAssemblyName="" SortExpression="Validation">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle ForeColor="Red" HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Tenant Name" HeaderText="Tenant Name" PropertyName="Tenant Name"
                        ResourceAssemblyName="" SortExpression="Tenant Name" meta:resourcekey="UIGridViewBoundColumnResource16">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Shop Name" HeaderText="Shop Name" PropertyName="Shop Name"
                        ResourceAssemblyName="" SortExpression="Shop Name">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Lease Start Date" HeaderText="Lease Start Date"
                        PropertyName="Lease Start Date" ResourceAssemblyName="" SortExpression="Lease Start Date"
                        DataFormatString="{0:dd-MMM-yyyy}" meta:resourcekey="UIGridViewBoundColumnResource17">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Lease End Date" HeaderText="Lease End Date"
                        PropertyName="Lease End Date" ResourceAssemblyName="" SortExpression="Lease End Date"
                        DataFormatString="{0:dd-MMM-yyyy}" meta:resourcekey="UIGridViewBoundColumnResource18">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Lease Status" HeaderText="Lease Status" PropertyName="Lease Status"
                        ResourceAssemblyName="" SortExpression="Lease Status" meta:resourcekey="UIGridViewBoundColumnResource19">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                </Columns>
