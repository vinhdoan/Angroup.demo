    ...
    <form id="form2" runat="server">
        <ui:UIObjectPanel runat="server" ID="panelMain" 
            ...
            <web:search runat="server" ID="panel" Caption="Running Number Generator" GridViewID="gridResults" EditButtonVisible="false"
                AutoSearchOnLoad="true" MaximumNumberOfResults="100" SearchTextBoxHint="Object Type Name, Object Type Code"
                AdvancedSearchOnLoad="false" AdvancedSearchPanelID="" SearchTextBoxPropertyNames="ObjectTypeName,ObjectTypeCode"
