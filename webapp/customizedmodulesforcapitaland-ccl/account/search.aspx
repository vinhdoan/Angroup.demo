...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" meta:resourcekey="panelMainResource1">
        <web:search runat="server" ID="panel" OnPopulateForm="panel_PopulateForm" Caption="Account"
            ...
            AutoSearchOnLoad="false" SearchTextBoxHint="Account Name, Account Category Name"
            MaximumNumberOfResults="30" SearchTextBoxPropertyNames="ObjectName,Parent.ObjectName"
            AdvancedSearchPanelID="panelAdvanced" AdvancedSearchOnLoad="false" EditButtonVisible="true"
            AssignedCheckboxVisible="false" SearchAssignedOnly="true" meta:resourcekey="panelResource1">
        </web:search>
        <div class="div-form">
            ...
            <ui:UIFieldTreeList runat="server" ID="treeAccount" Caption="Account" OnAcquireTreePopulater="treeAccount_AcquireTreePopulater"
            ...
            <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                ...
                <ui:UIFieldRadioList ID="radioAccountType" runat="server" Caption="Account Type"
                    RepeatDirection="Horizontal" RepeatColumns="3" PropertyName="Type" meta:resourcekey="radioAccountTypeResource1"
                    TextAlign="Right">
                    <Items>
                ...
                <ui:UIFieldTreeList runat="server" ID="treeMoveToAccount" OnAcquireTreePopulater="treeMoveToAccount_AcquireTreePopulater"
                    Caption="Move To" meta:resourcekey="treeMoveToAccountResource1" ShowCheckBoxes="None"
                    TreeValueMode="SelectedNode">
                </ui:UIFieldTreeList>
                <ui:UIButton runat='server' ID='buttonMove' Text="Move selected account items/categories"
                    ImageUrl="~/images/tick.gif" OnClick="buttonMove_Click" meta:resourcekey="buttonMoveResource1">
                </ui:UIButton>
            </ui:UIPanel>
            <%--</ui:UITabView>
                    <!--Tab Result-->
            ...
            <ui:UIGridView runat="server" ID="gridResults" Caption="Account Category/Item" OnRowDataBound="gridResults_RowDataBound"
                KeyName="ObjectID" Width="100%" DataKeyNames="ObjectID" GridLines="Both" meta:resourcekey="gridResultsResource1"
                RowErrorColor="" SortExpression="[Path] ASC" Style="clear: both;" ImageRowErrorUrl="">
                ...
                <Columns>
                    ...
                    <cc1:UIGridViewBoundColumn DataField="Type" HeaderText="Type" meta:resourcekey="UIGridViewBoundColumnResource1"
                        PropertyName="Type" ResourceAssemblyName="" SortExpression="Type">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Path" HeaderText="Account Path" meta:resourcekey="UIGridViewBoundColumnResource2"
                        PropertyName="Path" ResourceAssemblyName="" SortExpression="Path">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="SubCategory.ObjectName" HeaderText="Sub Category"
                        meta:resourcekey="UIGridViewBoundColumnResource4" PropertyName="SubCategory.ObjectName"
                        ResourceAssemblyName="" SortExpression="SubCategory.ObjectName">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="AccountCode" HeaderText="Account Code" meta:resourcekey="UIGridViewBoundColumnResource3"
                        PropertyName="AccountCode" ResourceAssemblyName="" SortExpression="AccountCode">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                </Columns>
