...
function jsGraphics(canvasDivElement)
{
	...
	function drawLine(pen,point0,point1,divid)
	{
	    ...
	    if(arguments[3]!="physical") 
	    {
	 	...
	 	{
	 		if(x0<=x1)
		 		lineDiv.innerHTML="<DIV name="+ divid + " style=\"position:absolute;overflow:hidden;left:" + x0 + "px;top:" + y0 + "px;width:" + (x1-x0+1) + "px;height:" + pen.width + ";background-color:" + hexColor + "\"></DIV>";
	 		else if(x0>x1)
	 		    lineDiv.innerHTML = "<DIV name=" + divid + "  style=\"position:absolute;overflow:hidden;left:" + x1 + "px;top:" + y0 + "px;width:" + (x0 - x1 + 1) + "px;height:" + pen.width + ";background-color:" + hexColor + "\"></DIV>";
	 	...
	 	{
	 		if(y0<=y1)
	 		    lineDiv.innerHTML = "<DIV name=" + divid + "  style=\"position:absolute;overflow:hidden;left:" + x0 + "px;top:" + y0 + "px;width:" + pen.width + ";height:" + (y1 - y0 + 1) + "px;background-color:" + hexColor + "\"></DIV>";
	 		else if(y0>y1)
	 		    lineDiv.innerHTML = "<DIV name=" + divid + "  style=\"position:absolute;overflow:hidden;left:" + x0 + "px;top:" + y1 + "px;width:" + pen.width + ";height:" + (y0 - y1 + 1) + "px;background-color:" + hexColor + "\"></DIV>";
   			...
   			{ 
   				...
   				else
   				{
   					...
   					else
   					{
   						...
   						iHtml[iHtml.length] = "<DIV name=" + divid + "  style=\"position:absolute;overflow:hidden;left:" + xp + "px;top:" + yp + "px;width:" + divWidth + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
 						divHeight=0;		
 						xp=y;
	   					yp=x;		
 					}
 				...
 				if(x==x1)
 				{
 					...
 					{
 						divHeight=pixHeight;
 						iHtml[iHtml.length] = "<DIV name=" + divid + "  style=\"position:absolute;overflow:hidden;left:" + y + "px;top:" + x + "px;width:" + divWidth + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
 					}
 				}
 			}
			else
			{ 
				if(x==x0)
 				...
 				if(x==x1)
 				{
 					...
 					{
 						divWidth=pixWidth;
 						iHtml[iHtml.length] = "<DIV name=" + divid + "  style=\"position:absolute;overflow:hidden;left:" + x + "px;top:" + y + "px;width:" + divWidth + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
 					}
 				}
 			}
    ...
    function drawPolyline(pen,points,divid)
    {
        //Check arguments for null values
	    if(!pen || !points)
		    return false;
	    ...
	    {
		    polylineDiv.appendChild(this.drawLine(pen,points[i-1],points[i],divid));
	    }
    ...
    function drawPolygon(pen,points,divid)
    {
        //Check arguments for null values
	    if(!pen || !points)
		    return false;
	...
	function fillPolygon(color,points,divid)
	{
	    //Check arguments for null values
		if(!color || !points)
		return false;
		...
		for(i=0;i<phPoints.length;i++)
		{
			...
			else
			{
				...
				{
					iHtml[iHtml.length]="<DIV name='"+ divid +"' style=\"position:absolute;height:1px;overflow:hidden;left:";
		...
		for(var i=0;i<curvePoints.length;i++)
		{
		    ...
		    if(!next)
		    {
				...
				if(x!=xp && !yStart)
				{
					if(y2==y1)
					{
					    iHtml[iHtml.length] = "<DIV name='"+ divid +"' style=\"position:absolute;overflow:hidden;left:";
