...
var spellURL = "../../components/SpellCheck.aspx";
    ...
    switch (oElement.tagName)
	{
        ...
        case "TEXTAREA" :
            if(typeof CKEDITOR != "undefined" && 
                CKEDITOR.instances && CKEDITOR.instances[checkElements[index]] && 
                CKEDITOR.instances[checkElements[index]].setData) 
                CKEDITOR.instances[checkElements[index]].setData(text);
            else
			    oElement.value = text;
			break;
		case "DIV" :
...
function checkSpelling()
{
    ...
    for (var i = 0; i < tagGroup.length; i++)
    {
        ...
        {
            if ((sTagName == "INPUT" && oElements[x].type == "text" && oElements[x].style.display != "none") || sTagName == "TEXTAREA")
