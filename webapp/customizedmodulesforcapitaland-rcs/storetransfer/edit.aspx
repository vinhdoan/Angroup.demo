...
<script runat="server">
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        if (storeTransfer.FromStoreType == StoreType.Storeroom)
        {
            ...
            //FromStoreID.Bind(OStore.FindAccessibleStoresActiveForCheckIn(AppSession.User, Security.Decrypt(Request["TYPE"]), OApplicationSetting.Current.FromStore.ObjectID, true, false));
        }
        else
        {
    ...
    protected void TransferItem_SubPanel_ValidateAndUpdate(object sender, EventArgs e)
    {
        ...
        //20120209 ptb
        //disallow transfer 0 amount
        if (item.FromStoreBin.GetTotalAvailableQuantity((Guid)item.CatalogueID) == 0)
            TransferItem_FromStoreBinID.ErrorMessage = Resources.Errors.StoreTransfer_ZeroAmount;
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        //if (radioFromStoreType.SelectedValue == StoreType.Storeroom.ToString())
    ...
    protected void panel_ValidateAndSave(object sender, EventArgs e)
    {
        using (Connection c = new Connection())
        {
            ...
            // Validate
            //
            if (objectBase.SelectedAction == "Request" ||
                ...
                objectBase.SelectedAction == "Commit")
            {
                ...
                {
                    //Revise, only check when Request, after that, no need to check anymore since item is reserved already.
                    if (!storeTransfer.ValidateSufficientItemsForTransfer() && objectBase.SelectedAction == "Request")
                    {
                        string list = "";
                    ...
                    <ui:UIPanel runat='server' ID="panelDetails" BorderStyle="NotSet" meta:resourcekey="panelDetailsResource1">
                        ...
                        <ui:UIGridView runat="server" ID="gridTransferItem" PropertyName="StoreTransferItems"
                            ...
                            <Columns>
                                ...
                                <cc1:UIGridViewTemplateColumn HeaderText="Quantity Received" meta:resourcekey="GridViewQuantityResource2"
                                    ...
                                    <ItemTemplate>
                                        <ui:UIFieldTextBox ID="Quantity" runat="server" Caption="Quantity" FieldLayout="Flow"
                                            DataFormatString="{0:#,##0.00##}" InternalControlWidth="95%" MaxLength="255"
                                            meta:resourcekey="QuantityResource2" PropertyName="Quantity" ShowCaption="False"
                                            ValidateRequiredField="True" Enabled="false">
                                        </ui:UIFieldTextBox>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                ...
                                <cc1:UIGridViewBoundColumn HeaderText="Quantity to Transfer" PropertyName="QuantityToTransfer"
                                    DataFormatString="{0:#,##0.00##}" meta:resourcekey="QuantitytoTransferResource2"
                                    DataField="QuantityToTransfer" ResourceAssemblyName="" SortExpression="QuantityToTransfer">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </cc1:UIGridViewBoundColumn>
                        ...
                        <ui:UIObjectPanel runat="server" ID="TransferItem_Panel" meta:resourcekey="TransferItem_PanelResource1"
                            ...
                            <ui:UIFieldTextBox runat="server" ID="TransferItem_QuantityToTransfer" PropertyName="QuantityToTransfer"
                                DataFormatString="{0:#,##0.00##}" Span="Half" ValidateRequiredField="True" ValidationDataType="Double"
                                Caption="Quantity To Transfer" meta:resourcekey="TransferItem_QuantityResource3"
                                InternalControlWidth="95%" />
