...
<script runat="server">
    ...
    protected void panel_Validate(object sender, PersistentObject obj)
    {
        ...
        if (action.Is("SubmitForApproval"))
        {
            ...
            //
            // TODO: Update in LogicLayer and reserve back
    ...
    ****************************/
    ...
    private void HideShowDetailsTabControls(OPurchaseInvoice invoice)
    {
        ...
        *****************/
        ...
        //2011 12 27 ptb
        //Change caption name
        if (radioInvoiceType.SelectedValue == PurchaseInvoiceType.CreditMemo.ToString())
            textReferenceNumber.Caption = "Credit Memo Number";
            ...
            <ui:UITabStrip ID="tabObject" runat="server" BorderStyle="NotSet" meta:resourcekey="tabObjectResource1">
                <ui:UITabView ID="tabDetails" runat="server" BorderStyle="NotSet" Caption="Details"
                    ...
                    <web:base ID="objectBase" runat="server" meta:resourceKey="objectBaseResource1" ObjectNameVisible="false"
                        ObjectNumberCaption="Invoice Number" ObjectNumberEnabled="false" ObjectNumberValidateRequiredField="true"
                    ...
                    <ui:UIPanel ID="panelDetails" runat="server" BorderStyle="NotSet" meta:resourcekey="panelDetailsResource1"
                        ...
                        <ui:UIFieldDropDownList runat="server" ID="dropPaymentType" Caption="Expense Type"
                            PropertyName="PaymentTypeID" ValidateRequiredField="true" OnSelectedIndexChanged="dropPaymentType_SelectedIndexChanged">
                        </ui:UIFieldDropDownList>
                ...
                <ui:UITabView ID="tabVendor" runat="server" BorderStyle="NotSet" Caption="Vendor and Amount"
                    ...
                    <ui:UIPanel runat="server" ID="panelCreditNote" Visible="true">
                        ...
                        <ui:UIFieldCheckBox runat="server" ID="cb_IsContainsCreditNote" PropertyName="IsContainsCreditNote"
                            Text="     Yes,the invoice is submitted with a credit note" CaptionWidth="1"
                            OnCheckedChanged="cb_IsContainsCreditNote_CheckedChanged">
                        </ui:UIFieldCheckBox>
                        <ui:UIPanel runat="server" ID="panelCreditNoteDetails">
                            <ui:UIFieldDateTime runat="server" ID="DateOfCreditNote" Caption="Date of Credit Note"
                                PropertyName="DateOfCreditNote" ValidateRequiredField="true">
                            </ui:UIFieldDateTime>
                            <ui:UIFieldTextBox runat="server" ID="txtCreditNoteReferenceNumber" Caption="Vendor Credit Note Number"
                                ValidateRequiredField="true" PropertyName="CreditNoteReferenceNumber" Span="Half">
                            </ui:UIFieldTextBox>
                            <br />
                            <ui:UIFieldTextBox runat="server" ID="txtCreditNoteAmountInSelectedCurrency" Caption="Net Amount"
                                Span="Half" DataFormatString="{0:n}" PropertyName="CreditNoteAmountInSelectedCurrency"
                                ValidateDataTypeCheck="true" ValidationDataType="Currency" ValidateRequiredField="true"
                                OnTextChanged="txtCreditNoteAmountInSelectedCurrency_TextChanged">
                            </ui:UIFieldTextBox>
                            <ui:UIFieldTextBox runat="server" ID="txtCreditNoteTaxAmountInSelectedCurrency" Caption="Tax Amount"
                                Span="Half" ValidateRequiredField="true" DataFormatString="{0:n}" PropertyName="CreditNoteTaxInSelectedCurrency"
                                ValidateDataTypeCheck="true" ValidationDataType="Currency" OnTextChanged="txtCreditNoteTaxAmountInSelectedCurrency_TextChanged">
                            </ui:UIFieldTextBox>
                            <ui:UIFieldLabel runat="server" ID="lblCreditNoteAmount" Caption="Net Amount" Span="Half"
                                PropertyName="CreditNoteAmount" DataFormatString="{0:n}">
                            </ui:UIFieldLabel>
                            <ui:UIFieldLabel runat="server" ID="lblCreditNoteTax" Caption="Tax Amount" Span="Half"
                                PropertyName="CreditNoteTax" DataFormatString="{0:n}">
                            </ui:UIFieldLabel>
                            <ui:UIFieldTextBox runat="server" ID="txtCreditNoteDescription" Caption="Credit Note Description"
                                Span="Full" PropertyName="CreditNoteDescription" MaxLength="255" ValidateRequiredField="true">
                            </ui:UIFieldTextBox>
                        </ui:UIPanel>
                    </ui:UIPanel>
                </ui:UITabView>
                <ui:UITabView ID="tabBudget" runat="server" BorderStyle="NotSet" Caption="Budget"
                    ...
                    <ui:UIPanel runat="server" ID="panelBudget2">
                        <ui:UIPanel ID="panelAddBudgets" runat="server" BorderStyle="NotSet" meta:resourcekey="panelAddBudgetsResource1">
                            ...
                            <web:searchdialogbox runat="server" ID="searchPurchaseOrderBudgets" SearchTextBoxPropertyNames="Account.Path,Budget.ObjectName"
                                AllowMultipleSelection="true" BaseTable="tBudgetTransactionLog" AutoSearchOnLoad="true"
                                OnSearched="searchPurchaseOrderBudgets_Searched" OnSelected="searchPurchaseOrderBudgets_Selected">
                                <Columns>
                                    <ui:UIGridViewBoundColumn PropertyName="PurchaseBudget.ItemNumber" HeaderStyle-Width="50px"
                                        HeaderText="Number" />
                                    <ui:UIGridViewBoundColumn PropertyName="Budget.ObjectName" HeaderStyle-Width="110px"
                                        HeaderText="Budget" />
                                    <ui:UIGridViewBoundColumn PropertyName="Account.Path" HeaderStyle-Width="350px" HeaderText="Account" />
                                    <ui:UIGridViewBoundColumn PropertyName="DateOfExpenditure" HeaderStyle-Width="130px"
                                        HeaderText="Expenditure Date" DataFormatString="{0:dd-MMM-yy}" />
                                    <ui:UIGridViewBoundColumn PropertyName="TransactionAmount" HeaderStyle-Width="70px"
                                        HeaderText="Amount" />
                                </Columns>
                                <AdvancedPanel>
                                    <ui:UIFieldTextBox runat="server" ID="textItemNumber" SearchType="Range" CaptionWidth="100px"
                                        Caption="Item Number" PropertyName="PurchaseBudget.ItemNumber" Span="Half">
                                    </ui:UIFieldTextBox>
                                    <br />
                                    <ui:UIFieldDateTime runat="server" ID="dateDateOfExpenditure" CaptionWidth="100px"
                                        SearchType="Range" Caption="Expenditure Date" PropertyName="DateOfExpenditure"
                                        Span="Half" ImageUrl="../../images/cross.gif">
                                    </ui:UIFieldDateTime>
                                </AdvancedPanel>
                            </web:searchdialogbox>
                            <br />
...
--%>
                            ...
                            <Columns>
                                ...
                                <ui:UIGridViewBoundColumn DataField="ItemNumber" HeaderText="No." PropertyName="ItemNumber"
