...
<script runat="server">
    ...
    {
        foreach (OPosition position in AppSession.User.GetPositionsByObjectType("OStoreCheckOut"))
        {
            foreach (OLocation location in position.LocationAccess)
            {
                if (e.CustomCondition == null)
                    e.CustomCondition = TablesLogic.tStoreCheckOut.Store.Location.HierarchyPath.Like(location.HierarchyPath + "%");
                else
                    e.CustomCondition = e.CustomCondition | TablesLogic.tStoreCheckOut.Store.Location.HierarchyPath.Like(location.HierarchyPath + "%");
            }
        }
...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" meta:resourcekey="panelMainResource1">
        <web:search runat="server" ID="panel" Caption="Check-Out" GridViewID="gridResults"
            EditButtonVisible="false" BaseTable="tStoreCheckOut" SearchType="ObjectQuery"
            AutoSearchOnLoad="true" MaximumNumberOfResults="300" AdvancedSearchPanelID="panelAdvanced"
            SearchTextBoxHint="Check Out Number, Description, WO Number" SearchTextBoxPropertyNames="ObjectNumber,Description, Work.ObjectNumber"
        ...
        <div class="div-form">
            ...
            <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                <%--<ui:UIFieldTextBox runat='server' ID="ObjectNumber" PropertyName="ObjectNumber" Caption="Check-Out Number"
            ...
            <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black" SortExpression="ObjectNumber"
                ...
                <Columns>
                    ...
                    <cc1:UIGridViewBoundColumn DataField="ObjectNumber" HeaderText="Check-Out Number"
                    ...
                    <cc1:UIGridViewBoundColumn DataField="Store.ObjectName" HeaderText="Store Name" meta:resourceKey="UIGridViewColumnResource5"
                        PropertyName="Store.ObjectName" ResourceAssemblyName="" SortExpression="Store.ObjectName">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Description" HeaderText="Remarks" meta:resourceKey="UIGridViewColumnResource6"
                    ...
                    <cc1:UIGridViewBoundColumn DataField="CurrentActivity.ObjectName" HeaderText="Status"
                        meta:resourceKey="UIGridViewColumnResource7" PropertyName="CurrentActivity.ObjectName"
                        ResourceAssemblyName="" ResourceName="Resources.WorkflowStates" SortExpression="CurrentActivity.ObjectName">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <ui:UIGridViewBoundColumn DataField="CurrentActivity.AssignedUserText" HeaderText="Assigned User(s)"
