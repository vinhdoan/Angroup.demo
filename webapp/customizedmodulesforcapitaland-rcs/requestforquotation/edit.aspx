...
<script runat="server">
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            BindSupporters(requestForQuotation);
    ...
    /// <summary>
    /// Bind Supporters controls
    /// </summary>
    /// <param name="rfq"></param>
    protected void BindSupporters(ORequestForQuotation rfq)
    {
        //ddlSupporters.Bind(OUser.GetAllNonTenantUsers());
        ddlSupporters.Bind(OUser.GetAllNonTenantSupporterUsers());
    }
    ...
    protected void panel_Validate(object sender, PersistentObject obj)
    {
        ...
        if (action.Is("CreateChildRFQs") || action.StartsWith("SubmitForApproval"))
        {
            string acrossPeriod;
    ...
    protected void Workflow_Setting(ORequestForQuotation RFQ)
    {
        ...
        panelDetails2.Enabled = !state.Is("PendingApproval", "Awarded", "Close", "Cancelled", "PendingApproval_Support");
        panelDateRequired.Enabled = !state.Is("PendingApproval", "Awarded", "Close", "Cancelled", "PendingApproval_Support");
        panelHasWarranty.Enabled = !state.Is("PendingApproval", "Awarded", "Close", "Cancelled", "PendingApproval_Support");
        tabLineItems.Enabled = !state.Is("PendingApproval", "Awarded", "Close", "Cancelled", "PendingApproval_Support");
        tabQuotations.Enabled = !state.Is("PendingApproval", "Awarded", "Close", "Cancelled", "PendingApproval_Support");
        panelBudget2.Enabled = !state.Is("PendingApproval", "Awarded", "Close", "Cancelled", "PendingApproval_Support");
        panelReallocateFrom.Enabled = !state.Is("PendingApproval", "Awarded", "Close", "Cancelled", "PendingApproval_Support");
        panelAwardVendor.Visible = !state.Is("PendingApproval", "Awarded", "Close", "Cancelled", "PendingApproval_Support");
        ...
        panelSupport.Enabled = !state.Is("PendingApproval", "Awarded", "Close", "Cancelled", "PendingApproval_Support");
        ...
        textAwardedJustification.ValidateRequiredField =
			...
			dropCRVSerialNumbers.ValidateRequiredField = action.StartsWith("SubmitForApproval") || action.Is("SubmitForApproval", "Approve");

        gridBudget.ValidateRequiredField =
            !(RFQ.BudgetValidationPolicy == PurchaseBudgetValidationPolicy.BudgetNotRequired) &&
            (action.StartsWith("SubmitForApproval") || action.Is("SubmitForApproval", "CreateChildRFQs"));
        ...
        ListItem submitforapproval2 = objectBase.GetWorkflowRadioListItem("SubmitForApproval_Supporter");
        if (submitforapproval2 != null)
        {
            submitforapproval2.Enabled =
                ((!checkIsGroupWJ.Checked && IsGroupApproval.Checked) ||
                !(checkIsGroupWJ.Checked && !IsGroupApproval.Checked)) &&
                !objectBase.CurrentObjectState.Is("PendingApproval", "Awarded", "Close", "Cancelled", "PendingApproval_Support");

            submitforapproval2.Text = rfq.Supporters.Count > 0 ? submitforapproval2.Text : "Submit for Approval";
        }
        //
    ...
    protected void gridSupporters_Action(object sender, string commandName, List<object> dataKeys)
    {
        if (commandName == "DeleteSupporters")
        {
            ORequestForQuotation rfq = panel.SessionObject as ORequestForQuotation;
            panel.ObjectPanel.BindControlsToObject(rfq);
            ...
            foreach (object id in dataKeys)
            {
                OSupporter obj = rfq.Supporters.Find(lf => lf.ObjectID == new Guid(id.ToString()));
                rfq.Supporters.RemoveObject(obj);
            }
    ...
    protected void subpanelSupporters_ValidateAndUpdate(object sender, EventArgs e)
    {
        //ORequestForQuotation rfq = panel.SessionObject as ORequestForQuotation;
        //panel.ObjectPanel.BindControlsToObject(rfq);
    ...
    protected void subpanelSupporters_PopulateForm(object sender, EventArgs e)
    {

    }

    protected void ddlSupporters_SelectedIndexChanged(object sender, EventArgs e)
    {
        ORequestForQuotation rfq = panel.SessionObject as ORequestForQuotation;
        panel.ObjectPanel.BindControlsToObject(rfq);

        if (ddlSupporters.SelectedIndex != 0 && rfq.Supporters.Find(lf => lf.SupporterID == new Guid(ddlSupporters.SelectedValue)) == null)
        {
            OSupporter sup = TablesLogic.tSupporter.Create();
            sup.SupporterID = new Guid(ddlSupporters.SelectedValue);
            sup.RFQID = rfq.ObjectID;

            rfq.Supporters.Add(sup);
        }
        panel.ObjectPanel.BindObjectToControls(rfq);
    }
    ...
    <ui:UIObjectPanel ID="UIObjectPanel1" runat="server" BorderStyle="NotSet" meta:resourcekey="UIObjectPanelResource1">
        ...
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1"
                ...
                <ui:UITabView runat="server" ID="tabBudget" Caption="Budget" BorderStyle="NotSet"
                    ...
                    <ui:UIPanel runat="server" ID="panelBudget2">
                        ...
                        <ui:UIObjectPanel runat="server" ID="panelInvisible" Visible="false">
                            ...
                            <ui:UIFieldTreeList runat="server" ID="treeAccount" PropertyName="AccountID" Caption="ValidateRequiredField="True"
                ...
                <ui:UITabView runat="server" ID="tabSupporters" Caption="Supporters" BorderStyle="NotSet">
                    <ui:UIPanel runat="server" ID="panelSupport">
                        <ui:UIFieldSearchableDropDownList runat="server" ID="ddlSupporters" Caption="Supporters"
                            MaximumNumberOfItems="50" OnSelectedIndexChanged="ddlSupporters_SelectedIndexChanged">
                        </ui:UIFieldSearchableDropDownList>
                        <ui:UIGridView runat="server" ID="gridSupporters" Caption="List of Supporters" OnAction="gridSupporters_Action"
                            SortExpression="IsApproved" PropertyName="Supporters" BindObjectsToRows="true">
                            <Commands>
                                <cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="True" CommandName="DeleteSupporters"
                                    CommandText="Delete" ConfirmText="Are you sure you wish to delete the selected items?"
                                    ImageUrl="~/images/delete.gif" meta:resourceKey="UIGridViewCommandResource1" />
                                <%--<cc1:UIGridViewCommand AlwaysEnabled="False" CausesValidation="False" CommandName="AddObject"
                                CommandText="Add" ImageUrl="~/images/add.gif" meta:resourceKey="UIGridViewCommandResource2" />--%>
                            ...
                            <Columns>
                                <%--<ui:UIGridViewBoundColumn DataField="Level" HeaderText="Level" PropertyName="Level"
                                ResourceAssemblyName="" SortExpression="Level">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </ui:UIGridViewBoundColumn>--%>
                                <ui:UIGridViewBoundColumn DataField="Supporter.ObjectName" HeaderText="Name" PropertyName="Supporter.ObjectName"
                                    ResourceAssemblyName="" SortExpression="Supporter.ObjectName">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </ui:UIGridViewBoundColumn>
                                <ui:UIGridViewBoundColumn DataField="Supporter.UserBase.Email" HeaderText="Email"
                                    PropertyName="Supporter.UserBase.Email" ResourceAssemblyName="" SortExpression="Supporter.UserBase.Email">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </ui:UIGridViewBoundColumn>
                                <ui:UIGridViewBoundColumn DataField="Supporter.UserBase.Phone" HeaderText="Phone"
                                    PropertyName="Supporter.UserBase.Phone" ResourceAssemblyName="" SortExpression="Supporter.UserBase.Phone">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </ui:UIGridViewBoundColumn>
                                <ui:UIGridViewBoundColumn DataField="IsApprovedText" HeaderText="Status" PropertyName="IsApprovedText"
                                    ResourceAssemblyName="" SortExpression="IsApprovedText">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" Font-Bold="true" />
                                </ui:UIGridViewBoundColumn>
                                <ui:UIGridViewBoundColumn DataField="IsApproved" HeaderText="Status" PropertyName="IsApproved"
                                    ResourceAssemblyName="" Visible="false">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" Font-Bold="true" />
                                </ui:UIGridViewBoundColumn>
                            </Columns>
                        </ui:UIGridView>
                        <%--<ui:UIObjectPanel runat="server" ID="panelSupporters" BorderStyle="NotSet">
                        <web:subpanel runat="server" GridViewID="gridSupporters" ID="subpanel1" OnValidateAndUpdate="subpanelSupporters_ValidateAndUpdate"
                            OnPopulateForm="subpanelSupporters_PopulateForm" UpdatePopupVisible="true" />
                        <ui:UIFieldSearchableDropDownList runat="server" ID="ddlSupporters" Caption="Supporters" 
                            OnSelectedIndexChanged="ddlSupporters_SelectedIndexChanged">
                        </ui:UIFieldSearchableDropDownList>
                    </ui:UIObjectPanel>--%>
                    </ui:UIPanel>
                </ui:UITabView>
