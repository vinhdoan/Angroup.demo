...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="formMain" BorderStyle="NotSet" meta:resourcekey="formMainResource2">
        <web:search runat="server" ID="panel" Caption="Tenant Contact" GridViewID="gridResults"
            BaseTable="tTenantContact" EditButtonVisible="false" AutoSearchOnLoad="false"
            MaximumNumberOfResults="300" SearchTextBoxPropertyNames="ObjectName,Tenant.ObjectName,Phone,Cellphone,Email,Fax"
            AdvancedSearchPanelID="panelAdvanced" SearchTextBoxHint="Contact Name, Tenant Name, Cellphone, Phone, Email, Fax, etc..."
        ...
        <div class="div-form">
            ...
            <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                ...
                <ui:UIFieldDropDownList runat="server" ID="ddlTenantContactType" PropertyName="TenantContactTypeID"
                    Span="Half" Caption="Tenant Contact Type" meta:resourcekey="ddlTenantContactTypeResource1" />
                ...
                <ui:UIFieldTextBox ID="AmosContactID" runat="server" Caption="Amos Contact ID" InternalControlWidth="95%"
                    PropertyName="AmosContactID" Span="Half" SearchType="Range" ValidationDataType="Integer"
                    meta:resourcekey="AmosContactIDResource1" />
                <ui:UIFieldTextBox ID="AmosBillAddressID" runat="server" Caption="Amos Bill Address ID"
                    InternalControlWidth="95%" PropertyName="AmosBillAddressID" Span="Half" SearchType="Range"
                    ValidationDataType="Integer" meta:resourcekey="AmosBillAddressIDResource1" />
                <ui:UIFieldTextBox ID="AddressLine1" runat="server" Caption="Address Line 1" InternalControlWidth="95%"
                    PropertyName="AddressLine1" Span="Half" SearchType="Range" ValidationDataType="Integer"
                ...
                <ui:UIFieldRadioList runat="server" Caption="Amos Instance" ID="AmosInstanceID" RepeatColumns="3"
                    PropertyName="AMOSInstanceID" RepeatDirection="Vertical" TextAlign="Right">
                    <Items>
            ...
            <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black" KeyName="ObjectID"
                ...
                <Columns>
                    ...
                    <cc1:UIGridViewBoundColumn DataField="ObjectName" HeaderText="Tenant Contact Name"
                        meta:resourceKey="UIGridViewColumnResource4" PropertyName="ObjectName" ResourceAssemblyName=""
                        SortExpression="ObjectName">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Tenant.ObjectName" HeaderText="Tenant's Name"
                        PropertyName="Tenant.ObjectName" ResourceAssemblyName="" SortExpression="DID"
                    ...
                    <cc1:UIGridViewBoundColumn DataField="TenantContactType.ObjectName" HeaderText="Tenant Contact Type"
                        PropertyName="TenantContactType.ObjectName" ResourceAssemblyName="" SortExpression="TenantContactType.ObjectName"
                        meta:resourcekey="UIGridViewBoundColumnResource2">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Position" HeaderText="Position" PropertyName="Position"
                        ResourceAssemblyName="" SortExpression="DID" meta:resourcekey="UIGridViewBoundColumnResource3">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Department" HeaderText="Department" PropertyName="Department"
                        ResourceAssemblyName="" SortExpression="DID" meta:resourcekey="UIGridViewBoundColumnResource4">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="DID" HeaderText="DID" PropertyName="DID" ResourceAssemblyName=""
                        SortExpression="DID" meta:resourcekey="UIGridViewBoundColumnResource5">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Cellphone" HeaderText="Cellphone" meta:resourceKey="UIGridViewColumnResource6"
                        PropertyName="Cellphone" ResourceAssemblyName="" SortExpression="Cellphone">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Email" HeaderText="Email" meta:resourceKey="UIGridViewColumnResource7"
                        PropertyName="Email" ResourceAssemblyName="" SortExpression="Email">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
                    <cc1:UIGridViewBoundColumn DataField="Fax" HeaderText="Fax" meta:resourceKey="UIGridViewColumnResource8"
                    ...
                    <cc1:UIGridViewBoundColumn DataField="ModifiedDateTime" HeaderText="Last modified date time"
                        PropertyName="ModifiedDateTime" DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}" ResourceAssemblyName=""
