...
<script runat="server">
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        RequestorName.ValidateRequiredField = (IsChargedToCaller.SelectedValue == "1");
        ...
        buttonGenerateRFQFromLineItems.Visible = state.Is("PendingExecution", "PendingMaterial", "PendingContractor") &&
                                                 IsChargedToCaller.SelectedValue == "1";
    ...
    void BindActualClassification(OWork work)
    {
        ...
        if (work.ActualTypeOfWorkID != null)
            ActualTypeOfServiceID.Bind(OCode.GetTypeOfServices(AppSession.User, work.ActualTypeOfWorkID, Security.Decrypt(Request["TYPE"]), work.ActualTypeOfServiceID));

        ActualTypeOfProblemID.Items.Clear();
        if (work.ActualTypeOfServiceID != null)
            ActualTypeOfProblemID.Bind(OCode.GetCodesByTypeAndParentID("TypeOfProblem", work.ActualTypeOfServiceID, work.ActualTypeOfProblemID));
    ...
    protected void searchTenantLease_Searched(objectSearchDialogBox.SearchEventArgs e)
    {
        ...
        {
            foreach (OLocation location in pos.LocationAccess)
            {
                if (cond == null)
                    cond = TablesLogic.tTenantLease.Location.HierarchyPath.Like(location.HierarchyPath + "%");
                else
...
<body>
    ...
    <ui:UIObjectPanel runat="server" ID="panelMain" BorderStyle="NotSet" 
        ...
        <web:object runat="server" ID="panel" Caption="Work" BaseTable="tWork" 
            ShowWorkflowActionAsButtons="true" SaveButtonsVisible="false" ShowWorkflowDialogBox="true"
            OnPopulateForm="panel_PopulateForm" meta:resourcekey="panelResource1" 
            OnValidateAndSave="panel_ValidateAndSave" >
        </web:object>
        <div class="div-main">
            <ui:UITabStrip runat="server" ID="tabObject" 
                ...
                <ui:UITabView runat="server" ID="tabDetails" Caption="Details" 
                    ...
                    <ui:UIPanel runat="server" ID="panelWorkDetails" 
                        ...
                        <ui:UIPanel runat="server" ID="panelCase" BorderStyle="NotSet" 
                            ...
                            <ui:UIFieldSearchableDropDownList runat="server" ID="dropCase" Enabled="false"
                            ...
                            <ui:UIPanel runat="server" ID="panelCaseDetails" BorderStyle="NotSet">
                                <%--<ui:UIFieldSearchableDropDownList runat="server" ID="RequestorID" 
                                    PropertyName="RequestorID" Caption="Requestor" Span="Half"
                                    ToolTip="The Requestor that made the request for this work. Leave this empty if the Requestor does not exist in this list. You can key in his or her name below in the 'Name' field." meta:resourcekey="RequestorIDResource2" 
                                    MaximumNumberOfItems="100" SearchInterval="300">
                                </ui:UIFieldSearchableDropDownList>--%>
                                <%--<ui:UIFieldDropDownList runat="server" ID="RequestorID" InternalControlWidth="95%" 
                                    PropertyName="RequestorID" Caption="Tenant" Span="Half"
                                    ToolTip="The Requestor that made the request for this work. Leave this empty if the Requestor does not exist in this list. You can key in his or her name below in the 'Name' field." meta:resourcekey="RequestorIDResource2">
                                </ui:UIFieldDropDownList>--%>
                                <ui:UIFieldLabel runat="server" ID="labelRequestor" PropertyName="Requestor.ObjectName" Caption="Requestor" Span="Half"></ui:UIFieldLabel>
                                <%--<ui:UIFieldTextBox runat="server" ID="textRequestor" PropertyName="Requestor.ObjectName" ReadOnly="true" Caption="Requestor" Span="Half"></ui:UIFieldTextBox>--%>
                                <web:searchdialogbox runat='server' ID="searchTenantLease" BaseTable="tTenantLease" AutoSearchOnLoad="false" AllowMultipleSelection="false"
                                    ...
                                    SearchTextBoxPropertyNames="Tenant.ObjectName, Location.ObjectName, ShopName, Location.Parent.ObjectName" OnSelected="searchTenantLease_Selected" OnSearched="searchTenantLease_Searched" OnCleared="searchTenantLease_Cleared">
                                    <Columns>
                                ...
                                <br />
                                <%--<ui:UIButton runat="server" ID="buttonSelectTenantLease" Text="Select a Tenant" Font-Bold="true" ImageUrl="" OnClick="buttonSelectTenantLease_Click" />--%>
                                <ui:UIFieldTextBox ID="RequestorName" runat="server" Caption="Name" PropertyName="RequestorName" ValidateRequiredField="True" ToolTip="The name of the Requestor to refer by." Span="Half" meta:resourcekey="RequestorNameResource2" InternalControlWidth="95%" />
                                <ui:UIFieldTextBox ID="RequestorUnitNo" runat="server" Caption="Unit No" PropertyName="TenantLease.Location.Path" Enabled="false" Span="Half"></ui:UIFieldTextBox>
                ...
                <ui:UITabView runat="server" ID="tabResolution" Caption="Resolution" 
                    ...
                    <ui:UIPanel runat="server" ID="panelResolution" 
                        ...
                        <ui:UIPanel runat="server" ID="PanelActualWorkClassificatioin" BorderStyle="NotSet">
                            <ui:UIFieldRadioList runat="server" ID="Classification" PropertyName="Classification" Caption="Classification">
                                <Items>
                                    <asp:ListItem Value="1" Text="Major"></asp:ListItem>
                                    <asp:ListItem Value="0" Text="Minor"></asp:ListItem>
                                </Items>
                            </ui:UIFieldRadioList>
                            <ui:UIFieldDropDownList runat="server" ID="ActualTypeOfWorkID" PropertyName="ActualTypeOfWorkID" Caption="Actual Type of Work" ValidateRequiredField="True" OnSelectedIndexChanged="ActualTypeOfWorkID_SelectedIndexChanged">
                            </ui:UIFieldDropDownList>
                            <ui:UIFieldDropDownList runat="server" ID="ActualTypeOfServiceID" PropertyName="ActualTypeOfServiceID" Caption="Actual Type of Service" ValidateRequiredField="True" OnSelectedIndexChanged="ActualTypeOfServiceID_SelectedIndexChanged">
                            </ui:UIFieldDropDownList>
                            <ui:UIFieldDropDownList runat="server" ID="ActualTypeOfProblemID" PropertyName="ActualTypeOfProblemID" Caption="Actual Type of Problem" ValidateRequiredField="True" >
                            </ui:UIFieldDropDownList>
                        </ui:UIPanel>
                ...
                <ui:UITabView runat="server" ID="tabCost" Caption="Cost" 
                    ...
                    <ui:UIPanel runat="server" ID="panelWorkCost" 
                        ...
                        <ui:UIButton runat="server" ID="buttonGenerateRFQFromLineItems" Text="Generate WJ from Selected Line Items"
                                ImageUrl="~/images/add.gif" OnClick="buttonGenerateRFQFromLineItems_Click" />
                    </ui:UIPanel>
                </ui:UITabView>
                ...
                <ui:UITabView runat="server" ID="tabReading" Caption="Reading" Visible="false" 
                ...
                <ui:UITabView runat="server" ID="tabRelated" Caption="Related" Visible="false"
