        ...
        <div class="div-form">
            ...
            <ui:UIGridView runat="server" ID="gridResults" BorderColor="Black" KeyName="ObjectID"
                ...
                <Columns>
                    ...
                    <cc1:UIGridViewBoundColumn DataField="AMOSInstanceID" HeaderText="AmosInstanceID" PropertyName="AMOSInstanceID"
                        ResourceAssemblyName="" SortExpression="AMOSInstanceID">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </cc1:UIGridViewBoundColumn>
