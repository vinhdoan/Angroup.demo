...
<body>
    <form id="form1" runat="server">
        ...
        <web:search runat="server" id="panel" Caption="Store"
        AutoSearchOnLoad="true" SearchTextBoxHint="Store Name, Location" 
        MaximumNumberOfResults="10" SearchTextBoxPropertyNames="ObjectName,Location.ObjectName"
        AdvancedSearchPanelID="panelAdvanced" AdvancedSearchOnLoad="true"
        GridViewID="gridResults" BaseTable="tStore" OnSearch="panel_Search"
        EditButtonVisible="false"  meta:resourcekey="panelResource1" OnPopulateForm="panel_PopulateForm" SearchType="ObjectQuery">
        </web:search>
        <div class="div-form">
            <%--<ui:UITabStrip runat="server" id="tabSearch" 
                ...
                <ui:UIPanel runat="server" ID="panelAdvanced" BorderStyle="NotSet">
                    ...
                    <ui:UIFieldRadioList runat="server" ID="radioStoreType" Caption="Store Type" 
                        PropertyName="StoreType" meta:resourcekey="radioStoreTypeResource1" 
                        TextAlign="Right">
                        <Items>
                            <asp:listitem meta:resourcekey="ListItemResource1" Text="Any" Value=""></asp:listitem>
                            <asp:listitem value="0" Selected="True" meta:resourcekey="ListItemResource2" 
                                Text="A physical storeroom that you can check inventory into or out of."></asp:listitem>
                            <asp:listitem value="1" meta:resourcekey="ListItemResource3" 
                                Text="An issue location that you can transfer non-consumables and equipments to."></asp:listitem>
                        </Items>
                    </ui:UIFieldRadioList>
                    ...
                    <ui:UIFieldRadioList runat="server" ID="IsActiveForCheckIn" Caption="Is Active For Check-In" 
                        ...
                        <Items>
                            <asp:listitem meta:resourcekey="IsActiveForCheckInResourceAny" Text="Any" Value="" Selected="True" ></asp:listitem>
                            <asp:listitem value="0" meta:resourcekey="IsActiveForCheckInListItemResource1" 
                                Text="No"></asp:listitem>
                            <asp:listitem value="1" meta:resourcekey="IsActiveForCheckInListItemResource2" 
                                Text="Yes"></asp:listitem>
                        </Items>
                    </ui:UIFieldRadioList>
                </ui:UIPanel>
                <%--</ui:UITabView>
                <ui:UITabView runat="server" ID="uitabview2" caption="Results"  
                    ...
                    <ui:UIGridView runat="server" ID="gridResults"  BorderColor="Black"
                        OnAction="gridResults_Action" sortexpression="ObjectName"    KeyName="ObjectID" 
                        ...
                        <Columns>
                            ...
                            <cc1:UIGridViewBoundColumn DataField="ObjectName" HeaderText="Store Name" 
                            ...
                            <cc1:UIGridViewBoundColumn DataField="Location.Path" HeaderText="Location" 
                                meta:resourceKey="UIGridViewColumnResource5" PropertyName="Location.Path" 
                                ResourceAssemblyName="" SortExpression="Location.Path">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
                            <cc1:UIGridViewBoundColumn DataField="StoreTypeText" HeaderText="Store Type" 
                                meta:resourcekey="UIGridViewBoundColumnResource1" PropertyName="StoreTypeText" 
                                ResourceAssemblyName="" SortExpression="StoreTypeText">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </cc1:UIGridViewBoundColumn>
