...
<script runat="server">
    ...
    protected void panel_PopulateForm(object sender, EventArgs e)
    {
        ...
        if (tenantLease.Tenant != null)
            ddlTenantContact.Bind(tenantLease.Tenant.TenantContacts);
    ...
    protected void ddlTenant_SelectedIndexChanged(object sender, EventArgs a)
    {
        OTenantLease tenantLease = (OTenantLease)panel.SessionObject;
        panel.ObjectPanel.BindControlsToObject(tenantLease);
        ddlTenantContact.Bind(tenantLease.Tenant.TenantContacts);
            ...
            <ui:UITabStrip runat="server" ID="tabObject" meta:resourcekey="tabObjectResource1" BorderStyle="NotSet">
                <ui:UITabView runat="server" ID="tabDetails" Caption="Details" meta:resourcekey="tabDetailsResource1" BorderStyle="NotSet">
                    ...
                    <ui:uifieldtreelist id="treeLocation" runat="server" caption="Location" 
                        ...
                        <ui:UIFieldSearchableDropDownList runat="server" ID="ddlTenant" PropertyName="TenantID" Caption="Tenant" meta:resourcekey="ddlTenantResource1" SearchInterval="300" OnSelectedIndexChanged="ddlTenant_SelectedIndexChanged"></ui:UIFieldSearchableDropDownList>
                        <ui:UIFieldDropDownList runat="server" ID="ddlTenantContact" Caption="Tenant Contact" PropertyName="TenantContactID" meta:resourcekey="ddlTenantContactResource1"></ui:UIFieldDropDownList>
