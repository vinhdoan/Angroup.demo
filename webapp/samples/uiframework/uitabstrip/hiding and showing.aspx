...
<script runat="server">
    ...
    protected void buttonToggleMemo_Click(object sender, EventArgs e)
    {
        // Toggles the visibility of the memo tab.
        //
        tabMemo.Visible = !tabMemo.Visible;
    }
</script>
    ...
    <div>
        <ui:UITabStrip runat="server" ID="tabstrip">
            <ui:UITabView runat="server" ID="tabDetails" Caption="Details">
                ...
                <ui:UIButton runat="server" ID="buttonToggleMemo" 
                    ImageUrl="~/images/tick.gif"
                    Text="Toggle Memo Tab" OnClick="buttonToggleMemo_Click" />
