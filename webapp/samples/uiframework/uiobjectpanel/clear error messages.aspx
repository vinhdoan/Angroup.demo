    ...
    protected void button_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            labelMessage.Text = "Validation failed: " + 
                objectpanel.CheckErrorMessages();
        }
    }

    protected void buttonClearMessages_Click(object sender, EventArgs e)
    {
        // Clears error messages of all UIField controls
        // within objectpanel.
        //
...
<body>
    <form id="form1" runat="server">
        <ui:UIObjectPanel runat="server" ID="objectpanel">
            ...
            <ui:UIButton runat="server" ID="buttonClearMessages" 
                ImageUrl="~/images/delete.gif" 
                Text="Clear Messages" OnClick="buttonClearMessages_Click" />
        </ui:UIObjectPanel>
    </form>
</body>
</html>
