...
<script runat="server">
    ...
    {
        // Call the GetSelectedKeys method of the gridview
        // and display all the selected keys.
        //
        List<object> selectedKeys = grid.GetSelectedKeys();
        labelMessage.Text = "";
        foreach (object dataKey in selectedKeys)
        {
...
<body>
    ...
    <ui:UIPanel ID="UIPanel1" runat="server">
        <ui:UIButton runat="server" ID="button" Text="Show Selected Keys"
