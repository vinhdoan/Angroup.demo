<%@ Page Language="C#" Theme="Corporate" CodeFile="~/applogin.aspx.cs" Inherits="applogin"
...
<body>
    ...
    <script type='text/javascript'>
        if (window.top) {
            if (window.top.name.indexOf('SIMPLISM') == 0) {
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" runat="server">
                        ...
                        <tr>
                            <td align="center" valign="middle" style="height: 30px">
                                <asp:Label runat="server" ID="labelLicense"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" valign="middle" style="height: 30px">
