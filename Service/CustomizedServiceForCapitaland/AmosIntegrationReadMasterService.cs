...
namespace Service
{
    public partial class AmosIntegrationReadMasterService : AnacleServiceBase
    {
        /// <summary>
        ...
        public override void OnExecute()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    ds = Connection.ExecuteQuery(connAmos,
                         "Select * from amos_suite_out", null);
                    if (ds.Tables.Count > 0)
                    ...
                    ds = Connection.ExecuteQuery(connAmos,
                         "Select * from amos_lease_agmt_out", null);
                    if (ds.Tables.Count > 0)
                ...
                catch (Exception e)
                {
                    ...
                    String emailAdd = OApplicationSetting.Current.EmailForAMOSFailure;
                    OMessage.SendMail(emailAdd, OApplicationSetting.Current.EmailForAMOSFailure, "Read Master Service Error", "Reading Data From AMOS: " + errorMsg);
                }
                #endregion
                ...
                foreach (DataRow dr in chargeTypeTable.Rows)
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        String emailAdd = OApplicationSetting.Current.EmailForAMOSFailure;
                        OMessage.SendMail(emailAdd, OApplicationSetting.Current.EmailForAMOSFailure, "Read Master Service Error", "Process ChargeType: " + errorMsg);
                    }
                }
                ...
                for (int i = 0; i < orgTable.Rows.Count; i++)
                {
                    ...
                    if (i % 200 == 0)
                    {
                        ...
                        List<OUser> users = TablesLogic.tUser.LoadList(
                            TablesLogic.tUser.AmosOrgID.In(ids), true);
                    ...
                    catch (Exception e)
                    {
                        ...
                        String emailAdd = OApplicationSetting.Current.EmailForAMOSFailure;
                        OMessage.SendMail(emailAdd, OApplicationSetting.Current.EmailForAMOSFailure, "Read Master Service Error", "Process Organisation: " + errorMsg);
                    }
                }
                ...
                List<OLocation> assets = TablesLogic.tLocation.LoadList(
                    ...
                    TablesLogic.tLocation.AmosSuiteID == null, true);
                    ...
                    if (dr["asset_id"].ToString() != "")
                    {
                        ...
                        if (asset != null)
                        {
                            ...
                            catch (Exception e)
                            {
                                ...
                                String emailAdd = OApplicationSetting.Current.EmailForAMOSFailure;
                                OMessage.SendMail(emailAdd, OApplicationSetting.Current.EmailForAMOSFailure, "Read Master Service Error", "Process Suite: " + errorMsg);
                            }
                        }
                    }
                }
                ...
                for (int i = 0; i < contactTable.Rows.Count; i++)
                {
                    ...
                    if (i % 200 == 0)
                    {
                        ...
                        List<OUser> users = TablesLogic.tUser.LoadList(
                            TablesLogic.tUser.AmosOrgID.In(orgIds), true);
                        foreach (OUser user in users)
                            preloadedRecords[user.AmosOrgID.ToString()] = user;
                    }
                        ...
                        dr["contact_name"].ToString().Trim() != "")
                    {
                        ...
                        catch (Exception e)
                        {
                            ...
                            String emailAdd = OApplicationSetting.Current.EmailForAMOSFailure;
                            OMessage.SendMail(emailAdd, OApplicationSetting.Current.EmailForAMOSFailure, "Read Master Service Error", "Process Contact: " + errorMsg);
                        }
                    }
                }
                    ...
                    if (dr["lease_id"].ToString() != "")
                    {
                        using (Connection conn = new Connection())
                        {
                            ...
                            catch (Exception e)
                            {
                                ...
                                String emailAdd = OApplicationSetting.Current.EmailForAMOSFailure;
                                OMessage.SendMail(emailAdd, OApplicationSetting.Current.EmailForAMOSFailure, "Read Master Service Error", "Process Lease Agmt: " + errorMsg);
                            }
                        }
                    }
                }
            ...
            catch (Exception e)
            {
                ...
                String emailAdd = OApplicationSetting.Current.EmailForAMOSFailure;
                OMessage.SendMail(emailAdd, OApplicationSetting.Current.EmailForAMOSFailure, "Read Master Service Error", errorMsg);
            }
        }
