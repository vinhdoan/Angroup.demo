...
namespace Service
{
    public partial class AmosIntegrationPostBillingService : AnacleServiceBase
    {
        /// <summary>
        ...
        public override void OnExecute()
        {
            ...
            try
            {
                ...
                catch (Exception e)
                {
                    ...
                    OMessage.SendMail(emailAdd, OApplicationSetting.Current.EmailForAMOSFailure, "Post Billing Service Error", errorMsg);
                }
