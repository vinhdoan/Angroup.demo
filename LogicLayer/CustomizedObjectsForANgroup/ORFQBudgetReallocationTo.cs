...
{
    [Serializable] 
    public partial class TRFQBudgetReallocationTo : LogicLayerSchema<ORFQBudgetReallocationTo>
    {
        public SchemaGuid RFQBudgetReallocationToPeriodID;
        ...
        //public TRFQBudgetReallocationToPeriod RFQBudgetReallocationToPeriod { get { return OneToOne<TRFQBudgetReallocationToPeriod>("RFQBudgetReallocationToPeriodID"); } }
    ...
    /// budget account.
    /// </summary>
    [Serializable] public abstract partial class ORFQBudgetReallocationTo : LogicLayerPersistentObject
    {
        /// <summary>
        /// [Column] Gets or sets the foreign key to the 
        /// budget reallocation record that this detail belongs under.
        /// </summary>
        public abstract Guid? RFQBudgetReallocationToPeriodID { get; set; }
        ...
        //public abstract ORFQBudgetReallocationToPeriod RFQBudgetReallocationToPeriod { get; set; }
