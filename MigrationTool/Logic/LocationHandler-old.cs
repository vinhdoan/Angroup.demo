...
{
    public class LocationHandlerold : Migratable
    {
        public LocationHandlerold(string mapfrom, string mapto)
            : base(mapfrom, mapto)
        { }

        public LocationHandlerold (string mapfrom, string mapto, string sourcefile)
